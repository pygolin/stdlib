...
var Code *πg.Code
func init() {
	Code = πg.NewCode("<module>", "/usr/lib/python2.7/textwrap.py", nil, 0, func(πF *πg.Frame, _ []*πg.Object) (*πg.Object, *πg.BaseException) {
		...
		for ; πF.State() >= 0; πF.PopCheckpoint() {
			...
			// line 1: """Text wrapping and filling.
			πF.SetLineno(1)
			if πE = πF.Globals().SetItem(πF, ß__doc__.ToObject(), πg.NewStr("Text wrapping and filling.\n").ToObject()); πE != nil {
				continue
			}
		...
		Label3:
			...
			_, πE = πg.NewCode("_unicode", "/usr/lib/python2.7/textwrap.py", nil, 0, func(πF *πg.Frame, _ []*πg.Object) (*πg.Object, *πg.BaseException) {
				πClass := πTemp006
				_ = πClass
				for ; πF.State() >= 0; πF.PopCheckpoint() {
					switch πF.State() {
		...
		Label1:
			...
			_, πE = πg.NewCode("TextWrapper", "/usr/lib/python2.7/textwrap.py", nil, 0, func(πF *πg.Frame, _ []*πg.Object) (*πg.Object, *πg.BaseException) {
				πClass := πTemp006
				_ = πClass
				...
				Label3:
					...
					πTemp002 = πg.NewFunction(πg.NewCode("__init__", "/usr/lib/python2.7/textwrap.py", πTemp011, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
					...
					πTemp004 = πg.NewFunction(πg.NewCode("_munge_whitespace", "/usr/lib/python2.7/textwrap.py", πTemp011, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
					...
					// line 148: """_munge_whitespace(text : string) -> string
					πF.SetLineno(148)
					if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp005}, πg.NewStr("_munge_whitespace(text : string) -> string\n\n        Munge whitespace in text: expand tabs and convert all other\n        whitespace characters to spaces.  Eg. \" foo\\tbar\\n\\nbaz\"\n        becomes \" foo    bar  baz\".\n        ").ToObject()); πE != nil {
						continue
					}
					if πTemp008, πE = πg.ResolveClass(πF, πClass, nil, ß_munge_whitespace); πE != nil {
						continue
					}
					...
					πTemp011[0] = πg.Param{Name: "self", Def: nil}
					πTemp011[1] = πg.Param{Name: "text", Def: nil}
					πTemp005 = πg.NewFunction(πg.NewCode("_split", "/usr/lib/python2.7/textwrap.py", πTemp011, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
						var µtext *πg.Object = πArgs[1]; _ = µtext
						...
						Label4:
							...
							πTemp003 = πg.NewFunction(πg.NewCode("<generator>", "/usr/lib/python2.7/textwrap.py", πTemp005, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
					...
					// line 167: """_split(text : string) -> [string]
					πF.SetLineno(167)
					if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp008}, πg.NewStr("_split(text : string) -> [string]\n\n        Split the text to wrap into indivisible chunks.  Chunks are\n        not quite the same as words; see _wrap_chunks() for full\n        details.  As an example, the text\n          Look, goof-ball -- use the -b option!\n        breaks into the following chunks:\n          'Look,', ' ', 'goof-', 'ball', ' ', '--', ' ',\n          'use', ' ', 'the', ' ', '-b', ' ', 'option!'\n        if break_on_hyphens is True, or in:\n          'Look,', ' ', 'goof-ball', ' ', '--', ' ',\n          'use', ' ', 'the', ' ', '-b', ' ', option!'\n        otherwise.\n        ").ToObject()); πE != nil {
						continue
					}
					if πTemp009, πE = πg.ResolveClass(πF, πClass, nil, ß_split); πE != nil {
						continue
					}
					...
					πTemp008 = πg.NewFunction(πg.NewCode("_fix_sentence_endings", "/usr/lib/python2.7/textwrap.py", πTemp011, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
					...
					// line 197: """_fix_sentence_endings(chunks : [string])
					πF.SetLineno(197)
					if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp009}, πg.NewStr("_fix_sentence_endings(chunks : [string])\n\n        Correct for sentence endings buried in 'chunks'.  Eg. when the\n        original text contains \"... foo.\\nBar ...\", munge_whitespace()\n        and split() will convert that to [..., \"foo.\", \" \", \"Bar\", ...]\n        which has one too few spaces; this method simply changes the one\n        space to two.\n        ").ToObject()); πE != nil {
						continue
					}
					if πTemp010, πE = πg.ResolveClass(πF, πClass, nil, ß_fix_sentence_endings); πE != nil {
						continue
					}
					...
					πTemp009 = πg.NewFunction(πg.NewCode("_handle_long_word", "/usr/lib/python2.7/textwrap.py", πTemp011, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
					...
					// line 215: """_handle_long_word(chunks : [string],
					πF.SetLineno(215)
					if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp010}, πg.NewStr("_handle_long_word(chunks : [string],\n                             cur_line : [string],\n                             cur_len : int, width : int)\n\n        Handle a chunk of text (most likely a word, not whitespace) that\n        is too long to fit in any line.\n        ").ToObject()); πE != nil {
						continue
					}
					if πTemp012, πE = πg.ResolveClass(πF, πClass, nil, ß_handle_long_word); πE != nil {
						continue
					}
					...
					πTemp011[0] = πg.Param{Name: "self", Def: nil}
					πTemp011[1] = πg.Param{Name: "chunks", Def: nil}
					πTemp010 = πg.NewFunction(πg.NewCode("_wrap_chunks", "/usr/lib/python2.7/textwrap.py", πTemp011, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
						var µchunks *πg.Object = πArgs[1]; _ = µchunks
					...
					// line 248: """_wrap_chunks(chunks : [string]) -> [string]
					πF.SetLineno(248)
					if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp012}, πg.NewStr("_wrap_chunks(chunks : [string]) -> [string]\n\n        Wrap a sequence of text chunks and return a list of lines of\n        length 'self.width' or less.  (If 'break_long_words' is false,\n        some lines may be longer than this.)  Chunks correspond roughly\n        to words and the whitespace between them: each chunk is\n        indivisible (modulo 'break_long_words'), but a line break can\n        come between any two chunks.  Chunks should not have internal\n        whitespace; ie. a chunk is either all whitespace or a \"word\".\n        Whitespace chunks will be removed from the beginning and end of\n        lines, but apart from that whitespace is preserved.\n        ").ToObject()); πE != nil {
						continue
					}
					if πTemp013, πE = πg.ResolveClass(πF, πClass, nil, ß_wrap_chunks); πE != nil {
						continue
					}
					...
					πTemp011[0] = πg.Param{Name: "self", Def: nil}
					πTemp011[1] = πg.Param{Name: "text", Def: nil}
					πTemp012 = πg.NewFunction(πg.NewCode("wrap", "/usr/lib/python2.7/textwrap.py", πTemp011, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
						var µtext *πg.Object = πArgs[1]; _ = µtext
						var µchunks *πg.Object = πg.UnboundLocal; _ = µchunks
						var πTemp001 []*πg.Object
					...
					// line 323: """wrap(text : string) -> [string]
					πF.SetLineno(323)
					if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp013}, πg.NewStr("wrap(text : string) -> [string]\n\n        Reformat the single paragraph in 'text' so it fits in lines of\n        no more than 'self.width' columns, and return a list of wrapped\n        lines.  Tabs in 'text' are expanded with string.expandtabs(),\n        and all other whitespace characters (including newline) are\n        converted to space.\n        ").ToObject()); πE != nil {
						continue
					}
					if πTemp014, πE = πg.ResolveClass(πF, πClass, nil, ßwrap); πE != nil {
						continue
					}
					...
					πTemp011[0] = πg.Param{Name: "self", Def: nil}
					πTemp011[1] = πg.Param{Name: "text", Def: nil}
					πTemp013 = πg.NewFunction(πg.NewCode("fill", "/usr/lib/python2.7/textwrap.py", πTemp011, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
						var µtext *πg.Object = πArgs[1]; _ = µtext
						var πTemp001 []*πg.Object
						_ = πTemp001
					...
					// line 338: """fill(text : string) -> string
					πF.SetLineno(338)
					if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp014}, πg.NewStr("fill(text : string) -> string\n\n        Reformat the single paragraph in 'text' to fit in lines of no\n        more than 'self.width' columns, and return a new string\n        containing the entire wrapped paragraph.\n        ").ToObject()); πE != nil {
						continue
					}
					if πTemp015, πE = πg.ResolveClass(πF, πClass, nil, ßfill); πE != nil {
						continue
					}
			...
			πTemp001 = πg.NewFunction(πg.NewCode("wrap", "/usr/lib/python2.7/textwrap.py", πTemp009, πg.CodeFlagKWArg, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
			...
			// line 350: """Wrap a single paragraph of text, returning a list of wrapped lines.
			πF.SetLineno(350)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp007}, πg.NewStr("Wrap a single paragraph of text, returning a list of wrapped lines.\n\n    Reformat the single paragraph in 'text' so it fits in lines of no\n    more than 'width' columns, and return a list of wrapped lines.  By\n    default, tabs in 'text' are expanded with string.expandtabs(), and\n    all other whitespace characters (including newline) are converted to\n    space.  See TextWrapper class for available keyword args to customize\n    wrapping behaviour.\n    ").ToObject()); πE != nil {
				continue
			}
			if πTemp008, πE = πg.ResolveGlobal(πF, ßwrap); πE != nil {
				continue
			}
			...
			πTemp009[0] = πg.Param{Name: "text", Def: nil}
			πTemp009[1] = πg.Param{Name: "width", Def: πg.NewInt(70).ToObject()}
			πTemp007 = πg.NewFunction(πg.NewCode("fill", "/usr/lib/python2.7/textwrap.py", πTemp009, πg.CodeFlagKWArg, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µtext *πg.Object = πArgs[0]; _ = µtext
				var µwidth *πg.Object = πArgs[1]; _ = µwidth
				var µkwargs *πg.Object = πArgs[2]; _ = µkwargs
				var µw *πg.Object = πg.UnboundLocal; _ = µw
			...
			// line 363: """Fill a single paragraph of text, returning a new string.
			πF.SetLineno(363)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp008}, πg.NewStr("Fill a single paragraph of text, returning a new string.\n\n    Reformat the single paragraph in 'text' to fit in lines of no more\n    than 'width' columns, and return a new string containing the entire\n    wrapped paragraph.  As with wrap(), tabs are expanded and other\n    whitespace characters converted to space.  See TextWrapper class for\n    available keyword args to customize wrapping behaviour.\n    ").ToObject()); πE != nil {
				continue
			}
			if πTemp010, πE = πg.ResolveGlobal(πF, ßfill); πE != nil {
				continue
			}
			...
			πTemp009[0] = πg.Param{Name: "text", Def: nil}
			πTemp008 = πg.NewFunction(πg.NewCode("dedent", "/usr/lib/python2.7/textwrap.py", πTemp009, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µtext *πg.Object = πArgs[0]; _ = µtext
			...
			// line 381: """Remove any common leading whitespace from every line in `text`.
			πF.SetLineno(381)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp010}, πg.NewStr("Remove any common leading whitespace from every line in `text`.\n\n    This can be used to make triple-quoted strings line up with the left\n    edge of the display, while still presenting them in the source code\n    in indented form.\n\n    Note that tabs and spaces are both treated as whitespace, but they\n    are not equal: the lines \"  hello\" and \"\\thello\" are\n    considered to have no common leading whitespace.  (This behaviour is\n    new in Python 2.5; older versions of this module incorrectly\n    expanded tabs before searching for common leading whitespace.)\n    ").ToObject()); πE != nil {
				continue
			}
			if πTemp011, πE = πg.ResolveGlobal(πF, ßdedent); πE != nil {
				continue
			}
