...
var Code *πg.Code
func init() {
	Code = πg.NewCode("<module>", "/usr/lib/python2.7/select_.py", nil, 0, func(πF *πg.Frame, _ []*πg.Object) (*πg.Object, *πg.BaseException) {
		...
		for ; πF.State() >= 0; πF.PopCheckpoint() {
			...
			πTemp001 = πTemp002[0]
			if πTemp003, πE = πg.GetAttrImport(πF, πTemp001, ßFD_SETSIZE); πE != nil {
				continue
			}
			...
			πTemp001 = πTemp002[0]
			if πTemp003, πE = πg.GetAttrImport(πF, πTemp001, ßSelect); πE != nil {
				continue
			}
			...
			πTemp001 = πTemp002[0]
			if πTemp003, πE = πg.GetAttrImport(πF, πTemp001, ßFdSet); πE != nil {
				continue
			}
			...
			πTemp001 = πTemp002[0]
			if πTemp003, πE = πg.GetAttrImport(πF, πTemp001, ßTimeval); πE != nil {
				continue
			}
			...
			_, πE = πg.NewCode("error", "/usr/lib/python2.7/select_.py", nil, 0, func(πF *πg.Frame, _ []*πg.Object) (*πg.Object, *πg.BaseException) {
				πClass := πTemp004
				_ = πClass
				for ; πF.State() >= 0; πF.PopCheckpoint() {
					switch πF.State() {
			...
			πTemp001 = πg.NewFunction(πg.NewCode("select", "/usr/lib/python2.7/select_.py", πTemp006, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				...
				Label6:
					...
					πTemp005 = πg.NewFunction(πg.NewCode("<generator>", "/usr/lib/python2.7/select_.py", πTemp006, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
					...
					πTemp006 = make([]πg.Param, 0)
					πTemp008 = πg.NewFunction(πg.NewCode("<generator>", "/usr/lib/python2.7/select_.py", πTemp006, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µi *πg.Object = πg.UnboundLocal; _ = µi
						var µfd *πg.Object = πg.UnboundLocal; _ = µfd
						var πTemp001 *πg.Object
						_ = πTemp001
					...
					πTemp006 = make([]πg.Param, 0)
					πTemp010 = πg.NewFunction(πg.NewCode("<generator>", "/usr/lib/python2.7/select_.py", πTemp006, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µi *πg.Object = πg.UnboundLocal; _ = µi
						var µfd *πg.Object = πg.UnboundLocal; _ = µfd
						var πTemp001 *πg.Object
						_ = πTemp001
			...
			πTemp003 = πg.NewFunction(πg.NewCode("_fdset_set", "/usr/lib/python2.7/select_.py", πTemp006, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
			...
			πTemp006[0] = πg.Param{Name: "fd", Def: nil}
			πTemp006[1] = πg.Param{Name: "fds", Def: nil}
			πTemp005 = πg.NewFunction(πg.NewCode("_fdset_isset", "/usr/lib/python2.7/select_.py", πTemp006, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µfd *πg.Object = πArgs[0]; _ = µfd
				var µfds *πg.Object = πArgs[1]; _ = µfds
				var µidx *πg.Object = πg.UnboundLocal; _ = µidx
				var µpos *πg.Object = πg.UnboundLocal; _ = µpos
			...
			πTemp007 = πg.NewFunction(πg.NewCode("_make_fdset", "/usr/lib/python2.7/select_.py", πTemp006, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
			...
			πTemp008 = πg.NewFunction(πg.NewCode("_normalize_fd_list", "/usr/lib/python2.7/select_.py", πTemp006, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
