...
var Code *πg.Code
func init() {
	Code = πg.NewCode("<module>", "/usr/lib/python2.7/copy_reg.py", nil, 0, func(πF *πg.Frame, _ []*πg.Object) (*πg.Object, *πg.BaseException) {
		...
		for ; πF.State() >= 0; πF.PopCheckpoint() {
			...
			// line 1: """Helper to provide extensibility for pickle/cPickle.
			πF.SetLineno(1)
			if πE = πF.Globals().SetItem(πF, ß__doc__.ToObject(), πg.NewStr("Helper to provide extensibility for pickle/cPickle.\n\nThis is only useful to add pickle support for extension types defined in\nC, not for instances of user-defined classes.\n").ToObject()); πE != nil {
				continue
			}
			...
			πTemp002 = πg.NewFunction(πg.NewCode("pickle", "/usr/lib/python2.7/copy_reg.py", πTemp004, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
			...
			πTemp005 = πg.NewFunction(πg.NewCode("constructor", "/usr/lib/python2.7/copy_reg.py", πTemp004, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
			...
			πTemp006 = πg.NewFunction(πg.NewCode("pickle_complex", "/usr/lib/python2.7/copy_reg.py", πTemp004, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
		...
		Label1:
			...
			πTemp007 = πg.NewFunction(πg.NewCode("_reconstructor", "/usr/lib/python2.7/copy_reg.py", πTemp004, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
			...
			πTemp008 = πg.NewFunction(πg.NewCode("_reduce_ex", "/usr/lib/python2.7/copy_reg.py", πTemp004, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
			...
			πTemp004 = make([]πg.Param, 1)
			πTemp004[0] = πg.Param{Name: "cls", Def: nil}
			πTemp012 = πg.NewFunction(πg.NewCode("__newobj__", "/usr/lib/python2.7/copy_reg.py", πTemp004, πg.CodeFlagVarArg, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µcls *πg.Object = πArgs[0]; _ = µcls
			...
			πTemp004 = make([]πg.Param, 1)
			πTemp004[0] = πg.Param{Name: "cls", Def: nil}
			πTemp013 = πg.NewFunction(πg.NewCode("_slotnames", "/usr/lib/python2.7/copy_reg.py", πTemp004, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µcls *πg.Object = πArgs[0]; _ = µcls
			...
			// line 96: """Return a list of slot names for a given class.
			πF.SetLineno(96)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp014}, πg.NewStr("Return a list of slot names for a given class.\n\n    This needs to find slots defined by the class and its bases, so we\n    can't simply return the __slots__ attribute.  We must walk down\n    the Method Resolution Order and concatenate the __slots__ of each\n    class found there.  (This assumes classes don't modify their\n    __slots__ attribute to misrepresent their slots after the class is\n    defined.)\n    ").ToObject()); πE != nil {
				continue
			}
			if πTemp015, πE = πg.ResolveGlobal(πF, ß_slotnames); πE != nil {
				continue
			}
			...
			πTemp014 = πg.NewFunction(πg.NewCode("add_extension", "/usr/lib/python2.7/copy_reg.py", πTemp004, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
			...
			// line 158: """Register an extension code."""
			πF.SetLineno(158)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp015}, πg.NewStr("Register an extension code.").ToObject()); πE != nil {
				continue
			}
			if πTemp016, πE = πg.ResolveGlobal(πF, ßadd_extension); πE != nil {
				continue
			}
			...
			πTemp004[1] = πg.Param{Name: "name", Def: nil}
			πTemp004[2] = πg.Param{Name: "code", Def: nil}
			πTemp015 = πg.NewFunction(πg.NewCode("remove_extension", "/usr/lib/python2.7/copy_reg.py", πTemp004, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µmodule *πg.Object = πArgs[0]; _ = µmodule
				var µname *πg.Object = πArgs[1]; _ = µname
				var µcode *πg.Object = πArgs[2]; _ = µcode
				var µkey *πg.Object = πg.UnboundLocal; _ = µkey
			...
			// line 176: """Unregister an extension code.  For testing only."""
			πF.SetLineno(176)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp016}, πg.NewStr("Unregister an extension code.  For testing only.").ToObject()); πE != nil {
				continue
			}
			if πTemp017, πE = πg.ResolveGlobal(πF, ßremove_extension); πE != nil {
				continue
			}
			...
			πTemp016 = πg.NewFunction(πg.NewCode("clear_extension_cache", "/usr/lib/python2.7/copy_reg.py", πTemp004, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var πTemp001 *πg.Object
				_ = πTemp001
				var πTemp002 *πg.Object
				_ = πTemp002
