...
var Code *πg.Code
func init() {
	Code = πg.NewCode("<module>", "/usr/lib/python2.7/tempfile.py", nil, 0, func(πF *πg.Frame, _ []*πg.Object) (*πg.Object, *πg.BaseException) {
		...
		for ; πF.State() >= 0; πF.PopCheckpoint() {
			...
			// line 15: """Generate temporary files and directories."""
			πF.SetLineno(15)
			if πE = πF.Globals().SetItem(πF, ß__doc__.ToObject(), πg.NewStr("Generate temporary files and directories.").ToObject()); πE != nil {
				continue
			}
			...
			πTemp001 = πTemp002[0]
			if πTemp003, πE = πg.GetAttrImport(πF, πTemp001, ßTempDir); πE != nil {
				continue
			}
			...
			πTemp001 = πTemp002[0]
			if πTemp003, πE = πg.GetAttrImport(πF, πTemp001, ßTempFile); πE != nil {
				continue
			}
			...
			πTemp001 = πTemp002[0]
			if πTemp003, πE = πg.GetAttrImport(πF, πTemp001, ßDup); πE != nil {
				continue
			}
			...
			πTemp001 = πg.NewFunction(πg.NewCode("mkdtemp", "/usr/lib/python2.7/tempfile.py", πTemp004, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
			...
			πTemp003 = πg.NewFunction(πg.NewCode("mkstemp", "/usr/lib/python2.7/tempfile.py", πTemp004, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µsuffix *πg.Object = πArgs[0]; _ = µsuffix
				var µprefix *πg.Object = πArgs[1]; _ = µprefix
				var µdir *πg.Object = πArgs[2]; _ = µdir
