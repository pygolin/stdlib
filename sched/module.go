...
var Code *πg.Code
func init() {
	Code = πg.NewCode("<module>", "/usr/lib/python2.7/sched.py", nil, 0, func(πF *πg.Frame, _ []*πg.Object) (*πg.Object, *πg.BaseException) {
		...
		for ; πF.State() >= 0; πF.PopCheckpoint() {
			...
			_, πE = πg.NewCode("Event", "/usr/lib/python2.7/sched.py", nil, 0, func(πF *πg.Frame, _ []*πg.Object) (*πg.Object, *πg.BaseException) {
				πClass := πTemp003
				_ = πClass
				var πTemp001 []*πg.Object
				_ = πTemp001
				...
				for ; πF.State() >= 0; πF.PopCheckpoint() {
					...
					πTemp002 = πg.NewFunction(πg.NewCode("__init__", "/usr/lib/python2.7/sched.py", πTemp003, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
					...
					πTemp003[0] = πg.Param{Name: "self", Def: nil}
					πTemp004 = πg.NewFunction(πg.NewCode("get_fields", "/usr/lib/python2.7/sched.py", πTemp003, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
						var πTemp001 *πg.Object
						_ = πTemp001
						var πTemp002 *πg.Object
					...
					πTemp005 = πg.NewFunction(πg.NewCode("__eq__", "/usr/lib/python2.7/sched.py", πTemp003, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
					...
					πTemp003[0] = πg.Param{Name: "s", Def: nil}
					πTemp003[1] = πg.Param{Name: "o", Def: nil}
					πTemp006 = πg.NewFunction(πg.NewCode("__lt__", "/usr/lib/python2.7/sched.py", πTemp003, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µs *πg.Object = πArgs[0]; _ = µs
						var µo *πg.Object = πArgs[1]; _ = µo
						var πTemp001 *πg.Object
						_ = πTemp001
					...
					πTemp003[0] = πg.Param{Name: "s", Def: nil}
					πTemp003[1] = πg.Param{Name: "o", Def: nil}
					πTemp007 = πg.NewFunction(πg.NewCode("__le__", "/usr/lib/python2.7/sched.py", πTemp003, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µs *πg.Object = πArgs[0]; _ = µs
						var µo *πg.Object = πArgs[1]; _ = µo
						var πTemp001 *πg.Object
						_ = πTemp001
					...
					πTemp003[0] = πg.Param{Name: "s", Def: nil}
					πTemp003[1] = πg.Param{Name: "o", Def: nil}
					πTemp008 = πg.NewFunction(πg.NewCode("__gt__", "/usr/lib/python2.7/sched.py", πTemp003, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µs *πg.Object = πArgs[0]; _ = µs
						var µo *πg.Object = πArgs[1]; _ = µo
						var πTemp001 *πg.Object
						_ = πTemp001
					...
					πTemp003[0] = πg.Param{Name: "s", Def: nil}
					πTemp003[1] = πg.Param{Name: "o", Def: nil}
					πTemp009 = πg.NewFunction(πg.NewCode("__ge__", "/usr/lib/python2.7/sched.py", πTemp003, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µs *πg.Object = πArgs[0]; _ = µs
						var µo *πg.Object = πArgs[1]; _ = µo
						var πTemp001 *πg.Object
						_ = πTemp001
			...
			_, πE = πg.NewCode("scheduler", "/usr/lib/python2.7/sched.py", nil, 0, func(πF *πg.Frame, _ []*πg.Object) (*πg.Object, *πg.BaseException) {
				πClass := πTemp003
				_ = πClass
				var πTemp001 *πg.Object
				_ = πTemp001
				...
				for ; πF.State() >= 0; πF.PopCheckpoint() {
					...
					πTemp001 = πg.NewFunction(πg.NewCode("__init__", "/usr/lib/python2.7/sched.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
					...
					// line 58: """Initialize a new instance, passing the time and delay
					πF.SetLineno(58)
					if πE = πClass.SetItem(πF, ß__doc__.ToObject(), πg.NewStr("Initialize a new instance, passing the time and delay\n        functions").ToObject()); πE != nil {
						continue
					}
					if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp003}, πg.NewStr("Initialize a new instance, passing the time and delay\n        functions").ToObject()); πE != nil {
						continue
					}
					...
					πTemp003 = πg.NewFunction(πg.NewCode("enterabs", "/usr/lib/python2.7/sched.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
						var µtime *πg.Object = πArgs[1]; _ = µtime
						var µpriority *πg.Object = πArgs[2]; _ = µpriority
						var µaction *πg.Object = πArgs[3]; _ = µaction
					...
					// line 65: """Enter a new event in the queue at an absolute time.
					πF.SetLineno(65)
					if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp004}, πg.NewStr("Enter a new event in the queue at an absolute time.\n        Returns an ID for the event which can be used to remove it,\n        if necessary.\n        ").ToObject()); πE != nil {
						continue
					}
					if πTemp005, πE = πg.ResolveClass(πF, πClass, nil, ßenterabs); πE != nil {
						continue
					}
					...
					πTemp002[3] = πg.Param{Name: "action", Def: nil}
					πTemp002[4] = πg.Param{Name: "argument", Def: nil}
					πTemp004 = πg.NewFunction(πg.NewCode("enter", "/usr/lib/python2.7/sched.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
					...
					// line 74: """A variant that specifies the time as a relative time.
					πF.SetLineno(74)
					if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp005}, πg.NewStr("A variant that specifies the time as a relative time.\n        This is actually the more commonly used interface.\n        ").ToObject()); πE != nil {
						continue
					}
					if πTemp006, πE = πg.ResolveClass(πF, πClass, nil, ßenter); πE != nil {
						continue
					}
					...
					πTemp005 = πg.NewFunction(πg.NewCode("cancel", "/usr/lib/python2.7/sched.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
					...
					// line 81: """Remove an event from the queue.
					πF.SetLineno(81)
					if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp006}, πg.NewStr("Remove an event from the queue.\n        This must be presented the ID as returned by enter().\n        If the event is not in the queue, this raises ValueError.\n        ").ToObject()); πE != nil {
						continue
					}
					...
					πTemp002[0] = πg.Param{Name: "self", Def: nil}
					πTemp006 = πg.NewFunction(πg.NewCode("empty", "/usr/lib/python2.7/sched.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
						var πTemp001 *πg.Object
						_ = πTemp001
						var πTemp002 *πg.Object
					...
					// line 89: """Check whether the queue is empty."""
					πF.SetLineno(89)
					if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp007}, πg.NewStr("Check whether the queue is empty.").ToObject()); πE != nil {
						continue
					}
					...
					πTemp002 = make([]πg.Param, 1)
					πTemp002[0] = πg.Param{Name: "self", Def: nil}
					πTemp007 = πg.NewFunction(πg.NewCode("run", "/usr/lib/python2.7/sched.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
					...
					// line 93: """Execute events until the queue is empty.
					πF.SetLineno(93)
					if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp008}, πg.NewStr("Execute events until the queue is empty.\n        When there is a positive delay until the first event, the\n        delay function is called and the event is left in the queue;\n        otherwise, the event is removed from the queue and executed\n        (its action function is called, passing it the argument).  If\n        the delay function returns prematurely, it is simply\n        restarted.\n        It is legal for both the delay function and the action\n        function to modify the queue or to raise an exception;\n        exceptions are not caught but the scheduler's state remains\n        well-defined so run() may be called again.\n        A questionable hack is added to allow other threads to run:\n        just after an event is executed, a delay of 0 is executed, to\n        avoid monopolizing the CPU when other threads are also\n        runnable.\n        ").ToObject()); πE != nil {
						continue
					}
					if πTemp009, πE = πg.ResolveClass(πF, πClass, nil, ßrun); πE != nil {
						continue
					}
					...
					πTemp002 = make([]πg.Param, 1)
					πTemp002[0] = πg.Param{Name: "self", Def: nil}
					πTemp008 = πg.NewFunction(πg.NewCode("queue", "/usr/lib/python2.7/sched.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
					...
					// line 134: """An ordered list of upcoming events.
					πF.SetLineno(134)
					if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp009}, πg.NewStr("An ordered list of upcoming events.\n        Events are named tuples with fields for:\n            time, priority, action, arguments\n        ").ToObject()); πE != nil {
						continue
					}
					...
					if πTemp009, πE = πg.ResolveClass(πF, πClass, nil, ßqueue); πE != nil {
						continue
					}
					πTemp011[0] = πTemp009
					...
					if πE = πClass.SetItem(πF, ßqueue.ToObject(), πTemp010); πE != nil {
						continue
					}
				}
				return nil, nil
