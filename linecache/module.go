...
var Code *πg.Code
func init() {
	Code = πg.NewCode("<module>", "/usr/lib/python2.7/linecache.py", nil, 0, func(πF *πg.Frame, _ []*πg.Object) (*πg.Object, *πg.BaseException) {
		...
		for ; πF.State() >= 0; πF.PopCheckpoint() {
			...
			// line 1: """Cache lines from files.
			πF.SetLineno(1)
			if πE = πF.Globals().SetItem(πF, ß__doc__.ToObject(), πg.NewStr("Cache lines from files.\n\nThis is intended to read lines from modules imported -- hence if a filename\nis not found, it will look down the module search path for a file by\nthat name.\n").ToObject()); πE != nil {
				continue
			}
			// line 8: import sys
			πF.SetLineno(8)
			...
			πTemp001 = πg.NewFunction(πg.NewCode("getline", "/usr/lib/python2.7/linecache.py", πTemp003, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
			...
			πTemp004 = πg.NewFunction(πg.NewCode("clearcache", "/usr/lib/python2.7/linecache.py", πTemp003, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
			...
			// line 27: """Clear the cache entirely."""
			πF.SetLineno(27)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp006}, πg.NewStr("Clear the cache entirely.").ToObject()); πE != nil {
				continue
			}
			if πTemp007, πE = πg.ResolveGlobal(πF, ßclearcache); πE != nil {
				continue
			}
			...
			πTemp006 = πg.NewFunction(πg.NewCode("getlines", "/usr/lib/python2.7/linecache.py", πTemp003, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µfilename *πg.Object = πArgs[0]; _ = µfilename
			...
			// line 34: """Get the lines for a file from the cache.
			πF.SetLineno(34)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp007}, πg.NewStr("Get the lines for a file from the cache.\n    Update the cache if it doesn't contain an entry for this file already.").ToObject()); πE != nil {
				continue
			}
			if πTemp008, πE = πg.ResolveGlobal(πF, ßgetlines); πE != nil {
				continue
			}
			...
			πTemp007 = πg.NewFunction(πg.NewCode("checkcache", "/usr/lib/python2.7/linecache.py", πTemp003, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µfilename *πg.Object = πArgs[0]; _ = µfilename
			...
			// line 48: """Discard cache entries that are out of date.
			πF.SetLineno(48)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp008}, πg.NewStr("Discard cache entries that are out of date.\n    (This is not checked upon each call!)").ToObject()); πE != nil {
				continue
			}
			if πTemp009, πE = πg.ResolveGlobal(πF, ßcheckcache); πE != nil {
				continue
			}
			...
			πTemp008 = πg.NewFunction(πg.NewCode("updatecache", "/usr/lib/python2.7/linecache.py", πTemp003, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µfilename *πg.Object = πArgs[0]; _ = µfilename
				var µmodule_globals *πg.Object = πArgs[1]; _ = µmodule_globals
				var µfullname *πg.Object = πg.UnboundLocal; _ = µfullname
				var µstat *πg.Object = πg.UnboundLocal; _ = µstat
				...
				Label19:
					...
					πTemp010 = πg.NewFunction(πg.NewCode("<generator>", "/usr/lib/python2.7/linecache.py", πTemp011, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				...
				Label33:
					...
					πE = nil
					πTemp008, πTemp009 = πF.ExcInfo()
					if πTemp007, πE = πg.ResolveGlobal(πF, ßIOError); πE != nil {
						continue
					}
					if πTemp003, πE = πg.IsInstance(πF, πTemp008.ToObject(), πTemp007); πE != nil {
						continue
					}
					if πTemp003 {
						goto Label35
				...
				Label32:
					...
					if πTemp016, πE = πg.GetItem(πF, µlines, πTemp015); πE != nil {
						continue
					}
					if πTemp015, πE = πg.GetAttr(πF, πTemp016, ßendswith, nil); πE != nil {
						continue
					}
					if πTemp016, πE = πTemp015.Call(πF, πTemp005, nil); πE != nil {
						continue
					}
					πF.FreeArgs(πTemp005)
					if πTemp004, πE = πg.IsTrue(πF, πTemp016); πE != nil {
						continue
					}
					πTemp012 = πg.GetBool(!πTemp004).ToObject()
					πTemp007 = πTemp012
				Label36:
					if πTemp003, πE = πg.IsTrue(πF, πTemp007); πE != nil {
						continue
				...
				Label37:
					...
					if πTemp012, πE = πg.GetItem(πF, µlines, πTemp007); πE != nil {
						continue
					}
					if πTemp007, πE = πg.IAdd(πF, πTemp012, πg.NewStr("\n").ToObject()); πE != nil {
						continue
					}
					if πE = πg.CheckLocal(πF, µlines, "lines"); πE != nil {
						continue
					...
					πTemp015 = πTemp016
					if πE = πg.SetItem(πF, µlines, πTemp015, πTemp007); πE != nil {
						continue
					}
					goto Label38
				Label38:
					...
					if πTemp012, πE = πg.GetAttr(πF, µstat, ßst_size, nil); πE != nil {
						continue
					}
					if πE = πg.CheckLocal(πF, µstat, "stat"); πE != nil {
						continue
					}
					if πTemp015, πE = πg.GetAttr(πF, µstat, ßst_mtime, nil); πE != nil {
						continue
					}
					πTemp007 = πg.NewTuple2(πTemp012, πTemp015).ToObject()
					if πE = πg.Tie(πF, πg.TieTarget{Children: []πg.TieTarget{πg.TieTarget{Target: &πTemp012}, πg.TieTarget{Target: &πTemp015}}}, πTemp007); πE != nil {
						continue
					}
					µsize = πTemp012
					µmtime = πTemp015
					...
					πTemp007 = πg.NewTuple4(µsize, µmtime, µlines, µfullname).ToObject()
					if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp012}, πTemp007); πE != nil {
						continue
					}
					if πTemp015, πE = πg.ResolveGlobal(πF, ßcache); πE != nil {
						continue
					}
					if πE = πg.CheckLocal(πF, µfilename, "filename"); πE != nil {
						continue
					...
					πTemp016 = µfilename
					if πE = πg.SetItem(πF, πTemp015, πTemp016, πTemp012); πE != nil {
						continue
					}
			...
			// line 73: """Update a cache entry and return its list of lines.
			πF.SetLineno(73)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp009}, πg.NewStr("Update a cache entry and return its list of lines.\n    If something's wrong, print a message, discard the cache entry,\n    and return an empty list.").ToObject()); πE != nil {
				continue
			}
			if πTemp010, πE = πg.ResolveGlobal(πF, ßupdatecache); πE != nil {
				continue
			}
