...
var Code *πg.Code
func init() {
	Code = πg.NewCode("<module>", "/usr/lib/python2.7/traceback.py", nil, 0, func(πF *πg.Frame, _ []*πg.Object) (*πg.Object, *πg.BaseException) {
		...
		for ; πF.State() >= 0; πF.PopCheckpoint() {
			...
			// line 1: """Extract, format and print information about Python stack traces."""
			πF.SetLineno(1)
			if πE = πF.Globals().SetItem(πF, ß__doc__.ToObject(), πg.NewStr("Extract, format and print information about Python stack traces.").ToObject()); πE != nil {
				continue
			}
			...
			πTemp001 = πg.NewFunction(πg.NewCode("_print", "/usr/lib/python2.7/traceback.py", πTemp003, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
			...
			πTemp004 = πg.NewFunction(πg.NewCode("print_list", "/usr/lib/python2.7/traceback.py", πTemp003, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
			...
			// line 17: """Print the list of tuples as returned by extract_tb() or
			πF.SetLineno(17)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp005}, πg.NewStr("Print the list of tuples as returned by extract_tb() or\n    extract_stack() as a formatted stack trace to the given file.").ToObject()); πE != nil {
				continue
			}
			if πTemp006, πE = πg.ResolveGlobal(πF, ßprint_list); πE != nil {
				continue
			}
			...
			πTemp003[0] = πg.Param{Name: "extracted_list", Def: nil}
			πTemp005 = πg.NewFunction(πg.NewCode("format_list", "/usr/lib/python2.7/traceback.py", πTemp003, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µextracted_list *πg.Object = πArgs[0]; _ = µextracted_list
			...
			// line 28: """Format a list of traceback entry tuples for printing.
			πF.SetLineno(28)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp006}, πg.NewStr("Format a list of traceback entry tuples for printing.\n\n    Given a list of tuples as returned by extract_tb() or\n    extract_stack(), return a list of strings ready for printing.\n    Each string in the resulting list corresponds to the item with the\n    same index in the argument list.  Each string ends in a newline;\n    the strings may contain internal newlines as well, for those items\n    whose source text line is not None.\n    ").ToObject()); πE != nil {
				continue
			}
			if πTemp007, πE = πg.ResolveGlobal(πF, ßformat_list); πE != nil {
				continue
			}
			...
			πTemp006 = πg.NewFunction(πg.NewCode("print_tb", "/usr/lib/python2.7/traceback.py", πTemp003, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
			...
			// line 47: """Print up to 'limit' stack trace entries from the traceback 'tb'.
			πF.SetLineno(47)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp007}, πg.NewStr("Print up to 'limit' stack trace entries from the traceback 'tb'.\n\n    If 'limit' is omitted or None, all entries are printed.  If 'file'\n    is omitted or None, the output goes to sys.stderr; otherwise\n    'file' should be an open file or file-like object with a write()\n    method.\n    ").ToObject()); πE != nil {
				continue
			}
			if πTemp008, πE = πg.ResolveGlobal(πF, ßprint_tb); πE != nil {
				continue
			}
			...
			πTemp007 = πg.NewFunction(πg.NewCode("format_tb", "/usr/lib/python2.7/traceback.py", πTemp003, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µtb *πg.Object = πArgs[0]; _ = µtb
				var µlimit *πg.Object = πArgs[1]; _ = µlimit
				var πTemp001 []*πg.Object
				_ = πTemp001
			...
			// line 75: """A shorthand for 'format_list(extract_tb(tb, limit))'."""
			πF.SetLineno(75)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp008}, πg.NewStr("A shorthand for 'format_list(extract_tb(tb, limit))'.").ToObject()); πE != nil {
				continue
			}
			if πTemp009, πE = πg.ResolveGlobal(πF, ßformat_tb); πE != nil {
				continue
			}
			...
			πTemp008 = πg.NewFunction(πg.NewCode("extract_tb", "/usr/lib/python2.7/traceback.py", πTemp003, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µtb *πg.Object = πArgs[0]; _ = µtb
				var µlimit *πg.Object = πArgs[1]; _ = µlimit
				var µlist *πg.Object = πg.UnboundLocal; _ = µlist
				var µn *πg.Object = πg.UnboundLocal; _ = µn
			...
			// line 79: """Return list of up to limit pre-processed entries from traceback.
			πF.SetLineno(79)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp009}, πg.NewStr("Return list of up to limit pre-processed entries from traceback.\n\n    This is useful for alternate formatting of stack traces.  If\n    'limit' is omitted or None, all entries are extracted.  A\n    pre-processed stack trace entry is a quadruple (filename, line\n    number, function name, text) representing the information that is\n    usually printed for a stack trace.  The text is a string with\n    leading and trailing whitespace stripped; if the source is not\n    available it is None.\n    ").ToObject()); πE != nil {
				continue
			}
			if πTemp010, πE = πg.ResolveGlobal(πF, ßextract_tb); πE != nil {
				continue
			}
			...
			πTemp009 = πg.NewFunction(πg.NewCode("print_exception", "/usr/lib/python2.7/traceback.py", πTemp003, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
			...
			// line 111: """Print exception up to 'limit' stack trace entries from 'tb' to 'file'.
			πF.SetLineno(111)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp010}, πg.NewStr("Print exception up to 'limit' stack trace entries from 'tb' to 'file'.\n\n    This differs from print_tb() in the following ways: (1) if\n    traceback is not None, it prints a header \"Traceback (most recent\n    call last):\"; (2) it prints the exception type and value after the\n    stack trace; (3) if type is SyntaxError and value has the\n    appropriate format, it prints the line where the syntax error\n    occurred with a caret on the next line indicating the approximate\n    position of the error.\n    ").ToObject()); πE != nil {
				continue
			}
			if πTemp011, πE = πg.ResolveGlobal(πF, ßprint_exception); πE != nil {
				continue
			}
			...
			πTemp010 = πg.NewFunction(πg.NewCode("format_exception", "/usr/lib/python2.7/traceback.py", πTemp003, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µetype *πg.Object = πArgs[0]; _ = µetype
				var µvalue *πg.Object = πArgs[1]; _ = µvalue
				var µtb *πg.Object = πArgs[2]; _ = µtb
				var µlimit *πg.Object = πArgs[3]; _ = µlimit
			...
			// line 133: """Format a stack trace and the exception information.
			πF.SetLineno(133)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp011}, πg.NewStr("Format a stack trace and the exception information.\n\n    The arguments have the same meaning as the corresponding arguments\n    to print_exception().  The return value is a list of strings, each\n    ending in a newline and some containing internal newlines.  When\n    these lines are concatenated and printed, exactly the same text is\n    printed as does print_exception().\n    ").ToObject()); πE != nil {
				continue
			}
			if πTemp012, πE = πg.ResolveGlobal(πF, ßformat_exception); πE != nil {
				continue
			}
			...
			πTemp003[0] = πg.Param{Name: "etype", Def: nil}
			πTemp003[1] = πg.Param{Name: "value", Def: nil}
			πTemp011 = πg.NewFunction(πg.NewCode("format_exception_only", "/usr/lib/python2.7/traceback.py", πTemp003, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µetype *πg.Object = πArgs[0]; _ = µetype
				var µvalue *πg.Object = πArgs[1]; _ = µvalue
				...
				Label11:
					...
					πTemp001 = πg.NewFunction(πg.NewCode("<generator>", "/usr/lib/python2.7/traceback.py", πTemp010, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
			...
			// line 150: """Format the exception part of a traceback.
			πF.SetLineno(150)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp012}, πg.NewStr("Format the exception part of a traceback.\n\n    The arguments are the exception type and value such as given by\n    sys.last_type and sys.last_value. The return value is a list of\n    strings, each ending in a newline.\n\n    Normally, the list contains a single string; however, for\n    SyntaxError exceptions, it contains several lines that (when\n    printed) display detailed information about where the syntax\n    error occurred.\n\n    The message indicating which exception occurred is always the last\n    string in the list.\n\n    ").ToObject()); πE != nil {
				continue
			}
			if πTemp013, πE = πg.ResolveGlobal(πF, ßformat_exception_only); πE != nil {
				continue
			}
			...
			πTemp003[0] = πg.Param{Name: "etype", Def: nil}
			πTemp003[1] = πg.Param{Name: "value", Def: nil}
			πTemp012 = πg.NewFunction(πg.NewCode("_format_final_exc_line", "/usr/lib/python2.7/traceback.py", πTemp003, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µetype *πg.Object = πArgs[0]; _ = µetype
				var µvalue *πg.Object = πArgs[1]; _ = µvalue
			...
			// line 206: """Return a list of a single line -- normal case for format_exception_only"""
			πF.SetLineno(206)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp013}, πg.NewStr("Return a list of a single line -- normal case for format_exception_only").ToObject()); πE != nil {
				continue
			}
			if πTemp014, πE = πg.ResolveGlobal(πF, ß_format_final_exc_line); πE != nil {
				continue
			}
			...
			πTemp013 = πg.NewFunction(πg.NewCode("_some_str", "/usr/lib/python2.7/traceback.py", πTemp003, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
			...
			πTemp014 = πg.NewFunction(πg.NewCode("print_exc", "/usr/lib/python2.7/traceback.py", πTemp003, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
			...
			// line 228: """Shorthand for 'print_exception(sys.exc_type, sys.exc_value, sys.exc_traceback, limit, file)'.
			πF.SetLineno(228)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp015}, πg.NewStr("Shorthand for 'print_exception(sys.exc_type, sys.exc_value, sys.exc_traceback, limit, file)'.\n    (In fact, it uses sys.exc_info() to retrieve the same information\n    in a thread-safe way.)").ToObject()); πE != nil {
				continue
			}
			if πTemp016, πE = πg.ResolveGlobal(πF, ßprint_exc); πE != nil {
				continue
			}
			...
			πTemp015 = πg.NewFunction(πg.NewCode("format_exc", "/usr/lib/python2.7/traceback.py", πTemp003, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µlimit *πg.Object = πArgs[0]; _ = µlimit
				var µetype *πg.Object = πg.UnboundLocal; _ = µetype
				var µvalue *πg.Object = πg.UnboundLocal; _ = µvalue
				var µtb *πg.Object = πg.UnboundLocal; _ = µtb
			...
			// line 243: """Like print_exc() but return a string."""
			πF.SetLineno(243)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp016}, πg.NewStr("Like print_exc() but return a string.").ToObject()); πE != nil {
				continue
			}
			if πTemp017, πE = πg.ResolveGlobal(πF, ßformat_exc); πE != nil {
				continue
			}
			...
			πTemp016 = πg.NewFunction(πg.NewCode("print_last", "/usr/lib/python2.7/traceback.py", πTemp003, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µlimit *πg.Object = πArgs[0]; _ = µlimit
				var µfile *πg.Object = πArgs[1]; _ = µfile
				var πTemp001 *πg.Object
				_ = πTemp001
			...
			// line 252: """This is a shorthand for 'print_exception(sys.last_type,
			πF.SetLineno(252)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp017}, πg.NewStr("This is a shorthand for 'print_exception(sys.last_type,\n    sys.last_value, sys.last_traceback, limit, file)'.").ToObject()); πE != nil {
				continue
			}
			if πTemp018, πE = πg.ResolveGlobal(πF, ßprint_last); πE != nil {
				continue
			}
			...
			πTemp017 = πg.NewFunction(πg.NewCode("print_stack", "/usr/lib/python2.7/traceback.py", πTemp003, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
			...
			// line 263: """Print a stack trace from its invocation point.
			πF.SetLineno(263)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp018}, πg.NewStr("Print a stack trace from its invocation point.\n\n    The optional 'f' argument can be used to specify an alternate\n    stack frame at which to start. The optional 'limit' and 'file'\n    arguments have the same meaning as for print_exception().\n    ").ToObject()); πE != nil {
				continue
			}
			if πTemp019, πE = πg.ResolveGlobal(πF, ßprint_stack); πE != nil {
				continue
			}
			...
			πTemp018 = πg.NewFunction(πg.NewCode("format_stack", "/usr/lib/python2.7/traceback.py", πTemp003, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µf *πg.Object = πArgs[0]; _ = µf
				var µlimit *πg.Object = πArgs[1]; _ = µlimit
				var πTemp001 *πg.Object
				_ = πTemp001
			...
			// line 277: """Shorthand for 'format_list(extract_stack(f, limit))'."""
			πF.SetLineno(277)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp019}, πg.NewStr("Shorthand for 'format_list(extract_stack(f, limit))'.").ToObject()); πE != nil {
				continue
			}
			if πTemp020, πE = πg.ResolveGlobal(πF, ßformat_stack); πE != nil {
				continue
			}
			...
			πTemp019 = πg.NewFunction(πg.NewCode("extract_stack", "/usr/lib/python2.7/traceback.py", πTemp003, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µf *πg.Object = πArgs[0]; _ = µf
				var µlimit *πg.Object = πArgs[1]; _ = µlimit
				var µlist *πg.Object = πg.UnboundLocal; _ = µlist
				var µn *πg.Object = πg.UnboundLocal; _ = µn
			...
			// line 286: """Extract the raw traceback from the current stack frame.
			πF.SetLineno(286)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp020}, πg.NewStr("Extract the raw traceback from the current stack frame.\n\n    The return value has the same format as for extract_tb().  The\n    optional 'f' and 'limit' arguments have the same meaning as for\n    print_stack().  Each item in the list is a quadruple (filename,\n    line number, function name, text), and the entries are in order\n    from oldest to newest stack frame.\n    ").ToObject()); πE != nil {
				continue
			}
			if πTemp021, πE = πg.ResolveGlobal(πF, ßextract_stack); πE != nil {
				continue
			}
			...
			πTemp003 = make([]πg.Param, 1)
			πTemp003[0] = πg.Param{Name: "tb", Def: nil}
			πTemp020 = πg.NewFunction(πg.NewCode("tb_lineno", "/usr/lib/python2.7/traceback.py", πTemp003, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µtb *πg.Object = πArgs[0]; _ = µtb
				var πTemp001 *πg.Object
				_ = πTemp001
				var πR *πg.Object; _ = πR
			...
			// line 320: """Calculate correct line number of traceback given in tb.
			πF.SetLineno(320)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp021}, πg.NewStr("Calculate correct line number of traceback given in tb.\n\n    Obsolete in 2.3.\n    ").ToObject()); πE != nil {
				continue
			}
			if πTemp022, πE = πg.ResolveGlobal(πF, ßtb_lineno); πE != nil {
				continue
			}
