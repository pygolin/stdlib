...
func fun(f *pygolin_runtime.Frame, _ []*pygolin_runtime.Object) (*pygolin_runtime.Object, *pygolin_runtime.BaseException) {
	if o, raised := pygolin_runtime.WrapNative(f, reflect.ValueOf(mod.ExpFloat64)); raised != nil {
		return nil, raised
	} else if raised = f.Globals().SetItemString(f, "ExpFloat64", o); raised != nil {
		return nil, raised
	}
	if o, raised := pygolin_runtime.WrapNative(f, reflect.ValueOf(mod.Float32)); raised != nil {
		return nil, raised
	} else if raised = f.Globals().SetItemString(f, "Float32", o); raised != nil {
		return nil, raised
	}
	if o, raised := pygolin_runtime.WrapNative(f, reflect.ValueOf(mod.Float64)); raised != nil {
		return nil, raised
	} else if raised = f.Globals().SetItemString(f, "Float64", o); raised != nil {
		return nil, raised
	}
	if o, raised := pygolin_runtime.WrapNative(f, reflect.ValueOf(mod.Int)); raised != nil {
		return nil, raised
	} else if raised = f.Globals().SetItemString(f, "Int", o); raised != nil {
		return nil, raised
	}
	if o, raised := pygolin_runtime.WrapNative(f, reflect.ValueOf(mod.Int31)); raised != nil {
		return nil, raised
	} else if raised = f.Globals().SetItemString(f, "Int31", o); raised != nil {
		return nil, raised
	}
	if o, raised := pygolin_runtime.WrapNative(f, reflect.ValueOf(mod.Int31n)); raised != nil {
		return nil, raised
	} else if raised = f.Globals().SetItemString(f, "Int31n", o); raised != nil {
		return nil, raised
	}
	if o, raised := pygolin_runtime.WrapNative(f, reflect.ValueOf(mod.Int63)); raised != nil {
		return nil, raised
	} else if raised = f.Globals().SetItemString(f, "Int63", o); raised != nil {
		return nil, raised
	}
	if o, raised := pygolin_runtime.WrapNative(f, reflect.ValueOf(mod.Int63n)); raised != nil {
		return nil, raised
	} else if raised = f.Globals().SetItemString(f, "Int63n", o); raised != nil {
		return nil, raised
	}
	if o, raised := pygolin_runtime.WrapNative(f, reflect.ValueOf(mod.Intn)); raised != nil {
		return nil, raised
	...
	if o, raised := pygolin_runtime.WrapNative(f, reflect.ValueOf(mod.NewSource)); raised != nil {
		return nil, raised
	} else if raised = f.Globals().SetItemString(f, "NewSource", o); raised != nil {
		return nil, raised
	}
	if o, raised := pygolin_runtime.WrapNative(f, reflect.ValueOf(mod.NewZipf)); raised != nil {
		return nil, raised
	} else if raised = f.Globals().SetItemString(f, "NewZipf", o); raised != nil {
		return nil, raised
	}
	if o, raised := pygolin_runtime.WrapNative(f, reflect.ValueOf(mod.NormFloat64)); raised != nil {
		return nil, raised
	} else if raised = f.Globals().SetItemString(f, "NormFloat64", o); raised != nil {
		return nil, raised
	}
	if o, raised := pygolin_runtime.WrapNative(f, reflect.ValueOf(mod.Perm)); raised != nil {
		return nil, raised
	...
	if o, raised := pygolin_runtime.WrapNative(f, reflect.ValueOf(mod.Seed)); raised != nil {
		return nil, raised
	} else if raised = f.Globals().SetItemString(f, "Seed", o); raised != nil {
		return nil, raised
	}
	if o, raised := pygolin_runtime.WrapNative(f, reflect.ValueOf(mod.Shuffle)); raised != nil {
		return nil, raised
	} else if raised = f.Globals().SetItemString(f, "Shuffle", o); raised != nil {
		return nil, raised
	}
	if o, raised := pygolin_runtime.WrapNative(f, reflect.ValueOf(mod.Uint32)); raised != nil {
		return nil, raised
	} else if raised = f.Globals().SetItemString(f, "Uint32", o); raised != nil {
		return nil, raised
	}
	if o, raised := pygolin_runtime.WrapNative(f, reflect.ValueOf(mod.Uint64)); raised != nil {
		return nil, raised
...
var Code = pygolin_runtime.NewCode("<module>", "math/rand", nil, 0, fun)

func init() {
	pygolin_runtime.RegisterModule("__go__/math/rand", Code)
}
