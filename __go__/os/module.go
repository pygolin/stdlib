...
func fun(f *pygolin_runtime.Frame, _ []*pygolin_runtime.Object) (*pygolin_runtime.Object, *pygolin_runtime.BaseException) {
	if o, raised := pygolin_runtime.WrapNative(f, reflect.ValueOf(mod.Args)); raised != nil {
		return nil, raised
	...
	if o, raised := pygolin_runtime.WrapNative(f, reflect.ValueOf(mod.Chtimes)); raised != nil {
		return nil, raised
	...
	if o, raised := pygolin_runtime.WrapNative(f, reflect.ValueOf(mod.Create)); raised != nil {
		return nil, raised
	} else if raised = f.Globals().SetItemString(f, "Create", o); raised != nil {
		return nil, raised
	}
	if o, raised := pygolin_runtime.WrapNative(f, reflect.ValueOf(mod.DevNull)); raised != nil {
		return nil, raised
	...
	if o, raised := pygolin_runtime.WrapNative(f, reflect.ValueOf(mod.ErrClosed)); raised != nil {
		return nil, raised
	} else if raised = f.Globals().SetItemString(f, "ErrClosed", o); raised != nil {
		return nil, raised
	}
	if o, raised := pygolin_runtime.WrapNative(f, reflect.ValueOf(mod.ErrDeadlineExceeded)); raised != nil {
		return nil, raised
	} else if raised = f.Globals().SetItemString(f, "ErrDeadlineExceeded", o); raised != nil {
		return nil, raised
	}
	if o, raised := pygolin_runtime.WrapNative(f, reflect.ValueOf(mod.ErrExist)); raised != nil {
		return nil, raised
	} else if raised = f.Globals().SetItemString(f, "ErrExist", o); raised != nil {
		return nil, raised
	}
	if o, raised := pygolin_runtime.WrapNative(f, reflect.ValueOf(mod.ErrInvalid)); raised != nil {
		return nil, raised
	} else if raised = f.Globals().SetItemString(f, "ErrInvalid", o); raised != nil {
		return nil, raised
	}
	if o, raised := pygolin_runtime.WrapNative(f, reflect.ValueOf(mod.ErrNoDeadline)); raised != nil {
		return nil, raised
	} else if raised = f.Globals().SetItemString(f, "ErrNoDeadline", o); raised != nil {
		return nil, raised
	}
	if o, raised := pygolin_runtime.WrapNative(f, reflect.ValueOf(mod.ErrNotExist)); raised != nil {
		return nil, raised
	} else if raised = f.Globals().SetItemString(f, "ErrNotExist", o); raised != nil {
		return nil, raised
	}
	if o, raised := pygolin_runtime.WrapNative(f, reflect.ValueOf(mod.ErrPermission)); raised != nil {
		return nil, raised
	} else if raised = f.Globals().SetItemString(f, "ErrPermission", o); raised != nil {
		return nil, raised
	}
	if o, raised := pygolin_runtime.WrapNative(f, reflect.ValueOf(mod.Executable)); raised != nil {
		return nil, raised
	...
	if o, raised := pygolin_runtime.WrapNative(f, reflect.ValueOf(mod.Expand)); raised != nil {
		return nil, raised
	} else if raised = f.Globals().SetItemString(f, "Expand", o); raised != nil {
		return nil, raised
	}
	if o, raised := pygolin_runtime.WrapNative(f, reflect.ValueOf(mod.ExpandEnv)); raised != nil {
		return nil, raised
	...
	if o, raised := pygolin_runtime.WrapNative(f, reflect.ValueOf(mod.FindProcess)); raised != nil {
		return nil, raised
	...
	if o, raised := pygolin_runtime.WrapNative(f, reflect.ValueOf(mod.Hostname)); raised != nil {
		return nil, raised
	} else if raised = f.Globals().SetItemString(f, "Hostname", o); raised != nil {
		return nil, raised
	}
	if o, raised := pygolin_runtime.WrapNative(f, reflect.ValueOf(mod.Interrupt)); raised != nil {
		return nil, raised
	} else if raised = f.Globals().SetItemString(f, "Interrupt", o); raised != nil {
		return nil, raised
	}
	if o, raised := pygolin_runtime.WrapNative(f, reflect.ValueOf(mod.IsExist)); raised != nil {
		return nil, raised
	} else if raised = f.Globals().SetItemString(f, "IsExist", o); raised != nil {
		return nil, raised
	}
	if o, raised := pygolin_runtime.WrapNative(f, reflect.ValueOf(mod.IsNotExist)); raised != nil {
		return nil, raised
	} else if raised = f.Globals().SetItemString(f, "IsNotExist", o); raised != nil {
		return nil, raised
	}
	if o, raised := pygolin_runtime.WrapNative(f, reflect.ValueOf(mod.IsPathSeparator)); raised != nil {
		return nil, raised
	} else if raised = f.Globals().SetItemString(f, "IsPathSeparator", o); raised != nil {
		return nil, raised
	}
	if o, raised := pygolin_runtime.WrapNative(f, reflect.ValueOf(mod.IsPermission)); raised != nil {
		return nil, raised
	} else if raised = f.Globals().SetItemString(f, "IsPermission", o); raised != nil {
		return nil, raised
	}
	if o, raised := pygolin_runtime.WrapNative(f, reflect.ValueOf(mod.IsTimeout)); raised != nil {
		return nil, raised
	} else if raised = f.Globals().SetItemString(f, "IsTimeout", o); raised != nil {
		return nil, raised
	}
	...
	if o, raised := pygolin_runtime.WrapNative(f, reflect.ValueOf(mod.LookupEnv)); raised != nil {
		return nil, raised
	...
	if o, raised := pygolin_runtime.WrapNative(f, reflect.ValueOf(mod.MkdirAll)); raised != nil {
		return nil, raised
	} else if raised = f.Globals().SetItemString(f, "MkdirAll", o); raised != nil {
		return nil, raised
	}
	if o, raised := pygolin_runtime.WrapNative(f, reflect.ValueOf(uint32(mod.ModeAppend))); raised != nil {
		return nil, raised
	} else if raised = f.Globals().SetItemString(f, "ModeAppend", o); raised != nil {
		return nil, raised
	}
	if o, raised := pygolin_runtime.WrapNative(f, reflect.ValueOf(uint32(mod.ModeCharDevice))); raised != nil {
		return nil, raised
	} else if raised = f.Globals().SetItemString(f, "ModeCharDevice", o); raised != nil {
		return nil, raised
	}
	if o, raised := pygolin_runtime.WrapNative(f, reflect.ValueOf(uint32(mod.ModeDevice))); raised != nil {
		return nil, raised
	} else if raised = f.Globals().SetItemString(f, "ModeDevice", o); raised != nil {
		return nil, raised
	}
	if o, raised := pygolin_runtime.WrapNative(f, reflect.ValueOf(uint64(mod.ModeDir))); raised != nil {
		return nil, raised
	} else if raised = f.Globals().SetItemString(f, "ModeDir", o); raised != nil {
		return nil, raised
	}
	if o, raised := pygolin_runtime.WrapNative(f, reflect.ValueOf(uint32(mod.ModeExclusive))); raised != nil {
		return nil, raised
	} else if raised = f.Globals().SetItemString(f, "ModeExclusive", o); raised != nil {
		return nil, raised
	}
	if o, raised := pygolin_runtime.WrapNative(f, reflect.ValueOf(uint32(mod.ModeIrregular))); raised != nil {
		return nil, raised
	} else if raised = f.Globals().SetItemString(f, "ModeIrregular", o); raised != nil {
		return nil, raised
	}
	if o, raised := pygolin_runtime.WrapNative(f, reflect.ValueOf(uint32(mod.ModeNamedPipe))); raised != nil {
		return nil, raised
	} else if raised = f.Globals().SetItemString(f, "ModeNamedPipe", o); raised != nil {
		return nil, raised
	}
	if o, raised := pygolin_runtime.WrapNative(f, reflect.ValueOf(uint32(mod.ModePerm))); raised != nil {
		return nil, raised
	} else if raised = f.Globals().SetItemString(f, "ModePerm", o); raised != nil {
		return nil, raised
	}
	if o, raised := pygolin_runtime.WrapNative(f, reflect.ValueOf(uint32(mod.ModeSetgid))); raised != nil {
		return nil, raised
	} else if raised = f.Globals().SetItemString(f, "ModeSetgid", o); raised != nil {
		return nil, raised
	}
	if o, raised := pygolin_runtime.WrapNative(f, reflect.ValueOf(uint32(mod.ModeSetuid))); raised != nil {
		return nil, raised
	} else if raised = f.Globals().SetItemString(f, "ModeSetuid", o); raised != nil {
		return nil, raised
	}
	if o, raised := pygolin_runtime.WrapNative(f, reflect.ValueOf(uint32(mod.ModeSocket))); raised != nil {
		return nil, raised
	} else if raised = f.Globals().SetItemString(f, "ModeSocket", o); raised != nil {
		return nil, raised
	}
	if o, raised := pygolin_runtime.WrapNative(f, reflect.ValueOf(uint32(mod.ModeSticky))); raised != nil {
		return nil, raised
	} else if raised = f.Globals().SetItemString(f, "ModeSticky", o); raised != nil {
		return nil, raised
	}
	if o, raised := pygolin_runtime.WrapNative(f, reflect.ValueOf(uint32(mod.ModeSymlink))); raised != nil {
		return nil, raised
	} else if raised = f.Globals().SetItemString(f, "ModeSymlink", o); raised != nil {
		return nil, raised
	}
	if o, raised := pygolin_runtime.WrapNative(f, reflect.ValueOf(uint32(mod.ModeTemporary))); raised != nil {
		return nil, raised
	} else if raised = f.Globals().SetItemString(f, "ModeTemporary", o); raised != nil {
		return nil, raised
	}
	if o, raised := pygolin_runtime.WrapNative(f, reflect.ValueOf(uint64(mod.ModeType))); raised != nil {
		return nil, raised
	} else if raised = f.Globals().SetItemString(f, "ModeType", o); raised != nil {
		return nil, raised
	}
	if o, raised := pygolin_runtime.WrapNative(f, reflect.ValueOf(mod.NewFile)); raised != nil {
		return nil, raised
	} else if raised = f.Globals().SetItemString(f, "NewFile", o); raised != nil {
		return nil, raised
	}
	if o, raised := pygolin_runtime.WrapNative(f, reflect.ValueOf(mod.NewSyscallError)); raised != nil {
		return nil, raised
	...
	if o, raised := pygolin_runtime.WrapNative(f, reflect.ValueOf(uint(mod.O_CREATE))); raised != nil {
		return nil, raised
	...
	if o, raised := pygolin_runtime.WrapNative(f, reflect.ValueOf(mod.OpenFile)); raised != nil {
		return nil, raised
	...
	if o, raised := pygolin_runtime.WrapNative(f, reflect.ValueOf(uint(mod.PathListSeparator))); raised != nil {
		return nil, raised
	} else if raised = f.Globals().SetItemString(f, "PathListSeparator", o); raised != nil {
		return nil, raised
	}
	if o, raised := pygolin_runtime.WrapNative(f, reflect.ValueOf(uint(mod.PathSeparator))); raised != nil {
		return nil, raised
	...
	if o, raised := pygolin_runtime.WrapNative(f, reflect.ValueOf(mod.Remove)); raised != nil {
		return nil, raised
	} else if raised = f.Globals().SetItemString(f, "Remove", o); raised != nil {
		return nil, raised
	}
	if o, raised := pygolin_runtime.WrapNative(f, reflect.ValueOf(mod.RemoveAll)); raised != nil {
		return nil, raised
	...
	if o, raised := pygolin_runtime.WrapNative(f, reflect.ValueOf(uint(mod.SEEK_CUR))); raised != nil {
		return nil, raised
	} else if raised = f.Globals().SetItemString(f, "SEEK_CUR", o); raised != nil {
		return nil, raised
	}
	if o, raised := pygolin_runtime.WrapNative(f, reflect.ValueOf(uint(mod.SEEK_END))); raised != nil {
		return nil, raised
	} else if raised = f.Globals().SetItemString(f, "SEEK_END", o); raised != nil {
		return nil, raised
	}
	if o, raised := pygolin_runtime.WrapNative(f, reflect.ValueOf(uint(mod.SEEK_SET))); raised != nil {
		return nil, raised
	} else if raised = f.Globals().SetItemString(f, "SEEK_SET", o); raised != nil {
		return nil, raised
	}
	if o, raised := pygolin_runtime.WrapNative(f, reflect.ValueOf(mod.SameFile)); raised != nil {
		return nil, raised
	...
	if o, raised := pygolin_runtime.WrapNative(f, reflect.ValueOf(mod.UserCacheDir)); raised != nil {
		return nil, raised
	} else if raised = f.Globals().SetItemString(f, "UserCacheDir", o); raised != nil {
		return nil, raised
	}
	if o, raised := pygolin_runtime.WrapNative(f, reflect.ValueOf(mod.UserConfigDir)); raised != nil {
		return nil, raised
	} else if raised = f.Globals().SetItemString(f, "UserConfigDir", o); raised != nil {
		return nil, raised
	}
	if o, raised := pygolin_runtime.WrapNative(f, reflect.ValueOf(mod.UserHomeDir)); raised != nil {
		return nil, raised
	} else if raised = f.Globals().SetItemString(f, "UserHomeDir", o); raised != nil {
		return nil, raised
	}
...
var Code = pygolin_runtime.NewCode("<module>", "os", nil, 0, fun)

func init() {
	pygolin_runtime.RegisterModule("__go__/os", Code)
}
