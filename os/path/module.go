...
var Code *πg.Code
func init() {
	Code = πg.NewCode("<module>", "/usr/lib/python2.7/os/path.py", nil, 0, func(πF *πg.Frame, _ []*πg.Object) (*πg.Object, *πg.BaseException) {
		...
		for ; πF.State() >= 0; πF.PopCheckpoint() {
			...
			// line 15: """"Utilities for manipulating and inspecting OS paths."""
			πF.SetLineno(15)
			if πE = πF.Globals().SetItem(πF, ß__doc__.ToObject(), πg.NewStr("\"Utilities for manipulating and inspecting OS paths.").ToObject()); πE != nil {
				continue
			}
			...
			πTemp001 = πTemp002[0]
			if πTemp003, πE = πg.GetAttrImport(πF, πTemp001, ßBase); πE != nil {
				continue
			}
			...
			πTemp001 = πTemp002[0]
			if πTemp003, πE = πg.GetAttrImport(πF, πTemp001, ßClean); πE != nil {
				continue
			}
			...
			πTemp001 = πTemp002[0]
			if πTemp003, πE = πg.GetAttrImport(πF, πTemp001, ßDir); πE != nil {
				continue
			}
			...
			πTemp001 = πTemp002[0]
			if πTemp003, πE = πg.GetAttrImport(πF, πTemp001, ßIsAbs); πE != nil {
				continue
			}
			...
			πTemp001 = πTemp002[0]
			if πTemp003, πE = πg.GetAttrImport(πF, πTemp001, ßJoin); πE != nil {
				continue
			}
			...
			πTemp001 = πTemp002[0]
			if πTemp003, πE = πg.GetAttrImport(πF, πTemp001, ßSplit); πE != nil {
				continue
			}
			...
			πTemp001 = πg.NewFunction(πg.NewCode("abspath", "/usr/lib/python2.7/os/path.py", πTemp004, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
			...
			πTemp004 = make([]πg.Param, 1)
			πTemp004[0] = πg.Param{Name: "path", Def: nil}
			πTemp003 = πg.NewFunction(πg.NewCode("basename", "/usr/lib/python2.7/os/path.py", πTemp004, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µpath *πg.Object = πArgs[0]; _ = µpath
				var πTemp001 *πg.Object
				_ = πTemp001
				var πTemp002 []*πg.Object
			...
			πTemp004 = make([]πg.Param, 1)
			πTemp004[0] = πg.Param{Name: "path", Def: nil}
			πTemp005 = πg.NewFunction(πg.NewCode("exists", "/usr/lib/python2.7/os/path.py", πTemp004, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µpath *πg.Object = πArgs[0]; _ = µpath
			...
			πTemp004 = make([]πg.Param, 1)
			πTemp004[0] = πg.Param{Name: "path", Def: nil}
			πTemp006 = πg.NewFunction(πg.NewCode("isdir", "/usr/lib/python2.7/os/path.py", πTemp004, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µpath *πg.Object = πArgs[0]; _ = µpath
			...
			πTemp004 = make([]πg.Param, 1)
			πTemp004[0] = πg.Param{Name: "path", Def: nil}
			πTemp007 = πg.NewFunction(πg.NewCode("isfile", "/usr/lib/python2.7/os/path.py", πTemp004, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µpath *πg.Object = πArgs[0]; _ = µpath
				var µinfo *πg.Object = πg.UnboundLocal; _ = µinfo
				var µerr *πg.Object = πg.UnboundLocal; _ = µerr
				var πTemp001 []*πg.Object
			...
			πTemp008 = πg.NewFunction(πg.NewCode("join", "/usr/lib/python2.7/os/path.py", πTemp004, πg.CodeFlagVarArg, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
			...
			πTemp004 = make([]πg.Param, 1)
			πTemp004[0] = πg.Param{Name: "path", Def: nil}
			πTemp009 = πg.NewFunction(πg.NewCode("normpath", "/usr/lib/python2.7/os/path.py", πTemp004, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µpath *πg.Object = πArgs[0]; _ = µpath
				var µresult *πg.Object = πg.UnboundLocal; _ = µresult
				var πTemp001 []*πg.Object
				_ = πTemp001
			...
			πTemp004 = make([]πg.Param, 1)
			πTemp004[0] = πg.Param{Name: "path", Def: nil}
			πTemp010 = πg.NewFunction(πg.NewCode("split", "/usr/lib/python2.7/os/path.py", πTemp004, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µpath *πg.Object = πArgs[0]; _ = µpath
