...
var Code *πg.Code
func init() {
	Code = πg.NewCode("<module>", "/usr/lib/python2.7/json/encoder.py", nil, 0, func(πF *πg.Frame, _ []*πg.Object) (*πg.Object, *πg.BaseException) {
		...
		for ; πF.State() >= 0; πF.PopCheckpoint() {
			...
			// line 1: """Implementation of JSONEncoder
			πF.SetLineno(1)
			if πE = πF.Globals().SetItem(πF, ß__doc__.ToObject(), πg.NewStr("Implementation of JSONEncoder\n").ToObject()); πE != nil {
				continue
			}
			// line 3: import re
			πF.SetLineno(3)
			...
			πTemp001 = πg.NewFunction(πg.NewCode("x4", "/usr/lib/python2.7/json/encoder.py", πTemp003, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
		...
		Label3:
			...
			πTemp004 = πg.NewFunction(πg.NewCode("encode_basestring", "/usr/lib/python2.7/json/encoder.py", πTemp003, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				...
				for ; πF.State() >= 0; πF.PopCheckpoint() {
					...
					πTemp001 = πg.NewFunction(πg.NewCode("replace", "/usr/lib/python2.7/json/encoder.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
			...
			// line 42: """Return a JSON representation of a Python string
			πF.SetLineno(42)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp005}, πg.NewStr("Return a JSON representation of a Python string\n\n    ").ToObject()); πE != nil {
				continue
			}
			if πTemp007, πE = πg.ResolveGlobal(πF, ßencode_basestring); πE != nil {
				continue
			}
			...
			πTemp003 = make([]πg.Param, 1)
			πTemp003[0] = πg.Param{Name: "s", Def: nil}
			πTemp005 = πg.NewFunction(πg.NewCode("py_encode_basestring_ascii", "/usr/lib/python2.7/json/encoder.py", πTemp003, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µs *πg.Object = πArgs[0]; _ = µs
				var µreplace *πg.Object = πg.UnboundLocal; _ = µreplace
				var πTemp001 *πg.Object
				_ = πTemp001
				...
				Label3:
					...
					πTemp001 = πg.NewFunction(πg.NewCode("replace", "/usr/lib/python2.7/json/encoder.py", πTemp007, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µmatch *πg.Object = πArgs[0]; _ = µmatch
			...
			// line 51: """Return an ASCII-only JSON representation of a Python string
			πF.SetLineno(51)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp007}, πg.NewStr("Return an ASCII-only JSON representation of a Python string\n\n    ").ToObject()); πE != nil {
				continue
			}
			if πTemp010, πE = πg.ResolveGlobal(πF, ßpy_encode_basestring_ascii); πE != nil {
				continue
			}
			if πE = πg.SetAttr(πF, πTemp010, ß__doc__, πTemp007); πE != nil {
				continue
			}
		...
		Label4:
			...
			_, πE = πg.NewCode("JSONEncoder", "/usr/lib/python2.7/json/encoder.py", nil, 0, func(πF *πg.Frame, _ []*πg.Object) (*πg.Object, *πg.BaseException) {
				πClass := πTemp006
				_ = πClass
				var πTemp001 *πg.Object
				_ = πTemp001
				...
				for ; πF.State() >= 0; πF.PopCheckpoint() {
					...
					// line 81: """Extensible JSON <http://json.org> encoder for Python data structures.
					πF.SetLineno(81)
					if πE = πClass.SetItem(πF, ß__doc__.ToObject(), πg.NewStr("Extensible JSON <http://json.org> encoder for Python data structures.\n\n    Supports the following objects and types by default:\n\n    +-------------------+---------------+\n    | Python            | JSON          |\n    +===================+===============+\n    | dict              | object        |\n    +-------------------+---------------+\n    | list, tuple       | array         |\n    +-------------------+---------------+\n    | str, unicode      | string        |\n    +-------------------+---------------+\n    | int, long, float  | number        |\n    +-------------------+---------------+\n    | True              | true          |\n    +-------------------+---------------+\n    | False             | false         |\n    +-------------------+---------------+\n    | None              | null          |\n    +-------------------+---------------+\n\n    To extend this to recognize other objects, subclass and implement a\n    ``.default()`` method with another method that returns a serializable\n    object for ``o`` if possible, otherwise it should call the superclass\n    implementation (to raise ``TypeError``).\n\n    ").ToObject()); πE != nil {
						continue
					}
					...
					πTemp001 = πg.NewFunction(πg.NewCode("__init__", "/usr/lib/python2.7/json/encoder.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
					...
					πTemp003 = πg.NewFunction(πg.NewCode("default", "/usr/lib/python2.7/json/encoder.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
					...
					// line 176: """Implement this method in a subclass such that it returns
					πF.SetLineno(176)
					if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp004}, πg.NewStr("Implement this method in a subclass such that it returns\n        a serializable object for ``o``, or calls the base implementation\n        (to raise a ``TypeError``).\n\n        For example, to support arbitrary iterators, you could\n        implement default like this::\n\n            def default(self, o):\n                try:\n                    iterable = iter(o)\n                except TypeError:\n                    pass\n                else:\n                    return list(iterable)\n                # Let the base class default method raise the TypeError\n                return JSONEncoder.default(self, o)\n\n        ").ToObject()); πE != nil {
						continue
					}
					if πTemp005, πE = πg.ResolveClass(πF, πClass, nil, ßdefault); πE != nil {
						continue
					}
					...
					πTemp002[0] = πg.Param{Name: "self", Def: nil}
					πTemp002[1] = πg.Param{Name: "o", Def: nil}
					πTemp004 = πg.NewFunction(πg.NewCode("encode", "/usr/lib/python2.7/json/encoder.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
						var µo *πg.Object = πArgs[1]; _ = µo
					...
					// line 197: """Return a JSON string representation of a Python data structure.
					πF.SetLineno(197)
					if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp005}, πg.NewStr("Return a JSON string representation of a Python data structure.\n\n        >>> JSONEncoder().encode({\"foo\": [\"bar\", \"baz\"]})\n        '{\"foo\": [\"bar\", \"baz\"]}'\n\n        ").ToObject()); πE != nil {
						continue
					}
					if πTemp006, πE = πg.ResolveClass(πF, πClass, nil, ßencode); πE != nil {
						continue
					}
					...
					πTemp005 = πg.NewFunction(πg.NewCode("iterencode", "/usr/lib/python2.7/json/encoder.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
						var µo *πg.Object = πArgs[1]; _ = µo
						...
						Label7:
							...
							πTemp001 = πg.NewFunction(πg.NewCode("_encoder", "/usr/lib/python2.7/json/encoder.py", πTemp005, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						...
						Label8:
							...
							πTemp004 = πg.NewFunction(πg.NewCode("floatstr", "/usr/lib/python2.7/json/encoder.py", πTemp005, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
								var µo *πg.Object = πArgs[0]; _ = µo
					...
					// line 223: """Encode the given object and yield each string
					πF.SetLineno(223)
					if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp006}, πg.NewStr("Encode the given object and yield each string\n        representation as available.\n\n        For example::\n\n            for chunk in JSONEncoder().iterencode(bigobject):\n                mysocket.write(chunk)\n\n        ").ToObject()); πE != nil {
						continue
					}
					if πTemp007, πE = πg.ResolveClass(πF, πClass, nil, ßiterencode); πE != nil {
						continue
					}
			...
			πTemp007 = πg.NewFunction(πg.NewCode("_make_iterencode", "/usr/lib/python2.7/json/encoder.py", πTemp003, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				...
				for ; πF.State() >= 0; πF.PopCheckpoint() {
					...
					πTemp001 = πg.NewFunction(πg.NewCode("_iterencode_list", "/usr/lib/python2.7/json/encoder.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
					...
					πTemp002[1] = πg.Param{Name: "_current_indent_level", Def: nil}
					πTemp003 = πg.NewFunction(πg.NewCode("_iterencode_dict", "/usr/lib/python2.7/json/encoder.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						...
						return πg.NewGenerator(πF, func(πSent *πg.Object) (*πg.Object, *πg.BaseException) {
							...
							Label13:
								...
								πTemp001 = πg.NewFunction(πg.NewCode("<lambda>", "/usr/lib/python2.7/json/encoder.py", πTemp006, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
					...
					πTemp002[1] = πg.Param{Name: "_current_indent_level", Def: nil}
					πTemp004 = πg.NewFunction(πg.NewCode("_iterencode", "/usr/lib/python2.7/json/encoder.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µo *πg.Object = πArgs[0]; _ = µo
						var µ_current_indent_level *πg.Object = πArgs[1]; _ = µ_current_indent_level
						var µchunk *πg.Object = πg.UnboundLocal; _ = µchunk
						var µmarkerid *πg.Object = πg.UnboundLocal; _ = µmarkerid
