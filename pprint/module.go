...
var Code *πg.Code
func init() {
	Code = πg.NewCode("<module>", "/usr/lib/python2.7/pprint.py", nil, 0, func(πF *πg.Frame, _ []*πg.Object) (*πg.Object, *πg.BaseException) {
		...
		for ; πF.State() >= 0; πF.PopCheckpoint() {
			...
			// line 11: """Support to pretty-print lists, tuples, & dictionaries recursively.
			πF.SetLineno(11)
			if πE = πF.Globals().SetItem(πF, ß__doc__.ToObject(), πg.NewStr("Support to pretty-print lists, tuples, & dictionaries recursively.\n\nVery simple, but useful, especially in debugging data structures.\n\nClasses\n-------\n\nPrettyPrinter()\n    Handle pretty-printing operations onto a stream using a configured\n    set of formatting parameters.\n\nFunctions\n---------\n\npformat()\n    Format a Python object into a pretty-printed representation.\n\npprint()\n    Pretty-print a Python object to a stream [default is sys.stdout].\n\nsaferepr()\n    Generate a 'standard' repr()-like value, but protect against recursive\n    data structures.\n\n").ToObject()); πE != nil {
				continue
			}
			...
			πTemp001 = πg.NewFunction(πg.NewCode("pprint", "/usr/lib/python2.7/pprint.py", πTemp004, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
			...
			// line 58: """Pretty-print a Python o to a stream [default is sys.stdout]."""
			πF.SetLineno(58)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp003}, πg.NewStr("Pretty-print a Python o to a stream [default is sys.stdout].").ToObject()); πE != nil {
				continue
			}
			...
			πTemp003 = πg.NewFunction(πg.NewCode("pformat", "/usr/lib/python2.7/pprint.py", πTemp004, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µo *πg.Object = πArgs[0]; _ = µo
			...
			// line 64: """Format a Python o into a pretty-printed representation."""
			πF.SetLineno(64)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp005}, πg.NewStr("Format a Python o into a pretty-printed representation.").ToObject()); πE != nil {
				continue
			}
			if πTemp006, πE = πg.ResolveGlobal(πF, ßpformat); πE != nil {
				continue
			}
			...
			πTemp004[0] = πg.Param{Name: "o", Def: nil}
			πTemp005 = πg.NewFunction(πg.NewCode("saferepr", "/usr/lib/python2.7/pprint.py", πTemp004, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µo *πg.Object = πArgs[0]; _ = µo
				var πTemp001 *πg.Object
				_ = πTemp001
				var πTemp002 *πg.Object
			...
			// line 68: """Version of repr() which can handle recursive data structures."""
			πF.SetLineno(68)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp006}, πg.NewStr("Version of repr() which can handle recursive data structures.").ToObject()); πE != nil {
				continue
			}
			if πTemp007, πE = πg.ResolveGlobal(πF, ßsaferepr); πE != nil {
				continue
			}
			...
			πTemp004 = make([]πg.Param, 1)
			πTemp004[0] = πg.Param{Name: "o", Def: nil}
			πTemp006 = πg.NewFunction(πg.NewCode("isreadable", "/usr/lib/python2.7/pprint.py", πTemp004, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µo *πg.Object = πArgs[0]; _ = µo
				var πTemp001 *πg.Object
				_ = πTemp001
				var πTemp002 *πg.Object
			...
			// line 72: """Determine if saferepr(o) is readable by eval()."""
			πF.SetLineno(72)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp007}, πg.NewStr("Determine if saferepr(o) is readable by eval().").ToObject()); πE != nil {
				continue
			}
			if πTemp008, πE = πg.ResolveGlobal(πF, ßisreadable); πE != nil {
				continue
			}
			...
			πTemp004 = make([]πg.Param, 1)
			πTemp004[0] = πg.Param{Name: "o", Def: nil}
			πTemp007 = πg.NewFunction(πg.NewCode("isrecursive", "/usr/lib/python2.7/pprint.py", πTemp004, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µo *πg.Object = πArgs[0]; _ = µo
				var πTemp001 *πg.Object
				_ = πTemp001
				var πTemp002 *πg.Object
			...
			// line 76: """Determine if o requires a recursive representation."""
			πF.SetLineno(76)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp008}, πg.NewStr("Determine if o requires a recursive representation.").ToObject()); πE != nil {
				continue
			}
			if πTemp009, πE = πg.ResolveGlobal(πF, ßisrecursive); πE != nil {
				continue
			}
			...
			πTemp008 = πg.NewFunction(πg.NewCode("_sorted", "/usr/lib/python2.7/pprint.py", πTemp004, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
			...
			if πE = πTemp010.SetItem(πF, ß__module__.ToObject(), πTemp009); πE != nil {
				continue
			}
			_, πE = πg.NewCode("PrettyPrinter", "/usr/lib/python2.7/pprint.py", nil, 0, func(πF *πg.Frame, _ []*πg.Object) (*πg.Object, *πg.BaseException) {
				πClass := πTemp010
				_ = πClass
				var πTemp001 *πg.Object
				_ = πTemp001
				...
				for ; πF.State() >= 0; πF.PopCheckpoint() {
					...
					πTemp001 = πg.NewFunction(πg.NewCode("__init__", "/usr/lib/python2.7/pprint.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
					...
					// line 88: """Handle pretty printing operations onto a stream using a set of
					πF.SetLineno(88)
					if πE = πClass.SetItem(πF, ß__doc__.ToObject(), πg.NewStr("Handle pretty printing operations onto a stream using a set of\n        configured parameters.\n\n        indent\n            Number of spaces to indent for each level of nesting.\n\n        width\n            Attempted maximum number of columns in the output.\n\n        depth\n            The maximum depth to print out nested structures.\n\n        stream\n            The desired output stream.  If omitted (or false), the standard\n            output stream available at construction will be used.\n\n        ").ToObject()); πE != nil {
						continue
					}
					if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp003}, πg.NewStr("Handle pretty printing operations onto a stream using a set of\n        configured parameters.\n\n        indent\n            Number of spaces to indent for each level of nesting.\n\n        width\n            Attempted maximum number of columns in the output.\n\n        depth\n            The maximum depth to print out nested structures.\n\n        stream\n            The desired output stream.  If omitted (or false), the standard\n            output stream available at construction will be used.\n\n        ").ToObject()); πE != nil {
						continue
					}
					...
					πTemp003 = πg.NewFunction(πg.NewCode("pprint", "/usr/lib/python2.7/pprint.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
					...
					πTemp002[0] = πg.Param{Name: "self", Def: nil}
					πTemp002[1] = πg.Param{Name: "o", Def: nil}
					πTemp004 = πg.NewFunction(πg.NewCode("pformat", "/usr/lib/python2.7/pprint.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
						var µo *πg.Object = πArgs[1]; _ = µo
					...
					πTemp002[0] = πg.Param{Name: "self", Def: nil}
					πTemp002[1] = πg.Param{Name: "o", Def: nil}
					πTemp005 = πg.NewFunction(πg.NewCode("isrecursive", "/usr/lib/python2.7/pprint.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
						var µo *πg.Object = πArgs[1]; _ = µo
						var πTemp001 *πg.Object
						_ = πTemp001
					...
					πTemp002[0] = πg.Param{Name: "self", Def: nil}
					πTemp002[1] = πg.Param{Name: "o", Def: nil}
					πTemp006 = πg.NewFunction(πg.NewCode("isreadable", "/usr/lib/python2.7/pprint.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
						var µo *πg.Object = πArgs[1]; _ = µo
					...
					πTemp007 = πg.NewFunction(πg.NewCode("_format", "/usr/lib/python2.7/pprint.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
						var µo *πg.Object = πArgs[1]; _ = µo
					...
					πTemp008 = πg.NewFunction(πg.NewCode("_repr", "/usr/lib/python2.7/pprint.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
						var µo *πg.Object = πArgs[1]; _ = µo
					...
					πTemp009 = πg.NewFunction(πg.NewCode("format", "/usr/lib/python2.7/pprint.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
						var µo *πg.Object = πArgs[1]; _ = µo
						var µcontext *πg.Object = πArgs[2]; _ = µcontext
					...
					// line 240: """Format o for a specific context, returning a string
					πF.SetLineno(240)
					if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp010}, πg.NewStr("Format o for a specific context, returning a string\n        and flags indicating whether the representation is 'readable'\n        and whether the o represents a recursive construct.\n        ").ToObject()); πE != nil {
						continue
					}
			...
			if πTemp011, πE = πTemp010.GetItem(πF, ß__metaclass__.ToObject()); πE != nil {
				continue
			}
			if πTemp011 == nil {
				πTemp011 = πg.TypeType.ToObject()
			}
			if πTemp012, πE = πTemp011.Call(πF, []*πg.Object{πg.NewStr("PrettyPrinter").ToObject(), πg.NewTuple(πTemp002...).ToObject(), πTemp010.ToObject()}, nil); πE != nil {
				continue
			}
			...
			πTemp009 = πg.NewFunction(πg.NewCode("_safe_repr", "/usr/lib/python2.7/pprint.py", πTemp004, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µo *πg.Object = πArgs[0]; _ = µo
			...
			if πE = πF.Globals().SetItem(πF, ß_safe_repr.ToObject(), πTemp009); πE != nil {
				continue
			}
			...
			πTemp004 = make([]πg.Param, 1)
			πTemp004[0] = πg.Param{Name: "o", Def: nil}
			πTemp011 = πg.NewFunction(πg.NewCode("_recursion", "/usr/lib/python2.7/pprint.py", πTemp004, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µo *πg.Object = πArgs[0]; _ = µo
				var πTemp001 *πg.Object
				_ = πTemp001
				var πTemp002 *πg.Object
