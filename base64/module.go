...
var Code *πg.Code
func init() {
	Code = πg.NewCode("<module>", "/usr/lib/python2.7/base64.py", nil, 0, func(πF *πg.Frame, _ []*πg.Object) (*πg.Object, *πg.BaseException) {
		...
		for ; πF.State() >= 0; πF.PopCheckpoint() {
			...
			// line 3: """RFC 3548: Base16, Base32, Base64 Data Encodings"""
			πF.SetLineno(3)
			if πE = πF.Globals().SetItem(πF, ß__doc__.ToObject(), πg.NewStr("RFC 3548: Base16, Base32, Base64 Data Encodings").ToObject()); πE != nil {
				continue
			}
			// line 8: import re
			πF.SetLineno(8)
			...
			πTemp003 = πg.NewFunction(πg.NewCode("<generator>", "/usr/lib/python2.7/base64.py", πTemp004, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
			...
			πTemp001 = πg.NewFunction(πg.NewCode("_translate", "/usr/lib/python2.7/base64.py", πTemp004, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
			...
			πTemp005 = πg.NewFunction(πg.NewCode("b64encode", "/usr/lib/python2.7/base64.py", πTemp004, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µs *πg.Object = πArgs[0]; _ = µs
				var µaltchars *πg.Object = πArgs[1]; _ = µaltchars
			...
			// line 45: """Encode a string using Base64.
			πF.SetLineno(45)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp006}, πg.NewStr("Encode a string using Base64.\n\n    s is the string to encode.  Optional altchars must be a string of at least\n    length 2 (additional characters are ignored) which specifies an\n    alternative alphabet for the '+' and '/' characters.  This allows an\n    application to e.g. generate url or filesystem safe Base64 strings.\n\n    The encoded string is returned.\n    ").ToObject()); πE != nil {
				continue
			}
			if πTemp007, πE = πg.ResolveGlobal(πF, ßb64encode); πE != nil {
				continue
			}
			...
			πTemp006 = πg.NewFunction(πg.NewCode("b64decode", "/usr/lib/python2.7/base64.py", πTemp004, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µs *πg.Object = πArgs[0]; _ = µs
				var µaltchars *πg.Object = πArgs[1]; _ = µaltchars
			...
			// line 62: """Decode a Base64 encoded string.
			πF.SetLineno(62)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp007}, πg.NewStr("Decode a Base64 encoded string.\n\n    s is the string to decode.  Optional altchars must be a string of at least\n    length 2 (additional characters are ignored) which specifies the\n    alternative alphabet used instead of the '+' and '/' characters.\n\n    The decoded string is returned.  A TypeError is raised if s is\n    incorrectly padded.  Characters that are neither in the normal base-64\n    alphabet nor the alternative alphabet are discarded prior to the padding\n    check.\n    ").ToObject()); πE != nil {
				continue
			}
			if πTemp008, πE = πg.ResolveGlobal(πF, ßb64decode); πE != nil {
				continue
			}
			...
			πTemp004[0] = πg.Param{Name: "s", Def: nil}
			πTemp007 = πg.NewFunction(πg.NewCode("standard_b64encode", "/usr/lib/python2.7/base64.py", πTemp004, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µs *πg.Object = πArgs[0]; _ = µs
				var πTemp001 []*πg.Object
				_ = πTemp001
				var πTemp002 *πg.Object
			...
			// line 83: """Encode a string using the standard Base64 alphabet.
			πF.SetLineno(83)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp008}, πg.NewStr("Encode a string using the standard Base64 alphabet.\n\n    s is the string to encode.  The encoded string is returned.\n    ").ToObject()); πE != nil {
				continue
			}
			if πTemp009, πE = πg.ResolveGlobal(πF, ßstandard_b64encode); πE != nil {
				continue
			}
			...
			πTemp004 = make([]πg.Param, 1)
			πTemp004[0] = πg.Param{Name: "s", Def: nil}
			πTemp008 = πg.NewFunction(πg.NewCode("standard_b64decode", "/usr/lib/python2.7/base64.py", πTemp004, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µs *πg.Object = πArgs[0]; _ = µs
				var πTemp001 []*πg.Object
				_ = πTemp001
				var πTemp002 *πg.Object
			...
			πTemp004 = make([]πg.Param, 1)
			πTemp004[0] = πg.Param{Name: "s", Def: nil}
			πTemp009 = πg.NewFunction(πg.NewCode("urlsafe_b64encode", "/usr/lib/python2.7/base64.py", πTemp004, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µs *πg.Object = πArgs[0]; _ = µs
				var πTemp001 []*πg.Object
				_ = πTemp001
				var πTemp002 *πg.Object
			...
			// line 103: """Encode a string using the URL- and filesystem-safe Base64 alphabet.
			πF.SetLineno(103)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp010}, πg.NewStr("Encode a string using the URL- and filesystem-safe Base64 alphabet.\n\n    Argument s is the string to encode.  The encoded string is returned.  The\n    alphabet uses '-' instead of '+' and '_' instead of '/'.\n    ").ToObject()); πE != nil {
				continue
			}
			if πTemp011, πE = πg.ResolveGlobal(πF, ßurlsafe_b64encode); πE != nil {
				continue
			}
			...
			πTemp004 = make([]πg.Param, 1)
			πTemp004[0] = πg.Param{Name: "s", Def: nil}
			πTemp010 = πg.NewFunction(πg.NewCode("urlsafe_b64decode", "/usr/lib/python2.7/base64.py", πTemp004, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µs *πg.Object = πArgs[0]; _ = µs
				var πTemp001 []*πg.Object
				_ = πTemp001
				var πTemp002 []*πg.Object
			...
			// line 111: """Decode a string using the URL- and filesystem-safe Base64 alphabet.
			πF.SetLineno(111)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp011}, πg.NewStr("Decode a string using the URL- and filesystem-safe Base64 alphabet.\n\n    Argument s is the string to decode.  The decoded string is returned.  A\n    TypeError is raised if the string is incorrectly padded.  Characters that\n    are not in the URL-safe base-64 alphabet, and are not a plus '+' or slash\n    '/', are discarded prior to the padding check.\n\n    The alphabet uses '-' instead of '+' and '_' instead of '/'.\n    ").ToObject()); πE != nil {
				continue
			}
			if πTemp012, πE = πg.ResolveGlobal(πF, ßurlsafe_b64decode); πE != nil {
				continue
			}
			...
			πF.SetLineno(125)
			πTemp013 = πg.NewDict()
			if πE = πTemp013.SetItem(πF, πg.NewInt(0).ToObject(), ßA.ToObject()); πE != nil {
				continue
			}
			if πE = πTemp013.SetItem(πF, πg.NewInt(9).ToObject(), ßJ.ToObject()); πE != nil {
				continue
			}
			if πE = πTemp013.SetItem(πF, πg.NewInt(18).ToObject(), ßS.ToObject()); πE != nil {
				continue
			}
			if πE = πTemp013.SetItem(πF, πg.NewInt(27).ToObject(), ß3.ToObject()); πE != nil {
				continue
			}
			if πE = πTemp013.SetItem(πF, πg.NewInt(1).ToObject(), ßB.ToObject()); πE != nil {
				continue
			}
			if πE = πTemp013.SetItem(πF, πg.NewInt(10).ToObject(), ßK.ToObject()); πE != nil {
				continue
			}
			if πE = πTemp013.SetItem(πF, πg.NewInt(19).ToObject(), ßT.ToObject()); πE != nil {
				continue
			}
			if πE = πTemp013.SetItem(πF, πg.NewInt(28).ToObject(), ß4.ToObject()); πE != nil {
				continue
			}
			if πE = πTemp013.SetItem(πF, πg.NewInt(2).ToObject(), ßC.ToObject()); πE != nil {
				continue
			}
			if πE = πTemp013.SetItem(πF, πg.NewInt(11).ToObject(), ßL.ToObject()); πE != nil {
				continue
			}
			if πE = πTemp013.SetItem(πF, πg.NewInt(20).ToObject(), ßU.ToObject()); πE != nil {
				continue
			}
			if πE = πTemp013.SetItem(πF, πg.NewInt(29).ToObject(), ß5.ToObject()); πE != nil {
				continue
			}
			if πE = πTemp013.SetItem(πF, πg.NewInt(3).ToObject(), ßD.ToObject()); πE != nil {
				continue
			}
			if πE = πTemp013.SetItem(πF, πg.NewInt(12).ToObject(), ßM.ToObject()); πE != nil {
				continue
			}
			if πE = πTemp013.SetItem(πF, πg.NewInt(21).ToObject(), ßV.ToObject()); πE != nil {
				continue
			}
			if πE = πTemp013.SetItem(πF, πg.NewInt(30).ToObject(), ß6.ToObject()); πE != nil {
				continue
			}
			if πE = πTemp013.SetItem(πF, πg.NewInt(4).ToObject(), ßE.ToObject()); πE != nil {
				continue
			}
			if πE = πTemp013.SetItem(πF, πg.NewInt(13).ToObject(), ßN.ToObject()); πE != nil {
				continue
			}
			if πE = πTemp013.SetItem(πF, πg.NewInt(22).ToObject(), ßW.ToObject()); πE != nil {
				continue
			}
			if πE = πTemp013.SetItem(πF, πg.NewInt(31).ToObject(), ß7.ToObject()); πE != nil {
				continue
			}
			if πE = πTemp013.SetItem(πF, πg.NewInt(5).ToObject(), ßF.ToObject()); πE != nil {
				continue
			}
			if πE = πTemp013.SetItem(πF, πg.NewInt(14).ToObject(), ßO.ToObject()); πE != nil {
				continue
			}
			if πE = πTemp013.SetItem(πF, πg.NewInt(23).ToObject(), ßX.ToObject()); πE != nil {
				continue
			}
			if πE = πTemp013.SetItem(πF, πg.NewInt(6).ToObject(), ßG.ToObject()); πE != nil {
				continue
			}
			if πE = πTemp013.SetItem(πF, πg.NewInt(15).ToObject(), ßP.ToObject()); πE != nil {
				continue
			}
			if πE = πTemp013.SetItem(πF, πg.NewInt(24).ToObject(), ßY.ToObject()); πE != nil {
				continue
			}
			if πE = πTemp013.SetItem(πF, πg.NewInt(7).ToObject(), ßH.ToObject()); πE != nil {
				continue
			}
			if πE = πTemp013.SetItem(πF, πg.NewInt(16).ToObject(), ßQ.ToObject()); πE != nil {
				continue
			}
			if πE = πTemp013.SetItem(πF, πg.NewInt(25).ToObject(), ßZ.ToObject()); πE != nil {
				continue
			}
			if πE = πTemp013.SetItem(πF, πg.NewInt(8).ToObject(), ßI.ToObject()); πE != nil {
				continue
			}
			if πE = πTemp013.SetItem(πF, πg.NewInt(17).ToObject(), ßR.ToObject()); πE != nil {
				continue
			}
			if πE = πTemp013.SetItem(πF, πg.NewInt(26).ToObject(), ß2.ToObject()); πE != nil {
				continue
			}
			πTemp011 = πTemp013.ToObject()
			if πE = πF.Globals().SetItem(πF, ß_b32alphabet.ToObject(), πTemp011); πE != nil {
				continue
			}
			// line 137: _b32tab = _b32alphabet.items()
			πF.SetLineno(137)
			if πTemp011, πE = πg.ResolveGlobal(πF, ß_b32alphabet); πE != nil {
				continue
			}
			...
			if πE = πF.Globals().SetItem(πF, ß_b32tab.ToObject(), πTemp011); πE != nil {
				continue
			}
			// line 138: _b32tab.sort()
			πF.SetLineno(138)
			if πTemp011, πE = πg.ResolveGlobal(πF, ß_b32tab); πE != nil {
				continue
			}
			if πTemp012, πE = πg.GetAttr(πF, πTemp011, ßsort, nil); πE != nil {
				continue
			}
			if πTemp011, πE = πTemp012.Call(πF, nil, nil); πE != nil {
				continue
			...
			πF.SetLineno(139)
			πTemp004 = make([]πg.Param, 0)
			πTemp012 = πg.NewFunction(πg.NewCode("<generator>", "/usr/lib/python2.7/base64.py", πTemp004, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µk *πg.Object = πg.UnboundLocal; _ = µk
				var µv *πg.Object = πg.UnboundLocal; _ = µv
				var πTemp001 *πg.Object
				_ = πTemp001
			...
			if πTemp011, πE = πg.ListType.Call(πF, πg.Args{πTemp014}, nil); πE != nil {
				continue
			}
			if πE = πF.Globals().SetItem(πF, ß_b32tab.ToObject(), πTemp011); πE != nil {
				continue
			...
			πTemp002 = πF.MakeArgs(1)
			πTemp004 = make([]πg.Param, 0)
			πTemp014 = πg.NewFunction(πg.NewCode("<generator>", "/usr/lib/python2.7/base64.py", πTemp004, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µk *πg.Object = πg.UnboundLocal; _ = µk
				var µv *πg.Object = πg.UnboundLocal; _ = µv
				var πTemp001 *πg.Object
				_ = πTemp001
			...
			if πTemp011, πE = πg.ListType.Call(πF, πg.Args{πTemp015}, nil); πE != nil {
				continue
			}
			πTemp002[0] = πTemp011
			if πTemp011, πE = πg.ResolveGlobal(πF, ßdict); πE != nil {
				continue
			}
			if πTemp015, πE = πTemp011.Call(πF, πTemp002, nil); πE != nil {
				continue
			}
			πF.FreeArgs(πTemp002)
			...
			πTemp004 = make([]πg.Param, 1)
			πTemp004[0] = πg.Param{Name: "s", Def: nil}
			πTemp011 = πg.NewFunction(πg.NewCode("b32encode", "/usr/lib/python2.7/base64.py", πTemp004, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µs *πg.Object = πArgs[0]; _ = µs
			...
			if πE = πF.Globals().SetItem(πF, ßb32encode.ToObject(), πTemp011); πE != nil {
				continue
			}
			// line 144: """Encode a string using Base32.
			πF.SetLineno(144)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp015}, πg.NewStr("Encode a string using Base32.\n\n    s is the string to encode.  The encoded string is returned.\n    ").ToObject()); πE != nil {
				continue
			}
			if πTemp016, πE = πg.ResolveGlobal(πF, ßb32encode); πE != nil {
				continue
			}
			...
			πTemp015 = πg.NewFunction(πg.NewCode("b32decode", "/usr/lib/python2.7/base64.py", πTemp004, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µs *πg.Object = πArgs[0]; _ = µs
			...
			// line 186: """Decode a Base32 encoded string.
			πF.SetLineno(186)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp016}, πg.NewStr("Decode a Base32 encoded string.\n\n    s is the string to decode.  Optional casefold is a flag specifying whether\n    a lowercase alphabet is acceptable as input.  For security purposes, the\n    default is False.\n\n    RFC 3548 allows for optional mapping of the digit 0 (zero) to the letter O\n    (oh), and for optional mapping of the digit 1 (one) to either the letter I\n    (eye) or letter L (el).  The optional argument map01 when not None,\n    specifies which letter the digit 1 should be mapped to (when map01 is not\n    None, the digit 0 is always mapped to the letter O).  For security\n    purposes the default is None, so that 0 and 1 are not allowed in the\n    input.\n\n    The decoded string is returned.  A TypeError is raised if s were\n    incorrectly padded or if there are non-alphabet characters present in the\n    string.\n    ").ToObject()); πE != nil {
				continue
			}
			if πTemp017, πE = πg.ResolveGlobal(πF, ßb32decode); πE != nil {
				continue
			}
			...
			πTemp004 = make([]πg.Param, 1)
			πTemp004[0] = πg.Param{Name: "s", Def: nil}
			πTemp016 = πg.NewFunction(πg.NewCode("b16encode", "/usr/lib/python2.7/base64.py", πTemp004, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µs *πg.Object = πArgs[0]; _ = µs
				var πTemp001 []*πg.Object
				_ = πTemp001
				var πTemp002 *πg.Object
			...
			// line 260: """Encode a string using Base16.
			πF.SetLineno(260)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp017}, πg.NewStr("Encode a string using Base16.\n\n    s is the string to encode.  The encoded string is returned.\n    ").ToObject()); πE != nil {
				continue
			}
			if πTemp018, πE = πg.ResolveGlobal(πF, ßb16encode); πE != nil {
				continue
			}
			...
			πTemp017 = πg.NewFunction(πg.NewCode("b16decode", "/usr/lib/python2.7/base64.py", πTemp004, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µs *πg.Object = πArgs[0]; _ = µs
				var µcasefold *πg.Object = πArgs[1]; _ = µcasefold
				var πTemp001 bool
				_ = πTemp001
			...
			// line 268: """Decode a Base16 encoded string.
			πF.SetLineno(268)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp018}, πg.NewStr("Decode a Base16 encoded string.\n\n    s is the string to decode.  Optional casefold is a flag specifying whether\n    a lowercase alphabet is acceptable as input.  For security purposes, the\n    default is False.\n\n    The decoded string is returned.  A TypeError is raised if s is\n    incorrectly padded or if there are non-alphabet characters present in the\n    string.\n    ").ToObject()); πE != nil {
				continue
			}
			if πTemp019, πE = πg.ResolveGlobal(πF, ßb16decode); πE != nil {
				continue
			}
			...
			πTemp018 = πg.NewFunction(πg.NewCode("encode", "/usr/lib/python2.7/base64.py", πTemp004, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
			...
			// line 294: """Encode a file."""
			πF.SetLineno(294)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp019}, πg.NewStr("Encode a file.").ToObject()); πE != nil {
				continue
			}
			if πTemp020, πE = πg.ResolveGlobal(πF, ßencode); πE != nil {
				continue
			}
			...
			πTemp004[0] = πg.Param{Name: "input", Def: nil}
			πTemp004[1] = πg.Param{Name: "output", Def: nil}
			πTemp019 = πg.NewFunction(πg.NewCode("decode", "/usr/lib/python2.7/base64.py", πTemp004, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µinput *πg.Object = πArgs[0]; _ = µinput
				var µoutput *πg.Object = πArgs[1]; _ = µoutput
				var µline *πg.Object = πg.UnboundLocal; _ = µline
				var µs *πg.Object = πg.UnboundLocal; _ = µs
			...
			// line 309: """Decode a file."""
			πF.SetLineno(309)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp020}, πg.NewStr("Decode a file.").ToObject()); πE != nil {
				continue
			}
			if πTemp021, πE = πg.ResolveGlobal(πF, ßdecode); πE != nil {
				continue
			}
			...
			πTemp004 = make([]πg.Param, 1)
			πTemp004[0] = πg.Param{Name: "s", Def: nil}
			πTemp020 = πg.NewFunction(πg.NewCode("encodestring", "/usr/lib/python2.7/base64.py", πTemp004, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µs *πg.Object = πArgs[0]; _ = µs
			...
			// line 319: """Encode a string into multiple lines of base-64 data."""
			πF.SetLineno(319)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp021}, πg.NewStr("Encode a string into multiple lines of base-64 data.").ToObject()); πE != nil {
				continue
			}
			if πTemp022, πE = πg.ResolveGlobal(πF, ßencodestring); πE != nil {
				continue
			}
			...
			πTemp004 = make([]πg.Param, 1)
			πTemp004[0] = πg.Param{Name: "s", Def: nil}
			πTemp021 = πg.NewFunction(πg.NewCode("decodestring", "/usr/lib/python2.7/base64.py", πTemp004, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µs *πg.Object = πArgs[0]; _ = µs
				var πTemp001 []*πg.Object
				_ = πTemp001
				var πTemp002 *πg.Object
			...
			// line 328: """Decode a string."""
			πF.SetLineno(328)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp022}, πg.NewStr("Decode a string.").ToObject()); πE != nil {
				continue
			}
			if πTemp023, πE = πg.ResolveGlobal(πF, ßdecodestring); πE != nil {
				continue
			}
			...
			πF.SetLineno(334)
			πTemp004 = make([]πg.Param, 0)
			πTemp022 = πg.NewFunction(πg.NewCode("test", "/usr/lib/python2.7/base64.py", πTemp004, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				...
				Label17:
					...
					if πTemp008, πE = πg.GetAttr(πF, µsys, ßstdin, nil); πE != nil {
						continue
					}
					πTemp002[0] = πTemp008
					if πE = πg.CheckLocal(πF, µsys, "sys"); πE != nil {
			...
			// line 335: """Small test program"""
			πF.SetLineno(335)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp023}, πg.NewStr("Small test program").ToObject()); πE != nil {
				continue
			}
			...
			πF.SetLineno(360)
			πTemp004 = make([]πg.Param, 0)
			πTemp023 = πg.NewFunction(πg.NewCode("test1", "/usr/lib/python2.7/base64.py", πTemp004, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
