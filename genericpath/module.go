...
var Code *πg.Code
func init() {
	Code = πg.NewCode("<module>", "/usr/lib/python2.7/genericpath.py", nil, 0, func(πF *πg.Frame, _ []*πg.Object) (*πg.Object, *πg.BaseException) {
		...
		Label3:
			...
			_, πE = πg.NewCode("_unicode", "/usr/lib/python2.7/genericpath.py", nil, 0, func(πF *πg.Frame, _ []*πg.Object) (*πg.Object, *πg.BaseException) {
				πClass := πTemp006
				_ = πClass
				for ; πF.State() >= 0; πF.PopCheckpoint() {
					switch πF.State() {
		...
		Label1:
			...
			πTemp001 = πg.NewFunction(πg.NewCode("exists", "/usr/lib/python2.7/genericpath.py", πTemp009, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
			...
			// line 24: """Test whether a path exists.  Returns False for broken symbolic links"""
			πF.SetLineno(24)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp007}, πg.NewStr("Test whether a path exists.  Returns False for broken symbolic links").ToObject()); πE != nil {
				continue
			}
			if πTemp008, πE = πg.ResolveGlobal(πF, ßexists); πE != nil {
				continue
			}
			...
			πTemp009 = make([]πg.Param, 1)
			πTemp009[0] = πg.Param{Name: "path", Def: nil}
			πTemp007 = πg.NewFunction(πg.NewCode("isfile", "/usr/lib/python2.7/genericpath.py", πTemp009, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µpath *πg.Object = πArgs[0]; _ = µpath
			...
			// line 35: """Test whether a path is a regular file"""
			πF.SetLineno(35)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp008}, πg.NewStr("Test whether a path is a regular file").ToObject()); πE != nil {
				continue
			}
			if πTemp010, πE = πg.ResolveGlobal(πF, ßisfile); πE != nil {
				continue
			}
			...
			πTemp008 = πg.NewFunction(πg.NewCode("isdir", "/usr/lib/python2.7/genericpath.py", πTemp009, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
			...
			// line 47: """Return true if the pathname refers to an existing directory."""
			πF.SetLineno(47)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp010}, πg.NewStr("Return true if the pathname refers to an existing directory.").ToObject()); πE != nil {
				continue
			}
			if πTemp011, πE = πg.ResolveGlobal(πF, ßisdir); πE != nil {
				continue
			}
			...
			πTemp010 = πg.NewFunction(πg.NewCode("getsize", "/usr/lib/python2.7/genericpath.py", πTemp009, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
			...
			// line 56: """Return the size of a file, reported by os.stat()."""
			πF.SetLineno(56)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp011}, πg.NewStr("Return the size of a file, reported by os.stat().").ToObject()); πE != nil {
				continue
			}
			if πTemp012, πE = πg.ResolveGlobal(πF, ßgetsize); πE != nil {
				continue
			}
			...
			πTemp009 = make([]πg.Param, 1)
			πTemp009[0] = πg.Param{Name: "filename", Def: nil}
			πTemp011 = πg.NewFunction(πg.NewCode("getmtime", "/usr/lib/python2.7/genericpath.py", πTemp009, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µfilename *πg.Object = πArgs[0]; _ = µfilename
				var πTemp001 []*πg.Object
				_ = πTemp001
				var πTemp002 *πg.Object
			...
			// line 61: """Return the last modification time of a file, reported by os.stat()."""
			πF.SetLineno(61)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp012}, πg.NewStr("Return the last modification time of a file, reported by os.stat().").ToObject()); πE != nil {
				continue
			}
			if πTemp013, πE = πg.ResolveGlobal(πF, ßgetmtime); πE != nil {
				continue
			}
			...
			πTemp009 = make([]πg.Param, 1)
			πTemp009[0] = πg.Param{Name: "filename", Def: nil}
			πTemp012 = πg.NewFunction(πg.NewCode("getatime", "/usr/lib/python2.7/genericpath.py", πTemp009, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µfilename *πg.Object = πArgs[0]; _ = µfilename
				var πTemp001 []*πg.Object
				_ = πTemp001
				var πTemp002 *πg.Object
			...
			// line 66: """Return the last access time of a file, reported by os.stat()."""
			πF.SetLineno(66)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp013}, πg.NewStr("Return the last access time of a file, reported by os.stat().").ToObject()); πE != nil {
				continue
			}
			if πTemp014, πE = πg.ResolveGlobal(πF, ßgetatime); πE != nil {
				continue
			}
			...
			πTemp009 = make([]πg.Param, 1)
			πTemp009[0] = πg.Param{Name: "filename", Def: nil}
			πTemp013 = πg.NewFunction(πg.NewCode("getctime", "/usr/lib/python2.7/genericpath.py", πTemp009, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µfilename *πg.Object = πArgs[0]; _ = µfilename
				var πTemp001 []*πg.Object
				_ = πTemp001
				var πTemp002 *πg.Object
			...
			// line 71: """Return the metadata change time of a file, reported by os.stat()."""
			πF.SetLineno(71)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp014}, πg.NewStr("Return the metadata change time of a file, reported by os.stat().").ToObject()); πE != nil {
				continue
			}
			if πTemp015, πE = πg.ResolveGlobal(πF, ßgetctime); πE != nil {
				continue
			}
			...
			πTemp014 = πg.NewFunction(πg.NewCode("commonprefix", "/usr/lib/python2.7/genericpath.py", πTemp009, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
			...
			// line 77: "Given a list of pathnames, returns the longest common leading component"
			πF.SetLineno(77)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp015}, πg.NewStr("Given a list of pathnames, returns the longest common leading component").ToObject()); πE != nil {
				continue
			}
			if πTemp016, πE = πg.ResolveGlobal(πF, ßcommonprefix); πE != nil {
				continue
			}
			...
			πTemp015 = πg.NewFunction(πg.NewCode("_splitext", "/usr/lib/python2.7/genericpath.py", πTemp009, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
			...
			// line 94: """Split the extension from a pathname.
			πF.SetLineno(94)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp016}, πg.NewStr("Split the extension from a pathname.\n\n    Extension is everything from the last dot to the end, ignoring\n    leading dots.  Returns \"(root, ext)\"; ext may be empty.").ToObject()); πE != nil {
				continue
			}
			if πTemp017, πE = πg.ResolveGlobal(πF, ß_splitext); πE != nil {
				continue
			}
