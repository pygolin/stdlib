...
var Code *πg.Code
func init() {
	Code = πg.NewCode("<module>", "/usr/lib/python2.7/_md5.py", nil, 0, func(πF *πg.Frame, _ []*πg.Object) (*πg.Object, *πg.BaseException) {
		...
		for ; πF.State() >= 0; πF.PopCheckpoint() {
			...
			πTemp001 = πg.NewFunction(πg.NewCode("_bytelist2long", "/usr/lib/python2.7/_md5.py", πTemp003, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
			...
			// line 49: "Transform a list of characters into a list of longs."
			πF.SetLineno(49)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp004}, πg.NewStr("Transform a list of characters into a list of longs.").ToObject()); πE != nil {
				continue
			}
			if πTemp005, πE = πg.ResolveGlobal(πF, ß_bytelist2long); πE != nil {
				continue
			}
			...
			πTemp004 = πg.NewFunction(πg.NewCode("_rotateLeft", "/usr/lib/python2.7/_md5.py", πTemp003, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
			...
			// line 69: "Rotate x (32 bit) left n bits circularly."
			πF.SetLineno(69)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp005}, πg.NewStr("Rotate x (32 bit) left n bits circularly.").ToObject()); πE != nil {
				continue
			}
			if πTemp006, πE = πg.ResolveGlobal(πF, ß_rotateLeft); πE != nil {
				continue
			}
			...
			πTemp005 = πg.NewFunction(πg.NewCode("F", "/usr/lib/python2.7/_md5.py", πTemp003, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µx *πg.Object = πArgs[0]; _ = µx
			...
			πTemp003[1] = πg.Param{Name: "y", Def: nil}
			πTemp003[2] = πg.Param{Name: "z", Def: nil}
			πTemp006 = πg.NewFunction(πg.NewCode("G", "/usr/lib/python2.7/_md5.py", πTemp003, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µx *πg.Object = πArgs[0]; _ = µx
				var µy *πg.Object = πArgs[1]; _ = µy
				var µz *πg.Object = πArgs[2]; _ = µz
				var πTemp001 *πg.Object
			...
			πTemp003[1] = πg.Param{Name: "y", Def: nil}
			πTemp003[2] = πg.Param{Name: "z", Def: nil}
			πTemp007 = πg.NewFunction(πg.NewCode("H", "/usr/lib/python2.7/_md5.py", πTemp003, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µx *πg.Object = πArgs[0]; _ = µx
				var µy *πg.Object = πArgs[1]; _ = µy
				var µz *πg.Object = πArgs[2]; _ = µz
				var πTemp001 *πg.Object
			...
			πTemp003[1] = πg.Param{Name: "y", Def: nil}
			πTemp003[2] = πg.Param{Name: "z", Def: nil}
			πTemp008 = πg.NewFunction(πg.NewCode("I", "/usr/lib/python2.7/_md5.py", πTemp003, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µx *πg.Object = πArgs[0]; _ = µx
				var µy *πg.Object = πArgs[1]; _ = µy
				var µz *πg.Object = πArgs[2]; _ = µz
				var πTemp001 *πg.Object
			...
			πTemp009 = πg.NewFunction(πg.NewCode("XX", "/usr/lib/python2.7/_md5.py", πTemp003, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
			...
			// line 100: """Wrapper for call distribution to functions F, G, H and I.
			πF.SetLineno(100)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp010}, πg.NewStr("Wrapper for call distribution to functions F, G, H and I.\n\n  This replaces functions FF, GG, HH and II from \"Appl. Crypto.\"\n  Rotation is separate from addition to prevent recomputation\n  (now summed-up in one function).\n  ").ToObject()); πE != nil {
				continue
			}
			if πTemp011, πE = πg.ResolveGlobal(πF, ßXX); πE != nil {
				continue
			}
			...
			if πE = πTemp012.SetItem(πF, ß__module__.ToObject(), πTemp010); πE != nil {
				continue
			}
			_, πE = πg.NewCode("MD5Type", "/usr/lib/python2.7/_md5.py", nil, 0, func(πF *πg.Frame, _ []*πg.Object) (*πg.Object, *πg.BaseException) {
				πClass := πTemp012
				_ = πClass
				var πTemp001 *πg.Object
				_ = πTemp001
				...
				for ; πF.State() >= 0; πF.PopCheckpoint() {
					...
					// line 120: "An implementation of the MD5 hash function in pure Python."
					πF.SetLineno(120)
					if πE = πClass.SetItem(πF, ß__doc__.ToObject(), πg.NewStr("An implementation of the MD5 hash function in pure Python.").ToObject()); πE != nil {
						continue
					}
					...
					πTemp001 = πg.NewFunction(πg.NewCode("__init__", "/usr/lib/python2.7/_md5.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
					...
					// line 126: "Initialisation."
					πF.SetLineno(126)
					if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp003}, πg.NewStr("Initialisation.").ToObject()); πE != nil {
						continue
					}
					...
					πTemp002 = make([]πg.Param, 1)
					πTemp002[0] = πg.Param{Name: "self", Def: nil}
					πTemp003 = πg.NewFunction(πg.NewCode("init", "/usr/lib/python2.7/_md5.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
						var πTemp001 *πg.Object
						_ = πTemp001
						var πTemp002 []*πg.Object
					...
					// line 140: "Initialize the message-digest and set all fields to zero.code"
					πF.SetLineno(140)
					if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp004}, πg.NewStr("Initialize the message-digest and set all fields to zero.code").ToObject()); πE != nil {
						continue
					}
					if πTemp005, πE = πg.ResolveClass(πF, πClass, nil, ßinit); πE != nil {
						continue
					}
					if πE = πg.SetAttr(πF, πTemp005, ß__doc__, πTemp004); πE != nil {
						continue
					...
					πTemp004 = πg.NewFunction(πg.NewCode("_transform", "/usr/lib/python2.7/_md5.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
					...
					// line 153: """Basic MD5 step transforming the digest based on the input.
					πF.SetLineno(153)
					if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp005}, πg.NewStr("Basic MD5 step transforming the digest based on the input.\n\n    Note that if the Mysterious Constants are arranged backwards\n    in little-endian order and decrypted with the DES they produce\n    OCCULT MESSAGES!\n    ").ToObject()); πE != nil {
						continue
					}
					if πTemp006, πE = πg.ResolveClass(πF, πClass, nil, ß_transform); πE != nil {
						continue
					}
					if πE = πg.SetAttr(πF, πTemp006, ß__doc__, πTemp005); πE != nil {
						continue
					...
					πTemp005 = πg.NewFunction(πg.NewCode("update", "/usr/lib/python2.7/_md5.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
					...
					πTemp002 = make([]πg.Param, 1)
					πTemp002[0] = πg.Param{Name: "self", Def: nil}
					πTemp006 = πg.NewFunction(πg.NewCode("digest", "/usr/lib/python2.7/_md5.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
						var µA *πg.Object = πg.UnboundLocal; _ = µA
						var µB *πg.Object = πg.UnboundLocal; _ = µB
						var µC *πg.Object = πg.UnboundLocal; _ = µC
					...
					// line 298: """Terminate the message-digest computation and return digest.
					πF.SetLineno(298)
					if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp007}, πg.NewStr("Terminate the message-digest computation and return digest.\n\n    Return the digest of the strings passed to the update()\n    method so far. This is a 16-byte string which may contain\n    non-ASCII characters, including null bytes.\n    ").ToObject()); πE != nil {
						continue
					}
					if πTemp008, πE = πg.ResolveClass(πF, πClass, nil, ßdigest); πE != nil {
						continue
					}
					...
					πTemp002 = make([]πg.Param, 1)
					πTemp002[0] = πg.Param{Name: "self", Def: nil}
					πTemp007 = πg.NewFunction(πg.NewCode("hexdigest", "/usr/lib/python2.7/_md5.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
						var πTemp001 []*πg.Object
						_ = πTemp001
						var πTemp002 *πg.Object
						...
						for ; πF.State() >= 0; πF.PopCheckpoint() {
							...
							πTemp003 = πg.NewFunction(πg.NewCode("<generator>", "/usr/lib/python2.7/_md5.py", πTemp004, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
								var µc *πg.Object = πg.UnboundLocal; _ = µc
								var πTemp001 *πg.Object
								_ = πTemp001
								var πTemp002 *πg.Object
					...
					// line 340: """Terminate and return digest in HEX form.
					πF.SetLineno(340)
					if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp008}, πg.NewStr("Terminate and return digest in HEX form.\n\n    Like digest() except the digest is returned as a string of\n    length 32, containing only hexadecimal digits. This may be\n    used to exchange the value safely in email or other non-\n    binary environments.\n    ").ToObject()); πE != nil {
						continue
					}
					if πTemp009, πE = πg.ResolveClass(πF, πClass, nil, ßhexdigest); πE != nil {
						continue
					}
					...
					πTemp002 = make([]πg.Param, 1)
					πTemp002[0] = πg.Param{Name: "self", Def: nil}
					πTemp008 = πg.NewFunction(πg.NewCode("copy", "/usr/lib/python2.7/_md5.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
					...
					// line 351: """Return a clone object.
					πF.SetLineno(351)
					if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp009}, πg.NewStr("Return a clone object.\n\n    Return a copy ('clone') of the md5 object. This can be used\n    to efficiently compute the digests of strings that share\n    a common initial substring.\n    ").ToObject()); πE != nil {
						continue
					}
					if πTemp010, πE = πg.ResolveClass(πF, πClass, nil, ßcopy); πE != nil {
						continue
					}
			...
			if πTemp011, πE = πTemp012.GetItem(πF, ß__metaclass__.ToObject()); πE != nil {
				continue
			}
			if πTemp011 == nil {
				πTemp011 = πg.TypeType.ToObject()
			}
			if πTemp013, πE = πTemp011.Call(πF, []*πg.Object{πg.NewStr("MD5Type").ToObject(), πg.NewTuple(πTemp002...).ToObject(), πTemp012.ToObject()}, nil); πE != nil {
				continue
			}
			...
			πTemp003[0] = πg.Param{Name: "arg", Def: πTemp011}
			πTemp010 = πg.NewFunction(πg.NewCode("new", "/usr/lib/python2.7/_md5.py", πTemp003, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
			...
			// line 379: """Return a new md5 crypto object.
			πF.SetLineno(379)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp011}, πg.NewStr("Return a new md5 crypto object.\n  If arg is present, the method call update(arg) is made.\n  ").ToObject()); πE != nil {
				continue
			}
			if πTemp013, πE = πg.ResolveGlobal(πF, ßnew); πE != nil {
				continue
			}
			if πE = πg.SetAttr(πF, πTemp013, ß__doc__, πTemp011); πE != nil {
				continue
			}
		}
		return nil, πE
