...
var Code *πg.Code
func init() {
	Code = πg.NewCode("<module>", "/usr/lib/python2.7/unittest_util.py", nil, 0, func(πF *πg.Frame, _ []*πg.Object) (*πg.Object, *πg.BaseException) {
		...
		for ; πF.State() >= 0; πF.PopCheckpoint() {
			...
			// line 1: """Various utility functions."""
			πF.SetLineno(1)
			if πE = πF.Globals().SetItem(πF, ß__doc__.ToObject(), πg.NewStr("Various utility functions.").ToObject()); πE != nil {
				continue
			}
			...
			πTemp001 = πg.NewFunction(πg.NewCode("safe_repr", "/usr/lib/python2.7/unittest_util.py", πTemp004, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
			...
			πTemp003 = πg.NewFunction(πg.NewCode("strclass", "/usr/lib/python2.7/unittest_util.py", πTemp004, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
			...
			πTemp005 = πg.NewFunction(πg.NewCode("sorted_list_difference", "/usr/lib/python2.7/unittest_util.py", πTemp004, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
			...
			// line 26: """Finds elements in only one or the other of two, sorted input lists.
			πF.SetLineno(26)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp006}, πg.NewStr("Finds elements in only one or the other of two, sorted input lists.\n\n    Returns a two-element tuple of lists.    The first list contains those\n    elements in the \"expected\" list but not in the \"actual\" list, and the\n    second contains those elements in the \"actual\" list but not in the\n    \"expected\" list.    Duplicate elements in either input list are ignored.\n    ").ToObject()); πE != nil {
				continue
			}
			if πTemp007, πE = πg.ResolveGlobal(πF, ßsorted_list_difference); πE != nil {
				continue
			}
			...
			πTemp006 = πg.NewFunction(πg.NewCode("unorderable_list_difference", "/usr/lib/python2.7/unittest_util.py", πTemp004, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µexpected *πg.Object = πArgs[0]; _ = µexpected
				var µactual *πg.Object = πArgs[1]; _ = µactual
			...
			// line 67: """Same behavior as sorted_list_difference but
			πF.SetLineno(67)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp007}, πg.NewStr("Same behavior as sorted_list_difference but\n    for lists of unorderable items (like dicts).\n\n    As it does a linear search per item (remove) it\n    has O(n*n) performance.\n    ").ToObject()); πE != nil {
				continue
			}
			if πTemp008, πE = πg.ResolveGlobal(πF, ßunorderable_list_difference); πE != nil {
				continue
			}
			...
			_, πE = πg.NewCode("_Mismatch", "/usr/lib/python2.7/unittest_util.py", nil, 0, func(πF *πg.Frame, _ []*πg.Object) (*πg.Object, *πg.BaseException) {
				πClass := πTemp009
				_ = πClass
				var πTemp001 *πg.Object
				_ = πTemp001
				...
				for ; πF.State() >= 0; πF.PopCheckpoint() {
					...
					// line 104: 'Mismatch(actual, expected, value)'
					πF.SetLineno(104)
					if πE = πClass.SetItem(πF, ß__doc__.ToObject(), πg.NewStr("Mismatch(actual, expected, value)").ToObject()); πE != nil {
						continue
					}
					// line 106: __slots__ = ()
					πF.SetLineno(106)
					...
					πTemp001 = πg.NewFunction(πg.NewCode("__new__", "/usr/lib/python2.7/unittest_util.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
					...
					// line 111: 'Create new instance of Mismatch(actual, expected, value)'
					πF.SetLineno(111)
					if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp003}, πg.NewStr("Create new instance of Mismatch(actual, expected, value)").ToObject()); πE != nil {
						continue
					}
					...
					πTemp003 = πg.NewFunction(πg.NewCode("_make", "/usr/lib/python2.7/unittest_util.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µcls *πg.Object = πArgs[0]; _ = µcls
					...
					// line 116: 'Make a new Mismatch object from a sequence or iterable'
					πF.SetLineno(116)
					if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp004}, πg.NewStr("Make a new Mismatch object from a sequence or iterable").ToObject()); πE != nil {
						continue
					}
					...
					πTemp004 = πg.NewFunction(πg.NewCode("__repr__", "/usr/lib/python2.7/unittest_util.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
					...
					πTemp002 = make([]πg.Param, 1)
					πTemp002[0] = πg.Param{Name: "self", Def: nil}
					πTemp005 = πg.NewFunction(πg.NewCode("_asdict", "/usr/lib/python2.7/unittest_util.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
						var πTemp001 []*πg.Object
						_ = πTemp001
						var πTemp002 []*πg.Object
					...
					πTemp007 = πg.NewFunction(πg.NewCode("_replace", "/usr/lib/python2.7/unittest_util.py", πTemp002, πg.CodeFlagKWArg, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
					...
					// line 133: 'Return a new Mismatch object replacing specified fields with new values'
					πF.SetLineno(133)
					if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp008}, πg.NewStr("Return a new Mismatch object replacing specified fields with new values").ToObject()); πE != nil {
						continue
					}
					...
					πTemp002 = make([]πg.Param, 1)
					πTemp002[0] = πg.Param{Name: "self", Def: nil}
					πTemp008 = πg.NewFunction(πg.NewCode("__getnewargs__", "/usr/lib/python2.7/unittest_util.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
						var πTemp001 []*πg.Object
						_ = πTemp001
						var πTemp002 *πg.Object
					...
					πTemp002 = make([]πg.Param, 1)
					πTemp002[0] = πg.Param{Name: "self", Def: nil}
					πTemp009 = πg.NewFunction(πg.NewCode("__getstate__", "/usr/lib/python2.7/unittest_util.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
						var πR *πg.Object; _ = πR
						var πE *πg.BaseException; _ = πE
						for ; πF.State() >= 0; πF.PopCheckpoint() {
					...
					πF.FreeArgs(πTemp006)
					if πE = πClass.SetItem(πF, ßactual.ToObject(), πTemp011); πE != nil {
						continue
					}
					...
					πF.FreeArgs(πTemp006)
					if πE = πClass.SetItem(πF, ßexpected.ToObject(), πTemp011); πE != nil {
						continue
					}
					...
					πF.FreeArgs(πTemp006)
					if πE = πClass.SetItem(πF, ßvalue.ToObject(), πTemp011); πE != nil {
						continue
					}
				}
				return nil, nil
			...
			if πTemp010, πE = πTemp008.Call(πF, []*πg.Object{πg.NewStr("_Mismatch").ToObject(), πg.NewTuple(πTemp002...).ToObject(), πTemp009.ToObject()}, nil); πE != nil {
				continue
			}
			...
			πTemp007 = πg.NewFunction(πg.NewCode("_count_diff_all_purpose", "/usr/lib/python2.7/unittest_util.py", πTemp004, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
			...
			// line 156: 'Returns list of (cnt_act, cnt_exp, elem) triples where the counts differ'
			πF.SetLineno(156)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp008}, πg.NewStr("Returns list of (cnt_act, cnt_exp, elem) triples where the counts differ").ToObject()); πE != nil {
				continue
			}
			if πTemp010, πE = πg.ResolveGlobal(πF, ß_count_diff_all_purpose); πE != nil {
				continue
			}
			...
			πTemp008 = πg.NewFunction(πg.NewCode("_ordered_count", "/usr/lib/python2.7/unittest_util.py", πTemp004, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
			...
			if πE = πF.Globals().SetItem(πF, ß_ordered_count.ToObject(), πTemp008); πE != nil {
				continue
			}
			// line 191: 'Return dict of element counts, in the order they were first seen'
			πF.SetLineno(191)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp010}, πg.NewStr("Return dict of element counts, in the order they were first seen").ToObject()); πE != nil {
				continue
			}
			if πTemp011, πE = πg.ResolveGlobal(πF, ß_ordered_count); πE != nil {
				continue
			}
			if πE = πg.SetAttr(πF, πTemp011, ß__doc__, πTemp010); πE != nil {
				continue
			...
			πTemp004[0] = πg.Param{Name: "actual", Def: nil}
			πTemp004[1] = πg.Param{Name: "expected", Def: nil}
			πTemp010 = πg.NewFunction(πg.NewCode("_count_diff_hashable", "/usr/lib/python2.7/unittest_util.py", πTemp004, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µactual *πg.Object = πArgs[0]; _ = µactual
				var µexpected *πg.Object = πArgs[1]; _ = µexpected
				var µs *πg.Object = πg.UnboundLocal; _ = µs
				var µt *πg.Object = πg.UnboundLocal; _ = µt
			...
			// line 198: 'Returns list of (cnt_act, cnt_exp, elem) triples where the counts differ'
			πF.SetLineno(198)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp011}, πg.NewStr("Returns list of (cnt_act, cnt_exp, elem) triples where the counts differ").ToObject()); πE != nil {
				continue
			}
			if πTemp012, πE = πg.ResolveGlobal(πF, ß_count_diff_hashable); πE != nil {
				continue
			}
