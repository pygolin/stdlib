...
var Code *πg.Code
func init() {
	Code = πg.NewCode("<module>", "/usr/lib/python2.7/weetest.py", nil, 0, func(πF *πg.Frame, _ []*πg.Object) (*πg.Object, *πg.BaseException) {
		...
		for ; πF.State() >= 0; πF.PopCheckpoint() {
			...
			_, πE = πg.NewCode("_Benchmark", "/usr/lib/python2.7/weetest.py", nil, 0, func(πF *πg.Frame, _ []*πg.Object) (*πg.Object, *πg.BaseException) {
				πClass := πTemp003
				_ = πClass
				var πTemp001 *πg.Object
				_ = πTemp001
				...
				for ; πF.State() >= 0; πF.PopCheckpoint() {
					...
					// line 46: """Wraps and runs a single user defined benchmark function."""
					πF.SetLineno(46)
					if πE = πClass.SetItem(πF, ß__doc__.ToObject(), πg.NewStr("Wraps and runs a single user defined benchmark function.").ToObject()); πE != nil {
						continue
					}
					...
					πTemp001 = πg.NewFunction(πg.NewCode("__init__", "/usr/lib/python2.7/weetest.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
					...
					// line 49: """Set up this benchmark to run bench_func to be run for target_duration."""
					πF.SetLineno(49)
					if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp003}, πg.NewStr("Set up this benchmark to run bench_func to be run for target_duration.").ToObject()); πE != nil {
						continue
					}
					...
					πTemp002[0] = πg.Param{Name: "self", Def: nil}
					πTemp003 = πg.NewFunction(πg.NewCode("Run", "/usr/lib/python2.7/weetest.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
					...
					// line 56: """Attempt to run this benchmark for the target duration."""
					πF.SetLineno(56)
					if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp004}, πg.NewStr("Attempt to run this benchmark for the target duration.").ToObject()); πE != nil {
						continue
					}
					if πTemp005, πE = πg.ResolveClass(πF, πClass, nil, ßRun); πE != nil {
						continue
					}
					...
					πTemp002 = make([]πg.Param, 1)
					πTemp002[0] = πg.Param{Name: "self", Def: nil}
					πTemp004 = πg.NewFunction(πg.NewCode("_RunOnce", "/usr/lib/python2.7/weetest.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
						var πTemp001 *πg.Object
						_ = πTemp001
						var πTemp002 *πg.Object
					...
					πTemp002 = make([]πg.Param, 1)
					πTemp002[0] = πg.Param{Name: "self", Def: nil}
					πTemp005 = πg.NewFunction(πg.NewCode("ResetTimer", "/usr/lib/python2.7/weetest.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
						var πTemp001 *πg.Object
						_ = πTemp001
						var πTemp002 *πg.Object
					...
					// line 81: """Clears the current elapsed time to discount expensive setup steps."""
					πF.SetLineno(81)
					if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp006}, πg.NewStr("Clears the current elapsed time to discount expensive setup steps.").ToObject()); πE != nil {
						continue
					}
					if πTemp007, πE = πg.ResolveClass(πF, πClass, nil, ßResetTimer); πE != nil {
						continue
					}
			...
			_, πE = πg.NewCode("_TestResult", "/usr/lib/python2.7/weetest.py", nil, 0, func(πF *πg.Frame, _ []*πg.Object) (*πg.Object, *πg.BaseException) {
				πClass := πTemp003
				_ = πClass
				var πTemp001 *πg.Object
				_ = πTemp001
				...
				for ; πF.State() >= 0; πF.PopCheckpoint() {
					...
					// line 86: """The outcome of running a particular benchmark function."""
					πF.SetLineno(86)
					if πE = πClass.SetItem(πF, ß__doc__.ToObject(), πg.NewStr("The outcome of running a particular benchmark function.").ToObject()); πE != nil {
						continue
					}
			...
			πTemp001 = πg.NewFunction(πg.NewCode("_RunOneBenchmark", "/usr/lib/python2.7/weetest.py", πTemp006, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
			...
			// line 96: """Runs a single benchmark and returns a _TestResult."""
			πF.SetLineno(96)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp004}, πg.NewStr("Runs a single benchmark and returns a _TestResult.").ToObject()); πE != nil {
				continue
			}
			if πTemp005, πE = πg.ResolveGlobal(πF, ß_RunOneBenchmark); πE != nil {
				continue
			}
			if πE = πg.SetAttr(πF, πTemp005, ß__doc__, πTemp004); πE != nil {
				continue
			...
			πTemp006[0] = πg.Param{Name: "name", Def: nil}
			πTemp006[1] = πg.Param{Name: "test_func", Def: nil}
			πTemp004 = πg.NewFunction(πg.NewCode("_RunOneTest", "/usr/lib/python2.7/weetest.py", πTemp006, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µname *πg.Object = πArgs[0]; _ = µname
				var µtest_func *πg.Object = πArgs[1]; _ = µtest_func
				var µresult *πg.Object = πg.UnboundLocal; _ = µresult
				var µstart_time *πg.Object = πg.UnboundLocal; _ = µstart_time
			...
			// line 118: """Runs a single test function and returns a _TestResult."""
			πF.SetLineno(118)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp005}, πg.NewStr("Runs a single test function and returns a _TestResult.").ToObject()); πE != nil {
				continue
			}
			if πTemp007, πE = πg.ResolveGlobal(πF, ß_RunOneTest); πE != nil {
				continue
			}
			...
			πTemp005 = πg.NewFunction(πg.NewCode("_WriteXmlFile", "/usr/lib/python2.7/weetest.py", πTemp006, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
			...
			// line 139: """Given a list of _BenchmarkResults, writes XML test results to filename."""
			πF.SetLineno(139)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp007}, πg.NewStr("Given a list of _BenchmarkResults, writes XML test results to filename.").ToObject()); πE != nil {
				continue
			}
			if πTemp008, πE = πg.ResolveGlobal(πF, ß_WriteXmlFile); πE != nil {
				continue
			}
			...
			πTemp007 = πg.NewFunction(πg.NewCode("_RunAll", "/usr/lib/python2.7/weetest.py", πTemp006, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
			...
			// line 165: """Runs all functions in __main__ matching test_prefix using runner."""
			πF.SetLineno(165)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp008}, πg.NewStr("Runs all functions in __main__ matching test_prefix using runner.").ToObject()); πE != nil {
				continue
			}
			if πTemp009, πE = πg.ResolveGlobal(πF, ß_RunAll); πE != nil {
				continue
			}
			...
			πTemp008 = πg.NewFunction(πg.NewCode("RunBenchmarks", "/usr/lib/python2.7/weetest.py", πTemp006, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var πTemp001 []*πg.Object
				_ = πTemp001
				var πTemp002 []*πg.Object
				_ = πTemp002
			...
			// line 184: """Benchmarks all functions in __main__ with names like BenchmarkXyz()."""
			πF.SetLineno(184)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp009}, πg.NewStr("Benchmarks all functions in __main__ with names like BenchmarkXyz().").ToObject()); πE != nil {
				continue
			}
			if πTemp010, πE = πg.ResolveGlobal(πF, ßRunBenchmarks); πE != nil {
				continue
			}
			...
			πF.SetLineno(188)
			πTemp006 = make([]πg.Param, 0)
			πTemp009 = πg.NewFunction(πg.NewCode("RunTests", "/usr/lib/python2.7/weetest.py", πTemp006, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var πTemp001 []*πg.Object
				_ = πTemp001
				var πTemp002 []*πg.Object
				_ = πTemp002
			...
			// line 189: """Runs all functions in __main__ with names like TestXyz()."""
			πF.SetLineno(189)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp010}, πg.NewStr("Runs all functions in __main__ with names like TestXyz().").ToObject()); πE != nil {
				continue
			}
			if πTemp011, πE = πg.ResolveGlobal(πF, ßRunTests); πE != nil {
				continue
			}
