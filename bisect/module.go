...
var Code *πg.Code
func init() {
	Code = πg.NewCode("<module>", "/usr/lib/python2.7/bisect.py", nil, 0, func(πF *πg.Frame, _ []*πg.Object) (*πg.Object, *πg.BaseException) {
		...
		for ; πF.State() >= 0; πF.PopCheckpoint() {
			...
			// line 1: """Bisection algorithms."""
			πF.SetLineno(1)
			if πE = πF.Globals().SetItem(πF, ß__doc__.ToObject(), πg.NewStr("Bisection algorithms.").ToObject()); πE != nil {
				continue
			}
			...
			πTemp001 = πg.NewFunction(πg.NewCode("insort_right", "/usr/lib/python2.7/bisect.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
			...
			// line 4: """Insert item x in list a, and keep it sorted assuming a is sorted.
			πF.SetLineno(4)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp003}, πg.NewStr("Insert item x in list a, and keep it sorted assuming a is sorted.\n\n    If x is already in a, insert it to the right of the rightmost x.\n\n    Optional args lo (default 0) and hi (default len(a)) bound the\n    slice of a to be searched.\n    ").ToObject()); πE != nil {
				continue
			}
			if πTemp004, πE = πg.ResolveGlobal(πF, ßinsort_right); πE != nil {
				continue
			}
			...
			πTemp003 = πg.NewFunction(πg.NewCode("bisect_right", "/usr/lib/python2.7/bisect.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µa *πg.Object = πArgs[0]; _ = µa
				var µx *πg.Object = πArgs[1]; _ = µx
				var µlo *πg.Object = πArgs[2]; _ = µlo
				var µhi *πg.Object = πArgs[3]; _ = µhi
			...
			// line 25: """Return the index where to insert item x in list a, assuming a is sorted.
			πF.SetLineno(25)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp004}, πg.NewStr("Return the index where to insert item x in list a, assuming a is sorted.\n\n    The return value i is such that all e in a[:i] have e <= x, and all e in\n    a[i:] have e > x.  So if x already appears in the list, a.insert(x) will\n    insert just after the rightmost x already there.\n\n    Optional args lo (default 0) and hi (default len(a)) bound the\n    slice of a to be searched.\n    ").ToObject()); πE != nil {
				continue
			}
			if πTemp005, πE = πg.ResolveGlobal(πF, ßbisect_right); πE != nil {
				continue
			}
			...
			πTemp004 = πg.NewFunction(πg.NewCode("insort_left", "/usr/lib/python2.7/bisect.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µa *πg.Object = πArgs[0]; _ = µa
				var µx *πg.Object = πArgs[1]; _ = µx
				var µlo *πg.Object = πArgs[2]; _ = µlo
				var µhi *πg.Object = πArgs[3]; _ = µhi
			...
			// line 48: """Insert item x in list a, and keep it sorted assuming a is sorted.
			πF.SetLineno(48)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp005}, πg.NewStr("Insert item x in list a, and keep it sorted assuming a is sorted.\n\n    If x is already in a, insert it to the left of the leftmost x.\n\n    Optional args lo (default 0) and hi (default len(a)) bound the\n    slice of a to be searched.\n    ").ToObject()); πE != nil {
				continue
			}
			if πTemp006, πE = πg.ResolveGlobal(πF, ßinsort_left); πE != nil {
				continue
			}
			...
			πTemp005 = πg.NewFunction(πg.NewCode("bisect_left", "/usr/lib/python2.7/bisect.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µa *πg.Object = πArgs[0]; _ = µa
				var µx *πg.Object = πArgs[1]; _ = µx
				var µlo *πg.Object = πArgs[2]; _ = µlo
				var µhi *πg.Object = πArgs[3]; _ = µhi
			...
			// line 68: """Return the index where to insert item x in list a, assuming a is sorted.
			πF.SetLineno(68)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp006}, πg.NewStr("Return the index where to insert item x in list a, assuming a is sorted.\n\n    The return value i is such that all e in a[:i] have e < x, and all e in\n    a[i:] have e >= x.  So if x already appears in the list, a.insert(x) will\n    insert just before the leftmost x already there.\n\n    Optional args lo (default 0) and hi (default len(a)) bound the\n    slice of a to be searched.\n    ").ToObject()); πE != nil {
				continue
			}
			if πTemp007, πE = πg.ResolveGlobal(πF, ßbisect_left); πE != nil {
				continue
			}
