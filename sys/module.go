...
func init() {
	Code = πg.NewCode("<module>", "/usr/lib/python2.7/sys.py", nil, 0, func(πF *πg.Frame, _ []*πg.Object) (*πg.Object, *πg.BaseException) {
		...
		for ; πF.State() >= 0; πF.PopCheckpoint() {
			...
			// line 15: """System-specific parameters and functions."""
			πF.SetLineno(15)
			if πE = πF.Globals().SetItem(πF, ß__doc__.ToObject(), πg.NewStr("System-specific parameters and functions.").ToObject()); πE != nil {
				continue
			}
			...
			πTemp001 = πTemp002[0]
			if πTemp003, πE = πg.GetAttrImport(πF, πTemp001, ßArgs); πE != nil {
				continue
			}
			...
			πTemp001 = πTemp002[0]
			if πTemp003, πE = πg.GetAttrImport(πF, πTemp001, ßSysModules); πE != nil {
				continue
			}
			...
			πTemp001 = πTemp002[0]
			if πTemp003, πE = πg.GetAttrImport(πF, πTemp001, ßMaxInt); πE != nil {
				continue
			}
			...
			πTemp001 = πTemp002[0]
			if πTemp003, πE = πg.GetAttrImport(πF, πTemp001, ßVersion); πE != nil {
				continue
			}
			...
			πTemp001 = πTemp002[0]
			if πTemp003, πE = πg.GetAttrImport(πF, πTemp001, ßMaxRune); πE != nil {
				continue
			}
		...
		Label3:
			...
			_, πE = πg.NewCode("_Flags", "/usr/lib/python2.7/sys.py", nil, 0, func(πF *πg.Frame, _ []*πg.Object) (*πg.Object, *πg.BaseException) {
				πClass := πTemp007
				_ = πClass
				for ; πF.State() >= 0; πF.PopCheckpoint() {
					switch πF.State() {
					...
					// line 38: """Container class for sys.flags."""
					πF.SetLineno(38)
					if πE = πClass.SetItem(πF, ß__doc__.ToObject(), πg.NewStr("Container class for sys.flags.").ToObject()); πE != nil {
						continue
					}
					// line 39: debug = 0
					πF.SetLineno(39)
			...
			πTemp001 = πg.NewFunction(πg.NewCode("exc_clear", "/usr/lib/python2.7/sys.py", πTemp008, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var πTemp001 *πg.Object
				_ = πTemp001
				var πTemp002 *πg.Object
				_ = πTemp002
