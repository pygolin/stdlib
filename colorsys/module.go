...
var Code *πg.Code
func init() {
	Code = πg.NewCode("<module>", "/usr/lib/python2.7/colorsys.py", nil, 0, func(πF *πg.Frame, _ []*πg.Object) (*πg.Object, *πg.BaseException) {
		...
		for ; πF.State() >= 0; πF.PopCheckpoint() {
			...
			// line 1: """Conversion functions between RGB and other color systems.
			πF.SetLineno(1)
			if πE = πF.Globals().SetItem(πF, ß__doc__.ToObject(), πg.NewStr("Conversion functions between RGB and other color systems.\nThis modules provides two functions for each color system ABC:\n  rgb_to_abc(r, g, b) --> a, b, c\n  abc_to_rgb(a, b, c) --> r, g, b\nAll inputs and outputs are triples of floats in the range [0.0...1.0]\n(with the exception of I and Q, which covers a slightly larger range).\nInputs outside the valid range may cause exceptions or invalid outputs.\nSupported color systems:\nRGB: Red, Green, Blue components\nYIQ: Luminance, Chrominance (used by composite video signals)\nHLS: Hue, Luminance, Saturation\nHSV: Hue, Saturation, Value\n").ToObject()); πE != nil {
				continue
			}
			...
			πTemp002 = πg.NewFunction(πg.NewCode("rgb_to_yiq", "/usr/lib/python2.7/colorsys.py", πTemp003, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
			...
			πTemp004 = πg.NewFunction(πg.NewCode("yiq_to_rgb", "/usr/lib/python2.7/colorsys.py", πTemp003, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
			...
			πTemp003[1] = πg.Param{Name: "g", Def: nil}
			πTemp003[2] = πg.Param{Name: "b", Def: nil}
			πTemp005 = πg.NewFunction(πg.NewCode("rgb_to_hls", "/usr/lib/python2.7/colorsys.py", πTemp003, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µr *πg.Object = πArgs[0]; _ = µr
				var µg *πg.Object = πArgs[1]; _ = µg
				var µb *πg.Object = πArgs[2]; _ = µb
			...
			πTemp006 = πg.NewFunction(πg.NewCode("hls_to_rgb", "/usr/lib/python2.7/colorsys.py", πTemp003, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
			...
			πTemp007 = πg.NewFunction(πg.NewCode("_v", "/usr/lib/python2.7/colorsys.py", πTemp003, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
			...
			πTemp003[1] = πg.Param{Name: "g", Def: nil}
			πTemp003[2] = πg.Param{Name: "b", Def: nil}
			πTemp008 = πg.NewFunction(πg.NewCode("rgb_to_hsv", "/usr/lib/python2.7/colorsys.py", πTemp003, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µr *πg.Object = πArgs[0]; _ = µr
				var µg *πg.Object = πArgs[1]; _ = µg
				var µb *πg.Object = πArgs[2]; _ = µb
				var µmaxc *πg.Object = πg.UnboundLocal; _ = µmaxc
			...
			πTemp009 = πg.NewFunction(πg.NewCode("hsv_to_rgb", "/usr/lib/python2.7/colorsys.py", πTemp003, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µh *πg.Object = πArgs[0]; _ = µh
