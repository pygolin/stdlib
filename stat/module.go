...
var Code *πg.Code
func init() {
	Code = πg.NewCode("<module>", "/usr/lib/python2.7/stat.py", nil, 0, func(πF *πg.Frame, _ []*πg.Object) (*πg.Object, *πg.BaseException) {
		...
		for ; πF.State() >= 0; πF.PopCheckpoint() {
			...
			// line 15: """Interpreting stat() results."""
			πF.SetLineno(15)
			if πE = πF.Globals().SetItem(πF, ß__doc__.ToObject(), πg.NewStr("Interpreting stat() results.").ToObject()); πE != nil {
				continue
			}
			...
			πTemp001 = πTemp002[0]
			if πTemp003, πE = πg.GetAttrImport(πF, πTemp001, ßModeDir); πE != nil {
				continue
			}
			...
			πTemp001 = πTemp002[0]
			if πTemp003, πE = πg.GetAttrImport(πF, πTemp001, ßModePerm); πE != nil {
				continue
			}
			...
			πTemp001 = πg.NewFunction(πg.NewCode("S_ISDIR", "/usr/lib/python2.7/stat.py", πTemp004, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
			...
			πTemp004 = make([]πg.Param, 1)
			πTemp004[0] = πg.Param{Name: "mode", Def: nil}
			πTemp003 = πg.NewFunction(πg.NewCode("S_IMODE", "/usr/lib/python2.7/stat.py", πTemp004, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µmode *πg.Object = πArgs[0]; _ = µmode
				var πTemp001 *πg.Object
				_ = πTemp001
				var πTemp002 *πg.Object
