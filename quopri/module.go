...
var Code *πg.Code
func init() {
	Code = πg.NewCode("<module>", "/usr/lib/python2.7/quopri.py", nil, 0, func(πF *πg.Frame, _ []*πg.Object) (*πg.Object, *πg.BaseException) {
		...
		for ; πF.State() >= 0; πF.PopCheckpoint() {
			...
			// line 3: """Conversions to/from quoted-printable transport encoding as per RFC 1521."""
			πF.SetLineno(3)
			if πE = πF.Globals().SetItem(πF, ß__doc__.ToObject(), πg.NewStr("Conversions to/from quoted-printable transport encoding as per RFC 1521.").ToObject()); πE != nil {
				continue
			}
			...
			πTemp002 = πTemp001[0]
			if πTemp003, πE = πg.GetAttrImport(πF, πTemp002, ßa2b_qp); πE != nil {
				continue
			}
			...
			πTemp002 = πTemp001[0]
			if πTemp003, πE = πg.GetAttrImport(πF, πTemp002, ßb2a_qp); πE != nil {
				continue
			}
		...
		Label1:
			...
			πTemp002 = πg.NewFunction(πg.NewCode("needsquoting", "/usr/lib/python2.7/quopri.py", πTemp007, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
			...
			// line 22: """Decide whether a particular character needs to be quoted.
			πF.SetLineno(22)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp003}, πg.NewStr("Decide whether a particular character needs to be quoted.\n\n    The 'quotetabs' flag indicates whether embedded tabs and spaces should be\n    quoted.  Note that line-ending tabs and spaces are always encoded, as per\n    RFC 1521.\n    ").ToObject()); πE != nil {
				continue
			}
			if πTemp008, πE = πg.ResolveGlobal(πF, ßneedsquoting); πE != nil {
				continue
			}
			if πE = πg.SetAttr(πF, πTemp008, ß__doc__, πTemp003); πE != nil {
				continue
			}
			// line 35: def quote(c):
			πF.SetLineno(35)
			...
			πTemp007[0] = πg.Param{Name: "c", Def: nil}
			πTemp003 = πg.NewFunction(πg.NewCode("quote", "/usr/lib/python2.7/quopri.py", πTemp007, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µc *πg.Object = πArgs[0]; _ = µc
			...
			// line 36: """Quote a single character."""
			πF.SetLineno(36)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp008}, πg.NewStr("Quote a single character.").ToObject()); πE != nil {
				continue
			}
			if πTemp009, πE = πg.ResolveGlobal(πF, ßquote); πE != nil {
				continue
			}
			...
			πTemp008 = πg.NewFunction(πg.NewCode("encode", "/usr/lib/python2.7/quopri.py", πTemp007, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				...
				Label2:
					...
					πTemp001 = πg.NewFunction(πg.NewCode("write", "/usr/lib/python2.7/quopri.py", πTemp007, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
			...
			// line 43: """Read 'input', apply quoted-printable encoding, and write to 'output'.
			πF.SetLineno(43)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp009}, πg.NewStr("Read 'input', apply quoted-printable encoding, and write to 'output'.\n\n    'input' and 'output' are files with readline() and write() methods.\n    The 'quotetabs' flag indicates whether embedded tabs and spaces should be\n    quoted.  Note that line-ending tabs and spaces are always encoded, as per\n    RFC 1521.\n    The 'header' flag indicates whether we are encoding spaces as _ as per\n    RFC 1522.\n    ").ToObject()); πE != nil {
				continue
			}
			if πTemp010, πE = πg.ResolveGlobal(πF, ßencode); πE != nil {
				continue
			}
			...
			πTemp009 = πg.NewFunction(πg.NewCode("encodestring", "/usr/lib/python2.7/quopri.py", πTemp007, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µs *πg.Object = πArgs[0]; _ = µs
				var µquotetabs *πg.Object = πArgs[1]; _ = µquotetabs
				var µheader *πg.Object = πArgs[2]; _ = µheader
				...
				Label2:
					...
					πTemp001 = πTemp005[0]
					if πTemp002, πE = πg.GetAttrImport(πF, πTemp001, ßStringIO); πE != nil {
						continue
					}
					µStringIO = πTemp002
			...
			πTemp007[1] = πg.Param{Name: "output", Def: nil}
			πTemp007[2] = πg.Param{Name: "header", Def: πg.NewInt(0).ToObject()}
			πTemp010 = πg.NewFunction(πg.NewCode("decode", "/usr/lib/python2.7/quopri.py", πTemp007, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µinput *πg.Object = πArgs[0]; _ = µinput
				var µoutput *πg.Object = πArgs[1]; _ = µoutput
				var µheader *πg.Object = πArgs[2]; _ = µheader
				var µdata *πg.Object = πg.UnboundLocal; _ = µdata
			...
			// line 117: """Read 'input', apply quoted-printable decoding, and write to 'output'.
			πF.SetLineno(117)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp011}, πg.NewStr("Read 'input', apply quoted-printable decoding, and write to 'output'.\n    'input' and 'output' are files with readline() and write() methods.\n    If 'header' is true, decode underscore as space (per RFC 1522).").ToObject()); πE != nil {
				continue
			}
			if πTemp012, πE = πg.ResolveGlobal(πF, ßdecode); πE != nil {
				continue
			}
			...
			πTemp011 = πg.NewFunction(πg.NewCode("decodestring", "/usr/lib/python2.7/quopri.py", πTemp007, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µs *πg.Object = πArgs[0]; _ = µs
			...
			πTemp007 = make([]πg.Param, 1)
			πTemp007[0] = πg.Param{Name: "c", Def: nil}
			πTemp012 = πg.NewFunction(πg.NewCode("ishex", "/usr/lib/python2.7/quopri.py", πTemp007, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µc *πg.Object = πArgs[0]; _ = µc
				var πTemp001 *πg.Object
				_ = πTemp001
				var πTemp002 bool
			...
			// line 172: """Return true if the character 'c' is a hexadecimal digit."""
			πF.SetLineno(172)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp013}, πg.NewStr("Return true if the character 'c' is a hexadecimal digit.").ToObject()); πE != nil {
				continue
			}
			if πTemp014, πE = πg.ResolveGlobal(πF, ßishex); πE != nil {
				continue
			}
			...
			πTemp007 = make([]πg.Param, 1)
			πTemp007[0] = πg.Param{Name: "s", Def: nil}
			πTemp013 = πg.NewFunction(πg.NewCode("unhex", "/usr/lib/python2.7/quopri.py", πTemp007, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µs *πg.Object = πArgs[0]; _ = µs
			...
			// line 176: """Get the integer value of a hexadecimal number."""
			πF.SetLineno(176)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp014}, πg.NewStr("Get the integer value of a hexadecimal number.").ToObject()); πE != nil {
				continue
			}
			if πTemp015, πE = πg.ResolveGlobal(πF, ßunhex); πE != nil {
				continue
			}
			...
			πTemp014 = πg.NewFunction(πg.NewCode("main", "/usr/lib/python2.7/quopri.py", πTemp007, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
