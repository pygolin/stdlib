...
var Code *πg.Code
func init() {
	Code = πg.NewCode("<module>", "/usr/lib/python2.7/glob.py", nil, 0, func(πF *πg.Frame, _ []*πg.Object) (*πg.Object, *πg.BaseException) {
		...
		for ; πF.State() >= 0; πF.PopCheckpoint() {
			...
			// line 1: """Filename globbing utility."""
			πF.SetLineno(1)
			if πE = πF.Globals().SetItem(πF, ß__doc__.ToObject(), πg.NewStr("Filename globbing utility.").ToObject()); πE != nil {
				continue
			}
			// line 3: import sys
			πF.SetLineno(3)
		...
		Label3:
			...
			_, πE = πg.NewCode("_unicode", "/usr/lib/python2.7/glob.py", nil, 0, func(πF *πg.Frame, _ []*πg.Object) (*πg.Object, *πg.BaseException) {
				πClass := πTemp006
				_ = πClass
				for ; πF.State() >= 0; πF.PopCheckpoint() {
					switch πF.State() {
		...
		Label1:
			...
			πTemp001 = πg.NewFunction(πg.NewCode("glob", "/usr/lib/python2.7/glob.py", πTemp009, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
			...
			// line 19: """Return a list of paths matching a pathname pattern.
			πF.SetLineno(19)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp007}, πg.NewStr("Return a list of paths matching a pathname pattern.\n\n    The pattern may contain simple shell-style wildcards a la\n    fnmatch. However, unlike fnmatch, filenames starting with a\n    dot are special cases that are not matched by '*' and '?'\n    patterns.\n\n    ").ToObject()); πE != nil {
				continue
			}
			if πTemp008, πE = πg.ResolveGlobal(πF, ßglob); πE != nil {
				continue
			}
			...
			πTemp009 = make([]πg.Param, 1)
			πTemp009[0] = πg.Param{Name: "pathname", Def: nil}
			πTemp007 = πg.NewFunction(πg.NewCode("iglob", "/usr/lib/python2.7/glob.py", πTemp009, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µpathname *πg.Object = πArgs[0]; _ = µpathname
			...
			// line 30: """Return an iterator which yields the paths matching a pathname pattern.
			πF.SetLineno(30)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp008}, πg.NewStr("Return an iterator which yields the paths matching a pathname pattern.\n\n    The pattern may contain simple shell-style wildcards a la\n    fnmatch. However, unlike fnmatch, filenames starting with a\n    dot are special cases that are not matched by '*' and '?'\n    patterns.\n\n    ").ToObject()); πE != nil {
				continue
			}
			if πTemp010, πE = πg.ResolveGlobal(πF, ßiglob); πE != nil {
				continue
			}
			...
			πTemp008 = πg.NewFunction(πg.NewCode("glob1", "/usr/lib/python2.7/glob.py", πTemp009, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				...
				Label10:
					...
					πTemp003 = πg.NewFunction(πg.NewCode("<generator>", "/usr/lib/python2.7/glob.py", πTemp010, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
			...
			πTemp010 = πg.NewFunction(πg.NewCode("glob0", "/usr/lib/python2.7/glob.py", πTemp009, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µdirname *πg.Object = πArgs[0]; _ = µdirname
			...
			πTemp011 = πg.NewFunction(πg.NewCode("has_magic", "/usr/lib/python2.7/glob.py", πTemp009, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
