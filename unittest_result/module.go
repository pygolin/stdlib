...
var Code *πg.Code
func init() {
	Code = πg.NewCode("<module>", "/usr/lib/python2.7/unittest_result.py", nil, 0, func(πF *πg.Frame, _ []*πg.Object) (*πg.Object, *πg.BaseException) {
		...
		for ; πF.State() >= 0; πF.PopCheckpoint() {
			...
			// line 1: """Test result object"""
			πF.SetLineno(1)
			if πE = πF.Globals().SetItem(πF, ß__doc__.ToObject(), πg.NewStr("Test result object").ToObject()); πE != nil {
				continue
			}
			// line 3: import os
			πF.SetLineno(3)
			...
			πTemp001 = πg.NewFunction(πg.NewCode("failfast", "/usr/lib/python2.7/unittest_result.py", πTemp004, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				...
				for ; πF.State() >= 0; πF.PopCheckpoint() {
					...
					πTemp001 = πg.NewFunction(πg.NewCode("inner", "/usr/lib/python2.7/unittest_result.py", πTemp002, πg.CodeFlagVarArg | πg.CodeFlagKWArg, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
			...
			_, πE = πg.NewCode("TestResult", "/usr/lib/python2.7/unittest_result.py", nil, 0, func(πF *πg.Frame, _ []*πg.Object) (*πg.Object, *πg.BaseException) {
				πClass := πTemp005
				_ = πClass
				var πTemp001 *πg.Object
				_ = πTemp001
				...
				for ; πF.State() >= 0; πF.PopCheckpoint() {
					...
					// line 33: """Holder for test result information.
					πF.SetLineno(33)
					if πE = πClass.SetItem(πF, ß__doc__.ToObject(), πg.NewStr("Holder for test result information.\n\n    Test results are automatically managed by the TestCase and TestSuite\n    classes, and do not need to be explicitly manipulated by writers of tests.\n\n    Each instance holds the total number of tests run, and collections of\n    failures and errors that occurred among those test runs. The collections\n    contain tuples of (testcase, exceptioninfo), where exceptioninfo is the\n    formatted traceback of the error that occurred.\n    ").ToObject()); πE != nil {
						continue
					}
					...
					πTemp001 = πg.NewFunction(πg.NewCode("__init__", "/usr/lib/python2.7/unittest_result.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
					...
					πTemp002 = make([]πg.Param, 1)
					πTemp002[0] = πg.Param{Name: "self", Def: nil}
					πTemp003 = πg.NewFunction(πg.NewCode("printErrors", "/usr/lib/python2.7/unittest_result.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
						var πR *πg.Object; _ = πR
						var πE *πg.BaseException; _ = πE
						for ; πF.State() >= 0; πF.PopCheckpoint() {
					...
					// line 63: "Called by TestRunner after test run"
					πF.SetLineno(63)
					if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp004}, πg.NewStr("Called by TestRunner after test run").ToObject()); πE != nil {
						continue
					}
					if πTemp005, πE = πg.ResolveClass(πF, πClass, nil, ßprintErrors); πE != nil {
						continue
					}
					...
					πTemp004 = πg.NewFunction(πg.NewCode("startTest", "/usr/lib/python2.7/unittest_result.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
					...
					// line 66: "Called when the given test is about to be run"
					πF.SetLineno(66)
					if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp005}, πg.NewStr("Called when the given test is about to be run").ToObject()); πE != nil {
						continue
					}
					if πTemp006, πE = πg.ResolveClass(πF, πClass, nil, ßstartTest); πE != nil {
						continue
					}
					...
					πTemp002 = make([]πg.Param, 1)
					πTemp002[0] = πg.Param{Name: "self", Def: nil}
					πTemp005 = πg.NewFunction(πg.NewCode("_setupStdout", "/usr/lib/python2.7/unittest_result.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
						var πTemp001 *πg.Object
						_ = πTemp001
						var πTemp002 bool
					...
					πTemp002 = make([]πg.Param, 1)
					πTemp002[0] = πg.Param{Name: "self", Def: nil}
					πTemp006 = πg.NewFunction(πg.NewCode("startTestRun", "/usr/lib/python2.7/unittest_result.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
						var πR *πg.Object; _ = πR
						var πE *πg.BaseException; _ = πE
						for ; πF.State() >= 0; πF.PopCheckpoint() {
					...
					// line 80: """Called once before any tests are executed.
					πF.SetLineno(80)
					if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp007}, πg.NewStr("Called once before any tests are executed.\n\n        See startTest for a method called before each test.\n        ").ToObject()); πE != nil {
						continue
					}
					if πTemp008, πE = πg.ResolveClass(πF, πClass, nil, ßstartTestRun); πE != nil {
						continue
					}
					...
					πTemp002[0] = πg.Param{Name: "self", Def: nil}
					πTemp002[1] = πg.Param{Name: "test", Def: nil}
					πTemp007 = πg.NewFunction(πg.NewCode("stopTest", "/usr/lib/python2.7/unittest_result.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
						var µtest *πg.Object = πArgs[1]; _ = µtest
						var πTemp001 *πg.Object
						_ = πTemp001
					...
					// line 86: """Called when the given test has been run"""
					πF.SetLineno(86)
					if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp008}, πg.NewStr("Called when the given test has been run").ToObject()); πE != nil {
						continue
					}
					if πTemp009, πE = πg.ResolveClass(πF, πClass, nil, ßstopTest); πE != nil {
						continue
					}
					...
					πTemp002 = make([]πg.Param, 1)
					πTemp002[0] = πg.Param{Name: "self", Def: nil}
					πTemp008 = πg.NewFunction(πg.NewCode("_restoreStdout", "/usr/lib/python2.7/unittest_result.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
					...
					πTemp002 = make([]πg.Param, 1)
					πTemp002[0] = πg.Param{Name: "self", Def: nil}
					πTemp009 = πg.NewFunction(πg.NewCode("stopTestRun", "/usr/lib/python2.7/unittest_result.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
						var πR *πg.Object; _ = πR
						var πE *πg.BaseException; _ = πE
						for ; πF.State() >= 0; πF.PopCheckpoint() {
					...
					// line 112: """Called once after all tests are executed.
					πF.SetLineno(112)
					if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp010}, πg.NewStr("Called once after all tests are executed.\n\n        See stopTest for a method called after each test.\n        ").ToObject()); πE != nil {
						continue
					}
					if πTemp011, πE = πg.ResolveClass(πF, πClass, nil, ßstopTestRun); πE != nil {
						continue
					}
					...
					πTemp010 = πg.NewFunction(πg.NewCode("addError", "/usr/lib/python2.7/unittest_result.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
						var µtest *πg.Object = πArgs[1]; _ = µtest
					...
					// line 119: """Called when an error has occurred. 'err' is a tuple of values as
					πF.SetLineno(119)
					if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp011}, πg.NewStr("Called when an error has occurred. 'err' is a tuple of values as\n        returned by sys.exc_info().\n        ").ToObject()); πE != nil {
						continue
					}
					...
					if πTemp011, πE = πg.ResolveClass(πF, πClass, nil, ßaddError); πE != nil {
						continue
					}
					πTemp013[0] = πTemp011
					if πTemp011, πE = πg.ResolveClass(πF, πClass, nil, ßfailfast); πE != nil {
						continue
					}
					if πTemp012, πE = πTemp011.Call(πF, πTemp013, nil); πE != nil {
						continue
					}
					πF.FreeArgs(πTemp013)
					if πE = πClass.SetItem(πF, ßaddError.ToObject(), πTemp012); πE != nil {
						continue
					}
					...
					πTemp002[1] = πg.Param{Name: "test", Def: nil}
					πTemp002[2] = πg.Param{Name: "err", Def: nil}
					πTemp011 = πg.NewFunction(πg.NewCode("addFailure", "/usr/lib/python2.7/unittest_result.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
						var µtest *πg.Object = πArgs[1]; _ = µtest
						var µerr *πg.Object = πArgs[2]; _ = µerr
						var πTemp001 []*πg.Object
					...
					if πE = πClass.SetItem(πF, ßaddFailure.ToObject(), πTemp011); πE != nil {
						continue
					}
					// line 128: """Called when an error has occurred. 'err' is a tuple of values as
					πF.SetLineno(128)
					if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp012}, πg.NewStr("Called when an error has occurred. 'err' is a tuple of values as\n        returned by sys.exc_info().").ToObject()); πE != nil {
						continue
					}
					if πTemp014, πE = πg.ResolveClass(πF, πClass, nil, ßaddFailure); πE != nil {
						continue
					}
					...
					πF.SetLineno(132)
					πTemp013 = πF.MakeArgs(1)
					if πTemp012, πE = πg.ResolveClass(πF, πClass, nil, ßaddFailure); πE != nil {
						continue
					}
					πTemp013[0] = πTemp012
					...
					πTemp002[0] = πg.Param{Name: "self", Def: nil}
					πTemp002[1] = πg.Param{Name: "test", Def: nil}
					πTemp012 = πg.NewFunction(πg.NewCode("addSuccess", "/usr/lib/python2.7/unittest_result.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
						var µtest *πg.Object = πArgs[1]; _ = µtest
						var πR *πg.Object; _ = πR
						var πE *πg.BaseException; _ = πE
					...
					if πE = πClass.SetItem(πF, ßaddSuccess.ToObject(), πTemp012); πE != nil {
						continue
					}
					// line 135: "Called when a test has completed successfully"
					πF.SetLineno(135)
					if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp014}, πg.NewStr("Called when a test has completed successfully").ToObject()); πE != nil {
						continue
					}
					if πTemp015, πE = πg.ResolveClass(πF, πClass, nil, ßaddSuccess); πE != nil {
						continue
					}
					...
					πTemp014 = πg.NewFunction(πg.NewCode("addSkip", "/usr/lib/python2.7/unittest_result.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
						var µtest *πg.Object = πArgs[1]; _ = µtest
					...
					// line 139: """Called when a test is skipped."""
					πF.SetLineno(139)
					if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp015}, πg.NewStr("Called when a test is skipped.").ToObject()); πE != nil {
						continue
					}
					if πTemp016, πE = πg.ResolveClass(πF, πClass, nil, ßaddSkip); πE != nil {
						continue
					}
					...
					πTemp002[1] = πg.Param{Name: "test", Def: nil}
					πTemp002[2] = πg.Param{Name: "err", Def: nil}
					πTemp015 = πg.NewFunction(πg.NewCode("addExpectedFailure", "/usr/lib/python2.7/unittest_result.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
						var µtest *πg.Object = πArgs[1]; _ = µtest
						var µerr *πg.Object = πArgs[2]; _ = µerr
						var πTemp001 []*πg.Object
					...
					// line 143: """Called when an expected failure/error occurred."""
					πF.SetLineno(143)
					if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp016}, πg.NewStr("Called when an expected failure/error occurred.").ToObject()); πE != nil {
						continue
					}
					if πTemp017, πE = πg.ResolveClass(πF, πClass, nil, ßaddExpectedFailure); πE != nil {
						continue
					}
					...
					πTemp002[0] = πg.Param{Name: "self", Def: nil}
					πTemp002[1] = πg.Param{Name: "test", Def: nil}
					πTemp016 = πg.NewFunction(πg.NewCode("addUnexpectedSuccess", "/usr/lib/python2.7/unittest_result.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
						var µtest *πg.Object = πArgs[1]; _ = µtest
						var πTemp001 []*πg.Object
						_ = πTemp001
					...
					// line 149: """Called when a test was expected to fail, but succeed."""
					πF.SetLineno(149)
					if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp017}, πg.NewStr("Called when a test was expected to fail, but succeed.").ToObject()); πE != nil {
						continue
					}
					if πTemp018, πE = πg.ResolveClass(πF, πClass, nil, ßaddUnexpectedSuccess); πE != nil {
						continue
					}
					...
					πTemp002 = make([]πg.Param, 1)
					πTemp002[0] = πg.Param{Name: "self", Def: nil}
					πTemp017 = πg.NewFunction(πg.NewCode("wasSuccessful", "/usr/lib/python2.7/unittest_result.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
						var πTemp001 *πg.Object
						_ = πTemp001
						var πTemp002 []*πg.Object
					...
					// line 154: "Tells whether or not this result was a success"
					πF.SetLineno(154)
					if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp018}, πg.NewStr("Tells whether or not this result was a success").ToObject()); πE != nil {
						continue
					}
					if πTemp019, πE = πg.ResolveClass(πF, πClass, nil, ßwasSuccessful); πE != nil {
						continue
					}
					...
					πTemp002 = make([]πg.Param, 1)
					πTemp002[0] = πg.Param{Name: "self", Def: nil}
					πTemp018 = πg.NewFunction(πg.NewCode("stop", "/usr/lib/python2.7/unittest_result.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
						var πTemp001 *πg.Object
						_ = πTemp001
						var πTemp002 *πg.Object
					...
					// line 158: "Indicates that the tests should be aborted"
					πF.SetLineno(158)
					if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp019}, πg.NewStr("Indicates that the tests should be aborted").ToObject()); πE != nil {
						continue
					}
					if πTemp020, πE = πg.ResolveClass(πF, πClass, nil, ßstop); πE != nil {
						continue
					}
					...
					πTemp019 = πg.NewFunction(πg.NewCode("_exc_info_to_string", "/usr/lib/python2.7/unittest_result.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
					...
					// line 162: """Converts a sys.exc_info()-style tuple of values into a string."""
					πF.SetLineno(162)
					if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp020}, πg.NewStr("Converts a sys.exc_info()-style tuple of values into a string.").ToObject()); πE != nil {
						continue
					}
					if πTemp021, πE = πg.ResolveClass(πF, πClass, nil, ß_exc_info_to_string); πE != nil {
						continue
					}
					...
					πTemp020 = πg.NewFunction(πg.NewCode("_is_relevant_tb_level", "/usr/lib/python2.7/unittest_result.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
					...
					πTemp002[0] = πg.Param{Name: "self", Def: nil}
					πTemp002[1] = πg.Param{Name: "tb", Def: nil}
					πTemp021 = πg.NewFunction(πg.NewCode("_count_relevant_tb_levels", "/usr/lib/python2.7/unittest_result.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
						var µtb *πg.Object = πArgs[1]; _ = µtb
						var µlength *πg.Object = πg.UnboundLocal; _ = µlength
						var πTemp001 bool
					...
					πTemp002 = make([]πg.Param, 1)
					πTemp002[0] = πg.Param{Name: "self", Def: nil}
					πTemp022 = πg.NewFunction(πg.NewCode("__repr__", "/usr/lib/python2.7/unittest_result.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
						var πTemp001 *πg.Object
						_ = πTemp001
						var πTemp002 *πg.Object
