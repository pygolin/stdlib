...
var Code *πg.Code
func init() {
	Code = πg.NewCode("<module>", "/usr/lib/python2.7/mimetools.py", nil, 0, func(πF *πg.Frame, _ []*πg.Object) (*πg.Object, *πg.BaseException) {
		...
		for ; πF.State() >= 0; πF.PopCheckpoint() {
			...
			// line 1: """Various tools used by MIME-reading or MIME-writing programs."""
			πF.SetLineno(1)
			if πE = πF.Globals().SetItem(πF, ß__doc__.ToObject(), πg.NewStr("Various tools used by MIME-reading or MIME-writing programs.").ToObject()); πE != nil {
				continue
			}
			// line 4: import os
			πF.SetLineno(4)
			...
			πTemp001 = πTemp002[0]
			if πTemp003, πE = πg.GetAttrImport(πF, πTemp001, ßfilterwarnings); πE != nil {
				continue
			}
			...
			πTemp001 = πTemp002[0]
			if πTemp003, πE = πg.GetAttrImport(πF, πTemp001, ßcatch_warnings); πE != nil {
				continue
			}
		...
		Label1:
			...
			πTemp005 = πTemp002[0]
			if πTemp006, πE = πg.GetAttrImport(πF, πTemp005, ßwarnpy3k); πE != nil {
				continue
			}
			if πE = πF.Globals().SetItem(πF, ßwarnpy3k.ToObject(), πTemp006); πE != nil {
				continue
			}
			...
			if πTemp006, πE = πTemp005.Call(πF, πTemp002, πTemp011); πE != nil {
				continue
			}
			πF.FreeArgs(πTemp002)
			...
			if πE = πF.Globals().SetItem(πF, ß__all__.ToObject(), πTemp005); πE != nil {
				continue
			}
			// line 20: class Message(rfc822.Message):
			πF.SetLineno(20)
			πTemp002 = make([]*πg.Object, 1)
			if πTemp013, πE = πg.ResolveGlobal(πF, ßrfc822); πE != nil {
				continue
			}
			if πTemp014, πE = πg.GetAttr(πF, πTemp013, ßMessage, nil); πE != nil {
				continue
			}
			πTemp002[0] = πTemp014
			πTemp012 = πg.NewDict()
			...
			if πE = πTemp012.SetItem(πF, ß__module__.ToObject(), πTemp005); πE != nil {
				continue
			}
			_, πE = πg.NewCode("Message", "/usr/lib/python2.7/mimetools.py", nil, 0, func(πF *πg.Frame, _ []*πg.Object) (*πg.Object, *πg.BaseException) {
				πClass := πTemp012
				_ = πClass
				var πTemp001 *πg.Object
				_ = πTemp001
				...
				for ; πF.State() >= 0; πF.PopCheckpoint() {
					...
					// line 21: """A derived class of rfc822.Message that knows about MIME headers and
					πF.SetLineno(21)
					if πE = πClass.SetItem(πF, ß__doc__.ToObject(), πg.NewStr("A derived class of rfc822.Message that knows about MIME headers and\n    contains some hooks for decoding encoded and multipart messages.").ToObject()); πE != nil {
						continue
					}
					...
					πTemp001 = πg.NewFunction(πg.NewCode("__init__", "/usr/lib/python2.7/mimetools.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
					...
					πTemp002[0] = πg.Param{Name: "self", Def: nil}
					πTemp003 = πg.NewFunction(πg.NewCode("parsetype", "/usr/lib/python2.7/mimetools.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
					...
					πTemp002 = make([]πg.Param, 1)
					πTemp002[0] = πg.Param{Name: "self", Def: nil}
					πTemp004 = πg.NewFunction(πg.NewCode("parseplist", "/usr/lib/python2.7/mimetools.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
						var µstr *πg.Object = πg.UnboundLocal; _ = µstr
					...
					πTemp002 = make([]πg.Param, 1)
					πTemp002[0] = πg.Param{Name: "self", Def: nil}
					πTemp005 = πg.NewFunction(πg.NewCode("getplist", "/usr/lib/python2.7/mimetools.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
						var πTemp001 *πg.Object
						_ = πTemp001
						var πR *πg.Object; _ = πR
					...
					πTemp006 = πg.NewFunction(πg.NewCode("getparam", "/usr/lib/python2.7/mimetools.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
					...
					πTemp002 = make([]πg.Param, 1)
					πTemp002[0] = πg.Param{Name: "self", Def: nil}
					πTemp007 = πg.NewFunction(πg.NewCode("getparamnames", "/usr/lib/python2.7/mimetools.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
					...
					πTemp002 = make([]πg.Param, 1)
					πTemp002[0] = πg.Param{Name: "self", Def: nil}
					πTemp008 = πg.NewFunction(πg.NewCode("getencoding", "/usr/lib/python2.7/mimetools.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
						var πTemp001 *πg.Object
						_ = πTemp001
						var πTemp002 *πg.Object
					...
					πTemp002 = make([]πg.Param, 1)
					πTemp002[0] = πg.Param{Name: "self", Def: nil}
					πTemp009 = πg.NewFunction(πg.NewCode("gettype", "/usr/lib/python2.7/mimetools.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
						var πTemp001 *πg.Object
						_ = πTemp001
						var πR *πg.Object; _ = πR
					...
					πTemp002 = make([]πg.Param, 1)
					πTemp002[0] = πg.Param{Name: "self", Def: nil}
					πTemp010 = πg.NewFunction(πg.NewCode("getmaintype", "/usr/lib/python2.7/mimetools.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
						var πTemp001 *πg.Object
						_ = πTemp001
						var πR *πg.Object; _ = πR
					...
					πTemp002 = make([]πg.Param, 1)
					πTemp002[0] = πg.Param{Name: "self", Def: nil}
					πTemp011 = πg.NewFunction(πg.NewCode("getsubtype", "/usr/lib/python2.7/mimetools.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
						var πTemp001 *πg.Object
						_ = πTemp001
						var πR *πg.Object; _ = πR
			...
			if πTemp006, πE = πTemp012.GetItem(πF, ß__metaclass__.ToObject()); πE != nil {
				continue
			}
			if πTemp006 == nil {
				πTemp006 = πg.TypeType.ToObject()
			}
			if πTemp013, πE = πTemp006.Call(πF, []*πg.Object{πg.NewStr("Message").ToObject(), πg.NewTuple(πTemp002...).ToObject(), πTemp012.ToObject()}, nil); πE != nil {
				continue
			}
			if πE = πF.Globals().SetItem(πF, ßMessage.ToObject(), πTemp013); πE != nil {
				continue
			}
			...
			πTemp005 = πTemp002[0]
			if πE = πF.Globals().SetItem(πF, ßthread.ToObject(), πTemp005); πE != nil {
				continue
			}
			...
			if πTemp006, πE = πg.GetAttr(πF, πTemp005, ßallocate_lock, nil); πE != nil {
				continue
			}
			if πTemp005, πE = πTemp006.Call(πF, nil, nil); πE != nil {
				continue
			}
			if πE = πF.Globals().SetItem(πF, ß_counter_lock.ToObject(), πTemp005); πE != nil {
				continue
			}
			// line 112: del thread
			πF.SetLineno(112)
			...
			πTemp005 = πg.NewFunction(πg.NewCode("_get_next_counter", "/usr/lib/python2.7/mimetools.py", πTemp015, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µresult *πg.Object = πg.UnboundLocal; _ = µresult
				var πTemp001 *πg.Object
				_ = πTemp001
				var πTemp002 *πg.Object
			...
			if πE = πF.Globals().SetItem(πF, ß_get_next_counter.ToObject(), πTemp005); πE != nil {
				continue
			}
			...
			if πE = πF.Globals().SetItem(πF, ß_prefix.ToObject(), πTemp006); πE != nil {
				continue
			}
			// line 157: def decode(input, output, encoding):
			πF.SetLineno(157)
			πTemp015 = make([]πg.Param, 3)
			πTemp015[0] = πg.Param{Name: "input", Def: nil}
			πTemp015[1] = πg.Param{Name: "output", Def: nil}
			πTemp015[2] = πg.Param{Name: "encoding", Def: nil}
			πTemp006 = πg.NewFunction(πg.NewCode("decode", "/usr/lib/python2.7/mimetools.py", πTemp015, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
			...
			if πE = πF.Globals().SetItem(πF, ßdecode.ToObject(), πTemp006); πE != nil {
				continue
			}
			// line 158: """Decode common content-transfer-encodings (base64, quopri, uuencode)."""
			πF.SetLineno(158)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp013}, πg.NewStr("Decode common content-transfer-encodings (base64, quopri, uuencode).").ToObject()); πE != nil {
				continue
			}
			if πTemp014, πE = πg.ResolveGlobal(πF, ßdecode); πE != nil {
				continue
			}
			...
			πTemp015[1] = πg.Param{Name: "output", Def: nil}
			πTemp015[2] = πg.Param{Name: "encoding", Def: nil}
			πTemp013 = πg.NewFunction(πg.NewCode("encode", "/usr/lib/python2.7/mimetools.py", πTemp015, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µinput *πg.Object = πArgs[0]; _ = µinput
				var µoutput *πg.Object = πArgs[1]; _ = µoutput
				var µencoding *πg.Object = πArgs[2]; _ = µencoding
				var µbase64 *πg.Object = πg.UnboundLocal; _ = µbase64
			...
			if πE = πF.Globals().SetItem(πF, ßencode.ToObject(), πTemp013); πE != nil {
				continue
			}
			// line 177: """Encode common content-transfer-encodings (base64, quopri, uuencode)."""
			πF.SetLineno(177)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp014}, πg.NewStr("Encode common content-transfer-encodings (base64, quopri, uuencode).").ToObject()); πE != nil {
				continue
			}
			if πTemp016, πE = πg.ResolveGlobal(πF, ßencode); πE != nil {
				continue
			}
			if πE = πg.SetAttr(πF, πTemp016, ß__doc__, πTemp014); πE != nil {
				continue
			}
			...
			πF.SetLineno(206)
			πTemp012 = πg.NewDict()
			if πTemp014, πE = πg.ResolveGlobal(πF, ßuudecode_pipe); πE != nil {
				continue
			}
			if πE = πTemp012.SetItem(πF, ßuuencode.ToObject(), πTemp014); πE != nil {
				continue
			}
			if πTemp014, πE = πg.ResolveGlobal(πF, ßuudecode_pipe); πE != nil {
				continue
			}
			if πE = πTemp012.SetItem(πF, πg.NewStr("x-uuencode").ToObject(), πTemp014); πE != nil {
				continue
			}
			if πTemp014, πE = πg.ResolveGlobal(πF, ßuudecode_pipe); πE != nil {
				continue
			}
			if πE = πTemp012.SetItem(πF, ßuue.ToObject(), πTemp014); πE != nil {
				continue
			}
			if πTemp014, πE = πg.ResolveGlobal(πF, ßuudecode_pipe); πE != nil {
				continue
			}
			if πE = πTemp012.SetItem(πF, πg.NewStr("x-uue").ToObject(), πTemp014); πE != nil {
				continue
			}
			...
			πTemp014 = πTemp012.ToObject()
			if πE = πF.Globals().SetItem(πF, ßdecodetab.ToObject(), πTemp014); πE != nil {
				continue
			}
			// line 215: encodetab = {
			πF.SetLineno(215)
			...
			πTemp014 = πTemp012.ToObject()
			if πE = πF.Globals().SetItem(πF, ßencodetab.ToObject(), πTemp014); πE != nil {
				continue
			}
			// line 224: def pipeto(input, command):
			πF.SetLineno(224)
			πTemp015 = make([]πg.Param, 2)
			πTemp015[0] = πg.Param{Name: "input", Def: nil}
			πTemp015[1] = πg.Param{Name: "command", Def: nil}
			πTemp014 = πg.NewFunction(πg.NewCode("pipeto", "/usr/lib/python2.7/mimetools.py", πTemp015, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µinput *πg.Object = πArgs[0]; _ = µinput
			...
			if πE = πF.Globals().SetItem(πF, ßpipeto.ToObject(), πTemp014); πE != nil {
				continue
			}
			...
			πTemp015[0] = πg.Param{Name: "input", Def: nil}
			πTemp015[1] = πg.Param{Name: "command", Def: nil}
			πTemp015[2] = πg.Param{Name: "output", Def: nil}
			πTemp016 = πg.NewFunction(πg.NewCode("pipethrough", "/usr/lib/python2.7/mimetools.py", πTemp015, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µinput *πg.Object = πArgs[0]; _ = µinput
				var µcommand *πg.Object = πArgs[1]; _ = µcommand
			...
			if πE = πF.Globals().SetItem(πF, ßpipethrough.ToObject(), πTemp016); πE != nil {
				continue
			}
			...
			πTemp015[0] = πg.Param{Name: "input", Def: nil}
			πTemp015[1] = πg.Param{Name: "output", Def: nil}
			πTemp017 = πg.NewFunction(πg.NewCode("copyliteral", "/usr/lib/python2.7/mimetools.py", πTemp015, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µinput *πg.Object = πArgs[0]; _ = µinput
				var µoutput *πg.Object = πArgs[1]; _ = µoutput
			...
			if πE = πF.Globals().SetItem(πF, ßcopyliteral.ToObject(), πTemp017); πE != nil {
				continue
			}
			...
			πTemp015[0] = πg.Param{Name: "input", Def: nil}
			πTemp015[1] = πg.Param{Name: "output", Def: nil}
			πTemp018 = πg.NewFunction(πg.NewCode("copybinary", "/usr/lib/python2.7/mimetools.py", πTemp015, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µinput *πg.Object = πArgs[0]; _ = µinput
				var µoutput *πg.Object = πArgs[1]; _ = µoutput
			...
			if πE = πF.Globals().SetItem(πF, ßcopybinary.ToObject(), πTemp018); πE != nil {
				continue
			}
		}
		return nil, πE
