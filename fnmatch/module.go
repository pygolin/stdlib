...
var Code *πg.Code
func init() {
	Code = πg.NewCode("<module>", "/usr/lib/python2.7/fnmatch.py", nil, 0, func(πF *πg.Frame, _ []*πg.Object) (*πg.Object, *πg.BaseException) {
		...
		for ; πF.State() >= 0; πF.PopCheckpoint() {
			...
			// line 1: """Filename matching with shell patterns.
			πF.SetLineno(1)
			if πE = πF.Globals().SetItem(πF, ß__doc__.ToObject(), πg.NewStr("Filename matching with shell patterns.\n\nfnmatch(FILENAME, PATTERN) matches according to the local convention.\nfnmatchcase(FILENAME, PATTERN) always takes case in account.\n\nThe functions operate by translating the pattern into a regular\nexpression.  They cache the compiled regular expressions for speed.\n\nThe function translate(PATTERN) returns a regular expression\ncorresponding to PATTERN.  (It does not compile it.)\n").ToObject()); πE != nil {
				continue
			}
			// line 13: import re
			πF.SetLineno(13)
			...
			πTemp001 = πg.NewFunction(πg.NewCode("_purge", "/usr/lib/python2.7/fnmatch.py", πTemp004, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
			...
			// line 21: """Clear the pattern cache"""
			πF.SetLineno(21)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp005}, πg.NewStr("Clear the pattern cache").ToObject()); πE != nil {
				continue
			}
			if πTemp006, πE = πg.ResolveGlobal(πF, ß_purge); πE != nil {
				continue
			}
			...
			πTemp005 = πg.NewFunction(πg.NewCode("fnmatch", "/usr/lib/python2.7/fnmatch.py", πTemp004, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
			...
			// line 26: """Test whether FILENAME matches PATTERN.
			πF.SetLineno(26)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp006}, πg.NewStr("Test whether FILENAME matches PATTERN.\n\n    Patterns are Unix shell style:\n\n    *       matches everything\n    ?       matches any single character\n    [seq]   matches any character in seq\n    [!seq]  matches any char not in seq\n\n    An initial period in FILENAME is not special.\n    Both FILENAME and PATTERN are first case-normalized\n    if the operating system requires it.\n    If you don't want this, use fnmatchcase(FILENAME, PATTERN).\n    ").ToObject()); πE != nil {
				continue
			}
			if πTemp007, πE = πg.ResolveGlobal(πF, ßfnmatch); πE != nil {
				continue
			}
			...
			πTemp004[1] = πg.Param{Name: "pat", Def: nil}
			πTemp006 = πg.NewFunction(πg.NewCode("filter", "/usr/lib/python2.7/fnmatch.py", πTemp004, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
			...
			// line 47: """Return the subset of the list NAMES that match PAT"""
			πF.SetLineno(47)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp007}, πg.NewStr("Return the subset of the list NAMES that match PAT").ToObject()); πE != nil {
				continue
			}
			if πTemp008, πE = πg.ResolveGlobal(πF, ßfilter); πE != nil {
				continue
			}
			...
			πTemp004[0] = πg.Param{Name: "name", Def: nil}
			πTemp004[1] = πg.Param{Name: "pat", Def: nil}
			πTemp007 = πg.NewFunction(πg.NewCode("fnmatchcase", "/usr/lib/python2.7/fnmatch.py", πTemp004, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µname *πg.Object = πArgs[0]; _ = µname
				var µpat *πg.Object = πArgs[1]; _ = µpat
				var µre_pat *πg.Object = πg.UnboundLocal; _ = µre_pat
				var µres *πg.Object = πg.UnboundLocal; _ = µres
			...
			// line 74: """Test whether FILENAME matches PATTERN, including case.
			πF.SetLineno(74)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp008}, πg.NewStr("Test whether FILENAME matches PATTERN, including case.\n\n    This is a version of fnmatch() which doesn't case-normalize\n    its arguments.\n    ").ToObject()); πE != nil {
				continue
			}
			if πTemp009, πE = πg.ResolveGlobal(πF, ßfnmatchcase); πE != nil {
				continue
			}
			...
			πTemp008 = πg.NewFunction(πg.NewCode("translate", "/usr/lib/python2.7/fnmatch.py", πTemp004, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
			...
			// line 91: """Translate a shell PATTERN to a regular expression.
			πF.SetLineno(91)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp009}, πg.NewStr("Translate a shell PATTERN to a regular expression.\n\n    There is no way to quote meta-characters.\n    ").ToObject()); πE != nil {
				continue
			}
			if πTemp010, πE = πg.ResolveGlobal(πF, ßtranslate); πE != nil {
				continue
			}
