...
var Code *πg.Code
func init() {
	Code = πg.NewCode("<module>", "/usr/lib/python2.7/re.py", nil, 0, func(πF *πg.Frame, _ []*πg.Object) (*πg.Object, *πg.BaseException) {
		...
		for ; πF.State() >= 0; πF.PopCheckpoint() {
			...
			πTemp001 = πg.NewFunction(πg.NewCode("match", "/usr/lib/python2.7/re.py", πTemp004, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
			...
			// line 142: """Try to apply the pattern at the start of the string, returning
			πF.SetLineno(142)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp003}, πg.NewStr("Try to apply the pattern at the start of the string, returning\n    a match object, or None if no match was found.").ToObject()); πE != nil {
				continue
			}
			if πTemp005, πE = πg.ResolveGlobal(πF, ßmatch); πE != nil {
				continue
			}
			...
			πTemp004[1] = πg.Param{Name: "string", Def: nil}
			πTemp004[2] = πg.Param{Name: "flags", Def: πg.NewInt(0).ToObject()}
			πTemp003 = πg.NewFunction(πg.NewCode("search", "/usr/lib/python2.7/re.py", πTemp004, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µpattern *πg.Object = πArgs[0]; _ = µpattern
				var µstring *πg.Object = πArgs[1]; _ = µstring
				var µflags *πg.Object = πArgs[2]; _ = µflags
				var πTemp001 []*πg.Object
			...
			// line 147: """Scan through string looking for a match to the pattern, returning
			πF.SetLineno(147)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp005}, πg.NewStr("Scan through string looking for a match to the pattern, returning\n    a match object, or None if no match was found.").ToObject()); πE != nil {
				continue
			}
			if πTemp006, πE = πg.ResolveGlobal(πF, ßsearch); πE != nil {
				continue
			}
			...
			πTemp005 = πg.NewFunction(πg.NewCode("sub", "/usr/lib/python2.7/re.py", πTemp004, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µpattern *πg.Object = πArgs[0]; _ = µpattern
			...
			// line 152: """Return the string obtained by replacing the leftmost
			πF.SetLineno(152)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp006}, πg.NewStr("Return the string obtained by replacing the leftmost\n    non-overlapping occurrences of the pattern in string by the\n    replacement repl.  repl can be either a string or a callable;\n    if a string, backslash escapes in it are processed.  If it is\n    a callable, it's passed the match object and must return\n    a replacement string to be used.").ToObject()); πE != nil {
				continue
			}
			if πTemp007, πE = πg.ResolveGlobal(πF, ßsub); πE != nil {
				continue
			}
			...
			πTemp004[3] = πg.Param{Name: "count", Def: πg.NewInt(0).ToObject()}
			πTemp004[4] = πg.Param{Name: "flags", Def: πg.NewInt(0).ToObject()}
			πTemp006 = πg.NewFunction(πg.NewCode("subn", "/usr/lib/python2.7/re.py", πTemp004, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µpattern *πg.Object = πArgs[0]; _ = µpattern
				var µrepl *πg.Object = πArgs[1]; _ = µrepl
				var µstring *πg.Object = πArgs[2]; _ = µstring
				var µcount *πg.Object = πArgs[3]; _ = µcount
			...
			// line 161: """Return a 2-tuple containing (new_string, number).
			πF.SetLineno(161)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp007}, πg.NewStr("Return a 2-tuple containing (new_string, number).\n    new_string is the string obtained by replacing the leftmost\n    non-overlapping occurrences of the pattern in the source\n    string by the replacement repl.  number is the number of\n    substitutions that were made. repl can be either a string or a\n    callable; if a string, backslash escapes in it are processed.\n    If it is a callable, it's passed the match object and must\n    return a replacement string to be used.").ToObject()); πE != nil {
				continue
			}
			if πTemp008, πE = πg.ResolveGlobal(πF, ßsubn); πE != nil {
				continue
			}
			...
			πTemp007 = πg.NewFunction(πg.NewCode("split", "/usr/lib/python2.7/re.py", πTemp004, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µpattern *πg.Object = πArgs[0]; _ = µpattern
				var µstring *πg.Object = πArgs[1]; _ = µstring
			...
			// line 172: """Split the source string by the occurrences of the pattern,
			πF.SetLineno(172)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp008}, πg.NewStr("Split the source string by the occurrences of the pattern,\n    returning a list containing the resulting substrings.").ToObject()); πE != nil {
				continue
			}
			if πTemp009, πE = πg.ResolveGlobal(πF, ßsplit); πE != nil {
				continue
			}
			...
			πTemp004[1] = πg.Param{Name: "string", Def: nil}
			πTemp004[2] = πg.Param{Name: "flags", Def: πg.NewInt(0).ToObject()}
			πTemp008 = πg.NewFunction(πg.NewCode("findall", "/usr/lib/python2.7/re.py", πTemp004, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µpattern *πg.Object = πArgs[0]; _ = µpattern
				var µstring *πg.Object = πArgs[1]; _ = µstring
				var µflags *πg.Object = πArgs[2]; _ = µflags
				...
				for ; πF.State() >= 0; πF.PopCheckpoint() {
					...
					πTemp003 = πg.NewFunction(πg.NewCode("finditer", "/usr/lib/python2.7/re.py", πTemp005, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µpattern *πg.Object = πArgs[0]; _ = µpattern
						var µstring *πg.Object = πArgs[1]; _ = µstring
						var µflags *πg.Object = πArgs[2]; _ = µflags
						var πTemp001 []*πg.Object
					...
					// line 189: """Return an iterator over all non-overlapping matches in the
					πF.SetLineno(189)
					if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp004}, πg.NewStr("Return an iterator over all non-overlapping matches in the\n        string.  For each match, the iterator returns a match object.\n\n        Empty matches are included in the result.").ToObject()); πE != nil {
						continue
					}
					if πE = πg.CheckLocal(πF, µfinditer, "finditer"); πE != nil {
						continue
					}
					if πE = πg.SetAttr(πF, µfinditer, ß__doc__, πTemp004); πE != nil {
						continue
					}
				}
				if πE != nil {
			...
			// line 177: """Return a list of all non-overlapping matches in the string.
			πF.SetLineno(177)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp009}, πg.NewStr("Return a list of all non-overlapping matches in the string.\n\n    If one or more groups are present in the pattern, return a\n    list of groups; this will be a list of tuples if the pattern\n    has more than one group.\n\n    Empty matches are included in the result.").ToObject()); πE != nil {
				continue
			}
			if πTemp010, πE = πg.ResolveGlobal(πF, ßfindall); πE != nil {
				continue
			}
			...
			πTemp009 = πg.NewFunction(πg.NewCode("compile", "/usr/lib/python2.7/re.py", πTemp004, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µpattern *πg.Object = πArgs[0]; _ = µpattern
			...
			// line 196: "Compile a regular expression pattern, returning a pattern object."
			πF.SetLineno(196)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp010}, πg.NewStr("Compile a regular expression pattern, returning a pattern object.").ToObject()); πE != nil {
				continue
			}
			if πTemp011, πE = πg.ResolveGlobal(πF, ßcompile); πE != nil {
				continue
			}
			...
			πTemp010 = πg.NewFunction(πg.NewCode("purge", "/usr/lib/python2.7/re.py", πTemp004, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var πTemp001 *πg.Object
				_ = πTemp001
				var πTemp002 *πg.Object
				_ = πTemp002
			...
			// line 200: "Clear the regular expression cache"
			πF.SetLineno(200)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp011}, πg.NewStr("Clear the regular expression cache").ToObject()); πE != nil {
				continue
			}
			if πTemp012, πE = πg.ResolveGlobal(πF, ßpurge); πE != nil {
				continue
			}
			...
			πTemp004[0] = πg.Param{Name: "pattern", Def: nil}
			πTemp004[1] = πg.Param{Name: "flags", Def: πg.NewInt(0).ToObject()}
			πTemp011 = πg.NewFunction(πg.NewCode("template", "/usr/lib/python2.7/re.py", πTemp004, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µpattern *πg.Object = πArgs[0]; _ = µpattern
				var µflags *πg.Object = πArgs[1]; _ = µflags
				var πTemp001 []*πg.Object
				_ = πTemp001
			...
			// line 205: "Compile a template pattern, returning a pattern object"
			πF.SetLineno(205)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp012}, πg.NewStr("Compile a template pattern, returning a pattern object").ToObject()); πE != nil {
				continue
			}
			if πTemp013, πE = πg.ResolveGlobal(πF, ßtemplate); πE != nil {
				continue
			}
			...
			πTemp004[0] = πg.Param{Name: "pattern", Def: nil}
			πTemp012 = πg.NewFunction(πg.NewCode("escape", "/usr/lib/python2.7/re.py", πTemp004, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µpattern *πg.Object = πArgs[0]; _ = µpattern
			...
			// line 212: "Escape all non-alphanumeric characters in pattern."
			πF.SetLineno(212)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp013}, πg.NewStr("Escape all non-alphanumeric characters in pattern.").ToObject()); πE != nil {
				continue
			}
			if πTemp014, πE = πg.ResolveGlobal(πF, ßescape); πE != nil {
				continue
			}
			...
			πTemp016[0] = ß.ToObject()
			πTemp016[1] = πg.NewInt(0).ToObject()
			...
			if πTemp013, πE = πTemp014.Call(πF, πTemp016, nil); πE != nil {
				continue
			}
			...
			πF.FreeArgs(πTemp002)
			if πE = πF.Globals().SetItem(πF, ß_pattern_type.ToObject(), πTemp014); πE != nil {
				continue
			}
			...
			πF.SetLineno(233)
			πTemp004 = make([]πg.Param, 0)
			πTemp013 = πg.NewFunction(πg.NewCode("_compile", "/usr/lib/python2.7/re.py", πTemp004, πg.CodeFlagVarArg, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
			...
			πF.SetLineno(267)
			πTemp004 = make([]πg.Param, 0)
			πTemp014 = πg.NewFunction(πg.NewCode("_compile_repl", "/usr/lib/python2.7/re.py", πTemp004, πg.CodeFlagVarArg, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µkey *πg.Object = πArgs[0]; _ = µkey
				var µp *πg.Object = πg.UnboundLocal; _ = µp
			...
			if πE = πF.Globals().SetItem(πF, ß_compile_repl.ToObject(), πTemp014); πE != nil {
				continue
			}
			...
			πTemp017 = πg.NewFunction(πg.NewCode("_expand", "/usr/lib/python2.7/re.py", πTemp004, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µpattern *πg.Object = πArgs[0]; _ = µpattern
			...
			πTemp018 = πg.NewFunction(πg.NewCode("_subx", "/usr/lib/python2.7/re.py", πTemp004, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µpattern *πg.Object = πArgs[0]; _ = µpattern
				...
				Label3:
					...
					πTemp002 = πg.NewFunction(πg.NewCode("filter", "/usr/lib/python2.7/re.py", πTemp008, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
			...
			πTemp019 = πg.NewFunction(πg.NewCode("_pickle", "/usr/lib/python2.7/re.py", πTemp004, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
			...
			if πE = πTemp015.SetItem(πF, ß__module__.ToObject(), πTemp020); πE != nil {
				continue
			}
			_, πE = πg.NewCode("Scanner", "/usr/lib/python2.7/re.py", nil, 0, func(πF *πg.Frame, _ []*πg.Object) (*πg.Object, *πg.BaseException) {
				πClass := πTemp015
				_ = πClass
				var πTemp001 *πg.Object
				_ = πTemp001
				...
				for ; πF.State() >= 0; πF.PopCheckpoint() {
					...
					πTemp001 = πg.NewFunction(πg.NewCode("__init__", "/usr/lib/python2.7/re.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
					...
					πTemp003 = πg.NewFunction(πg.NewCode("scan", "/usr/lib/python2.7/re.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
						var µstring *πg.Object = πArgs[1]; _ = µstring
			...
			if πTemp021, πE = πTemp015.GetItem(πF, ß__metaclass__.ToObject()); πE != nil {
				continue
			}
			if πTemp021 == nil {
				πTemp021 = πg.TypeType.ToObject()
			}
			if πTemp022, πE = πTemp021.Call(πF, []*πg.Object{πg.NewStr("Scanner").ToObject(), πg.NewTuple(πTemp002...).ToObject(), πTemp015.ToObject()}, nil); πE != nil {
				continue
			}
