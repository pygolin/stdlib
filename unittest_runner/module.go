...
var Code *πg.Code
func init() {
	Code = πg.NewCode("<module>", "/usr/lib/python2.7/unittest_runner.py", nil, 0, func(πF *πg.Frame, _ []*πg.Object) (*πg.Object, *πg.BaseException) {
		...
		for ; πF.State() >= 0; πF.PopCheckpoint() {
			...
			// line 1: """Running tests"""
			πF.SetLineno(1)
			if πE = πF.Globals().SetItem(πF, ß__doc__.ToObject(), πg.NewStr("Running tests").ToObject()); πE != nil {
				continue
			}
			// line 3: import sys
			πF.SetLineno(3)
			...
			_, πE = πg.NewCode("_WritelnDecorator", "/usr/lib/python2.7/unittest_runner.py", nil, 0, func(πF *πg.Frame, _ []*πg.Object) (*πg.Object, *πg.BaseException) {
				πClass := πTemp004
				_ = πClass
				var πTemp001 *πg.Object
				_ = πTemp001
				...
				for ; πF.State() >= 0; πF.PopCheckpoint() {
					...
					// line 16: """Used to decorate file-like objects with a handy 'writeln' method"""
					πF.SetLineno(16)
					if πE = πClass.SetItem(πF, ß__doc__.ToObject(), πg.NewStr("Used to decorate file-like objects with a handy 'writeln' method").ToObject()); πE != nil {
						continue
					}
					...
					πTemp001 = πg.NewFunction(πg.NewCode("__init__", "/usr/lib/python2.7/unittest_runner.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
					...
					πTemp003 = πg.NewFunction(πg.NewCode("__getattr__", "/usr/lib/python2.7/unittest_runner.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
					...
					πTemp004 = πg.NewFunction(πg.NewCode("writeln", "/usr/lib/python2.7/unittest_runner.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
					...
					πTemp005 = πg.NewFunction(πg.NewCode("write", "/usr/lib/python2.7/unittest_runner.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
						var µarg *πg.Object = πArgs[1]; _ = µarg
						var πTemp001 []*πg.Object
						_ = πTemp001
					...
					πTemp002[0] = πg.Param{Name: "self", Def: nil}
					πTemp006 = πg.NewFunction(πg.NewCode("flush", "/usr/lib/python2.7/unittest_runner.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
						var πR *πg.Object; _ = πR
						var πE *πg.BaseException; _ = πE
						for ; πF.State() >= 0; πF.PopCheckpoint() {
			...
			_, πE = πg.NewCode("TextTestResult", "/usr/lib/python2.7/unittest_runner.py", nil, 0, func(πF *πg.Frame, _ []*πg.Object) (*πg.Object, *πg.BaseException) {
				πClass := πTemp004
				_ = πClass
				var πTemp001 *πg.Object
				_ = πTemp001
				...
				for ; πF.State() >= 0; πF.PopCheckpoint() {
					...
					// line 37: """A test result class that can print formatted text results to a stream.
					πF.SetLineno(37)
					if πE = πClass.SetItem(πF, ß__doc__.ToObject(), πg.NewStr("A test result class that can print formatted text results to a stream.\n\n    Used by TextTestRunner.\n    ").ToObject()); πE != nil {
						continue
					}
					...
					πTemp003 = πg.NewFunction(πg.NewCode("getDescription", "/usr/lib/python2.7/unittest_runner.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
					...
					πTemp002[0] = πg.Param{Name: "self", Def: nil}
					πTemp002[1] = πg.Param{Name: "test", Def: nil}
					πTemp004 = πg.NewFunction(πg.NewCode("startTest", "/usr/lib/python2.7/unittest_runner.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
						var µtest *πg.Object = πArgs[1]; _ = µtest
						var πTemp001 []*πg.Object
						_ = πTemp001
					...
					πTemp002[0] = πg.Param{Name: "self", Def: nil}
					πTemp002[1] = πg.Param{Name: "test", Def: nil}
					πTemp005 = πg.NewFunction(πg.NewCode("addSuccess", "/usr/lib/python2.7/unittest_runner.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
						var µtest *πg.Object = πArgs[1]; _ = µtest
						var πTemp001 []*πg.Object
						_ = πTemp001
					...
					πTemp006 = πg.NewFunction(πg.NewCode("addError", "/usr/lib/python2.7/unittest_runner.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
						var µtest *πg.Object = πArgs[1]; _ = µtest
					...
					πTemp002[1] = πg.Param{Name: "test", Def: nil}
					πTemp002[2] = πg.Param{Name: "err", Def: nil}
					πTemp007 = πg.NewFunction(πg.NewCode("addFailure", "/usr/lib/python2.7/unittest_runner.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
						var µtest *πg.Object = πArgs[1]; _ = µtest
						var µerr *πg.Object = πArgs[2]; _ = µerr
						var πTemp001 []*πg.Object
					...
					πTemp008 = πg.NewFunction(πg.NewCode("addSkip", "/usr/lib/python2.7/unittest_runner.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
						var µtest *πg.Object = πArgs[1]; _ = µtest
					...
					πTemp002[1] = πg.Param{Name: "test", Def: nil}
					πTemp002[2] = πg.Param{Name: "err", Def: nil}
					πTemp009 = πg.NewFunction(πg.NewCode("addExpectedFailure", "/usr/lib/python2.7/unittest_runner.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
						var µtest *πg.Object = πArgs[1]; _ = µtest
						var µerr *πg.Object = πArgs[2]; _ = µerr
						var πTemp001 []*πg.Object
					...
					πTemp002[0] = πg.Param{Name: "self", Def: nil}
					πTemp002[1] = πg.Param{Name: "test", Def: nil}
					πTemp010 = πg.NewFunction(πg.NewCode("addUnexpectedSuccess", "/usr/lib/python2.7/unittest_runner.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
						var µtest *πg.Object = πArgs[1]; _ = µtest
						var πTemp001 []*πg.Object
						_ = πTemp001
					...
					πTemp002 = make([]πg.Param, 1)
					πTemp002[0] = πg.Param{Name: "self", Def: nil}
					πTemp011 = πg.NewFunction(πg.NewCode("printErrors", "/usr/lib/python2.7/unittest_runner.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
						var πTemp001 *πg.Object
						_ = πTemp001
						var πTemp002 bool
					...
					πTemp012 = πg.NewFunction(πg.NewCode("printErrorList", "/usr/lib/python2.7/unittest_runner.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
			...
			_, πE = πg.NewCode("TextTestRunner", "/usr/lib/python2.7/unittest_runner.py", nil, 0, func(πF *πg.Frame, _ []*πg.Object) (*πg.Object, *πg.BaseException) {
				πClass := πTemp004
				_ = πClass
				var πTemp001 *πg.Object
				_ = πTemp001
				...
				for ; πF.State() >= 0; πF.PopCheckpoint() {
					...
					// line 129: """A test runner class that displays results in textual form.
					πF.SetLineno(129)
					if πE = πClass.SetItem(πF, ß__doc__.ToObject(), πg.NewStr("A test runner class that displays results in textual form.\n\n    It prints out the names of tests as they are run, errors as they\n    occur, and a summary of the results at the end of the test run.\n    ").ToObject()); πE != nil {
						continue
					}
					...
					πTemp002 = make([]πg.Param, 1)
					πTemp002[0] = πg.Param{Name: "self", Def: nil}
					πTemp003 = πg.NewFunction(πg.NewCode("_makeResult", "/usr/lib/python2.7/unittest_runner.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
						var πTemp001 []*πg.Object
						_ = πTemp001
						var πTemp002 *πg.Object
					...
					πTemp002[0] = πg.Param{Name: "self", Def: nil}
					πTemp002[1] = πg.Param{Name: "test", Def: nil}
					πTemp004 = πg.NewFunction(πg.NewCode("run", "/usr/lib/python2.7/unittest_runner.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
						var µtest *πg.Object = πArgs[1]; _ = µtest
					...
					// line 150: "Run the given test case or test suite."
					πF.SetLineno(150)
					if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp005}, πg.NewStr("Run the given test case or test suite.").ToObject()); πE != nil {
						continue
					}
