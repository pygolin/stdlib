...
var Code *πg.Code
func init() {
	Code = πg.NewCode("<module>", "/usr/lib/python2.7/heapq.py", nil, 0, func(πF *πg.Frame, _ []*πg.Object) (*πg.Object, *πg.BaseException) {
		...
		for ; πF.State() >= 0; πF.PopCheckpoint() {
			...
			πTemp002 = πg.NewFunction(πg.NewCode("cmp_lt", "/usr/lib/python2.7/heapq.py", πTemp004, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
			...
			πTemp003 = πg.NewFunction(πg.NewCode("heappush", "/usr/lib/python2.7/heapq.py", πTemp004, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
			...
			// line 148: """Push item onto heap, maintaining the heap invariant."""
			πF.SetLineno(148)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp005}, πg.NewStr("Push item onto heap, maintaining the heap invariant.").ToObject()); πE != nil {
				continue
			}
			if πTemp006, πE = πg.ResolveGlobal(πF, ßheappush); πE != nil {
				continue
			}
			...
			πTemp004[0] = πg.Param{Name: "heap", Def: nil}
			πTemp005 = πg.NewFunction(πg.NewCode("heappop", "/usr/lib/python2.7/heapq.py", πTemp004, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µheap *πg.Object = πArgs[0]; _ = µheap
			...
			// line 153: """Pop the smallest item off the heap, maintaining the heap invariant."""
			πF.SetLineno(153)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp006}, πg.NewStr("Pop the smallest item off the heap, maintaining the heap invariant.").ToObject()); πE != nil {
				continue
			}
			if πTemp007, πE = πg.ResolveGlobal(πF, ßheappop); πE != nil {
				continue
			}
			...
			πTemp004[0] = πg.Param{Name: "heap", Def: nil}
			πTemp004[1] = πg.Param{Name: "item", Def: nil}
			πTemp006 = πg.NewFunction(πg.NewCode("heapreplace", "/usr/lib/python2.7/heapq.py", πTemp004, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µheap *πg.Object = πArgs[0]; _ = µheap
				var µitem *πg.Object = πArgs[1]; _ = µitem
				var µreturnitem *πg.Object = πg.UnboundLocal; _ = µreturnitem
				var πTemp001 *πg.Object
			...
			// line 164: """Pop and return the current smallest value, and add the new item.
			πF.SetLineno(164)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp007}, πg.NewStr("Pop and return the current smallest value, and add the new item.\n\n    This is more efficient than heappop() followed by heappush(), and can be\n    more appropriate when using a fixed-size heap.  Note that the value\n    returned may be larger than item!  That constrains reasonable uses of\n    this routine unless written as part of a conditional replacement:\n\n        if item > heap[0]:\n            item = heapreplace(heap, item)\n    ").ToObject()); πE != nil {
				continue
			}
			if πTemp008, πE = πg.ResolveGlobal(πF, ßheapreplace); πE != nil {
				continue
			}
			...
			πTemp004[0] = πg.Param{Name: "heap", Def: nil}
			πTemp004[1] = πg.Param{Name: "item", Def: nil}
			πTemp007 = πg.NewFunction(πg.NewCode("heappushpop", "/usr/lib/python2.7/heapq.py", πTemp004, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µheap *πg.Object = πArgs[0]; _ = µheap
				var µitem *πg.Object = πArgs[1]; _ = µitem
				var πTemp001 *πg.Object
				_ = πTemp001
			...
			// line 180: """Fast version of a heappush followed by a heappop."""
			πF.SetLineno(180)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp008}, πg.NewStr("Fast version of a heappush followed by a heappop.").ToObject()); πE != nil {
				continue
			}
			if πTemp009, πE = πg.ResolveGlobal(πF, ßheappushpop); πE != nil {
				continue
			}
			...
			πTemp004 = make([]πg.Param, 1)
			πTemp004[0] = πg.Param{Name: "x", Def: nil}
			πTemp008 = πg.NewFunction(πg.NewCode("heapify", "/usr/lib/python2.7/heapq.py", πTemp004, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µx *πg.Object = πArgs[0]; _ = µx
			...
			// line 187: """Transform list into a heap, in-place, in O(len(x)) time."""
			πF.SetLineno(187)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp009}, πg.NewStr("Transform list into a heap, in-place, in O(len(x)) time.").ToObject()); πE != nil {
				continue
			}
			if πTemp010, πE = πg.ResolveGlobal(πF, ßheapify); πE != nil {
				continue
			}
			...
			πTemp004[0] = πg.Param{Name: "heap", Def: nil}
			πTemp004[1] = πg.Param{Name: "item", Def: nil}
			πTemp009 = πg.NewFunction(πg.NewCode("_heappushpop_max", "/usr/lib/python2.7/heapq.py", πTemp004, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µheap *πg.Object = πArgs[0]; _ = µheap
				var µitem *πg.Object = πArgs[1]; _ = µitem
				var πTemp001 *πg.Object
				_ = πTemp001
			...
			// line 198: """Maxheap version of a heappush followed by a heappop."""
			πF.SetLineno(198)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp010}, πg.NewStr("Maxheap version of a heappush followed by a heappop.").ToObject()); πE != nil {
				continue
			}
			if πTemp011, πE = πg.ResolveGlobal(πF, ß_heappushpop_max); πE != nil {
				continue
			}
			...
			πTemp004 = make([]πg.Param, 1)
			πTemp004[0] = πg.Param{Name: "x", Def: nil}
			πTemp010 = πg.NewFunction(πg.NewCode("_heapify_max", "/usr/lib/python2.7/heapq.py", πTemp004, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µx *πg.Object = πArgs[0]; _ = µx
				var µn *πg.Object = πg.UnboundLocal; _ = µn
				var µi *πg.Object = πg.UnboundLocal; _ = µi
				var πTemp001 []*πg.Object
			...
			// line 205: """Transform list into a maxheap, in-place, in O(len(x)) time."""
			πF.SetLineno(205)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp011}, πg.NewStr("Transform list into a maxheap, in-place, in O(len(x)) time.").ToObject()); πE != nil {
				continue
			}
			if πTemp012, πE = πg.ResolveGlobal(πF, ß_heapify_max); πE != nil {
				continue
			}
			...
			πTemp011 = πg.NewFunction(πg.NewCode("nlargest", "/usr/lib/python2.7/heapq.py", πTemp004, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
			...
			// line 211: """Find the n largest elements in a dataset.
			πF.SetLineno(211)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp012}, πg.NewStr("Find the n largest elements in a dataset.\n\n    Equivalent to:  sorted(iterable, reverse=True)[:n]\n    ").ToObject()); πE != nil {
				continue
			}
			if πTemp013, πE = πg.ResolveGlobal(πF, ßnlargest); πE != nil {
				continue
			}
			...
			πTemp004[0] = πg.Param{Name: "n", Def: nil}
			πTemp004[1] = πg.Param{Name: "iterable", Def: nil}
			πTemp012 = πg.NewFunction(πg.NewCode("nsmallest", "/usr/lib/python2.7/heapq.py", πTemp004, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µn *πg.Object = πArgs[0]; _ = µn
				var µiterable *πg.Object = πArgs[1]; _ = µiterable
				var µit *πg.Object = πg.UnboundLocal; _ = µit
				var µresult *πg.Object = πg.UnboundLocal; _ = µresult
			...
			// line 229: """Find the n smallest elements in a dataset.
			πF.SetLineno(229)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp013}, πg.NewStr("Find the n smallest elements in a dataset.\n\n    Equivalent to:  sorted(iterable)[:n]\n    ").ToObject()); πE != nil {
				continue
			}
			if πTemp014, πE = πg.ResolveGlobal(πF, ßnsmallest); πE != nil {
				continue
			}
			...
			πTemp013 = πg.NewFunction(πg.NewCode("_siftdown", "/usr/lib/python2.7/heapq.py", πTemp004, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µheap *πg.Object = πArgs[0]; _ = µheap
			...
			πTemp014 = πg.NewFunction(πg.NewCode("_siftup", "/usr/lib/python2.7/heapq.py", πTemp004, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µheap *πg.Object = πArgs[0]; _ = µheap
			...
			πTemp004[1] = πg.Param{Name: "startpos", Def: nil}
			πTemp004[2] = πg.Param{Name: "pos", Def: nil}
			πTemp015 = πg.NewFunction(πg.NewCode("_siftdown_max", "/usr/lib/python2.7/heapq.py", πTemp004, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µheap *πg.Object = πArgs[0]; _ = µheap
				var µstartpos *πg.Object = πArgs[1]; _ = µstartpos
				var µpos *πg.Object = πArgs[2]; _ = µpos
				var µnewitem *πg.Object = πg.UnboundLocal; _ = µnewitem
			...
			// line 323: 'Maxheap variant of _siftdown'
			πF.SetLineno(323)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp016}, πg.NewStr("Maxheap variant of _siftdown").ToObject()); πE != nil {
				continue
			}
			if πTemp017, πE = πg.ResolveGlobal(πF, ß_siftdown_max); πE != nil {
				continue
			}
			...
			πTemp004[0] = πg.Param{Name: "heap", Def: nil}
			πTemp004[1] = πg.Param{Name: "pos", Def: nil}
			πTemp016 = πg.NewFunction(πg.NewCode("_siftup_max", "/usr/lib/python2.7/heapq.py", πTemp004, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µheap *πg.Object = πArgs[0]; _ = µheap
				var µpos *πg.Object = πArgs[1]; _ = µpos
				var µendpos *πg.Object = πg.UnboundLocal; _ = µendpos
				var µstartpos *πg.Object = πg.UnboundLocal; _ = µstartpos
			...
			// line 338: 'Maxheap variant of _siftup'
			πF.SetLineno(338)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp017}, πg.NewStr("Maxheap variant of _siftup").ToObject()); πE != nil {
				continue
			}
			if πTemp018, πE = πg.ResolveGlobal(πF, ß_siftup_max); πE != nil {
				continue
			}
			...
			πTemp017 = πg.NewFunction(πg.NewCode("merge", "/usr/lib/python2.7/heapq.py", πTemp004, πg.CodeFlagVarArg, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
			...
			// line 365: '''Merge multiple sorted inputs into a single sorted output.
			πF.SetLineno(365)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp018}, πg.NewStr("Merge multiple sorted inputs into a single sorted output.\n\n    Similar to sorted(itertools.chain(*iterables)) but returns a generator,\n    does not pull the data into memory all at once, and assumes that each of\n    the input streams is already sorted (smallest to largest).\n\n    >>> list(merge([1,3,5,7], [0,2,4,8], [5,10,15,20], [], [25]))\n    [0, 1, 2, 3, 4, 5, 5, 7, 8, 10, 15, 20, 25]\n\n    ").ToObject()); πE != nil {
				continue
			}
			if πTemp019, πE = πg.ResolveGlobal(πF, ßmerge); πE != nil {
				continue
			}
			...
			πTemp018 = πg.NewFunction(πg.NewCode("nsmallest", "/usr/lib/python2.7/heapq.py", πTemp004, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µn *πg.Object = πArgs[0]; _ = µn
				var µiterable *πg.Object = πArgs[1]; _ = µiterable
			...
			// line 407: """Find the n smallest elements in a dataset.
			πF.SetLineno(407)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp019}, πg.NewStr("Find the n smallest elements in a dataset.\n\n    Equivalent to:  sorted(iterable, key=key)[:n]\n    ").ToObject()); πE != nil {
				continue
			}
			if πTemp020, πE = πg.ResolveGlobal(πF, ßnsmallest); πE != nil {
				continue
			}
			...
			πTemp019 = πg.NewFunction(πg.NewCode("nlargest", "/usr/lib/python2.7/heapq.py", πTemp004, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µn *πg.Object = πArgs[0]; _ = µn
				var µiterable *πg.Object = πArgs[1]; _ = µiterable
				var µkey *πg.Object = πArgs[2]; _ = µkey
				var µit *πg.Object = πg.UnboundLocal; _ = µit
			...
			// line 444: """Find the n largest elements in a dataset.
			πF.SetLineno(444)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp020}, πg.NewStr("Find the n largest elements in a dataset.\n\n    Equivalent to:  sorted(iterable, key=key, reverse=True)[:n]\n    ").ToObject()); πE != nil {
				continue
			}
			if πTemp021, πE = πg.ResolveGlobal(πF, ßnlargest); πE != nil {
				continue
			}
