...
var Code *πg.Code
func init() {
	Code = πg.NewCode("<module>", "/usr/lib/python2.7/unittest_signals.py", nil, 0, func(πF *πg.Frame, _ []*πg.Object) (*πg.Object, *πg.BaseException) {
		...
		for ; πF.State() >= 0; πF.PopCheckpoint() {
			...
			_, πE = πg.NewCode("_InterruptHandler", "/usr/lib/python2.7/unittest_signals.py", nil, 0, func(πF *πg.Frame, _ []*πg.Object) (*πg.Object, *πg.BaseException) {
				πClass := πTemp004
				_ = πClass
				for ; πF.State() >= 0; πF.PopCheckpoint() {
					switch πF.State() {
			...
			πTemp001 = πg.NewFunction(πg.NewCode("registerResult", "/usr/lib/python2.7/unittest_signals.py", πTemp006, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
			...
			πTemp006 = make([]πg.Param, 1)
			πTemp006[0] = πg.Param{Name: "result", Def: nil}
			πTemp003 = πg.NewFunction(πg.NewCode("removeResult", "/usr/lib/python2.7/unittest_signals.py", πTemp006, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µresult *πg.Object = πArgs[0]; _ = µresult
				var πTemp001 []*πg.Object
				_ = πTemp001
				var πTemp002 []*πg.Object
			...
			πTemp005 = πg.NewFunction(πg.NewCode("installHandler", "/usr/lib/python2.7/unittest_signals.py", πTemp006, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var πR *πg.Object; _ = πR
				var πE *πg.BaseException; _ = πE
				for ; πF.State() >= 0; πF.PopCheckpoint() {
					switch πF.State() {
			...
			πTemp007 = πg.NewFunction(πg.NewCode("removeHandler", "/usr/lib/python2.7/unittest_signals.py", πTemp006, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
