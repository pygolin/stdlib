...
var Code *πg.Code
func init() {
	Code = πg.NewCode("<module>", "/usr/lib/python2.7/_sha.py", nil, 0, func(πF *πg.Frame, _ []*πg.Object) (*πg.Object, *πg.BaseException) {
		...
		for ; πF.State() >= 0; πF.PopCheckpoint() {
			...
			// line 7: """A sample implementation of SHA-1 in pure Python.
			πF.SetLineno(7)
			if πE = πF.Globals().SetItem(πF, ß__doc__.ToObject(), πg.NewStr("A sample implementation of SHA-1 in pure Python.\n\n   Framework adapted from Dinu Gherman's MD5 implementation by\n   J. Hall\xef\xbf\xbdn and L. Creighton. SHA-1 implementation based directly on\n   the text of the NIST standard FIPS PUB 180-1.\n").ToObject()); πE != nil {
				continue
			}
			...
			πTemp001 = πg.NewFunction(πg.NewCode("_long2bytesBigEndian", "/usr/lib/python2.7/_sha.py", πTemp003, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
			...
			// line 31: """Convert a long integer to a byte string.
			πF.SetLineno(31)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp004}, πg.NewStr("Convert a long integer to a byte string.\n\n    If optional blocksize is given and greater than zero, pad the front\n    of the byte string with binary zeros so that the length is a multiple\n    of blocksize.\n    ").ToObject()); πE != nil {
				continue
			}
			...
			πTemp004 = πg.NewFunction(πg.NewCode("_bytelist2longBigEndian", "/usr/lib/python2.7/_sha.py", πTemp003, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
			...
			// line 65: "Transform a list of characters into a list of longs."
			πF.SetLineno(65)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp005}, πg.NewStr("Transform a list of characters into a list of longs.").ToObject()); πE != nil {
				continue
			}
			if πTemp006, πE = πg.ResolveGlobal(πF, ß_bytelist2longBigEndian); πE != nil {
				continue
			}
			...
			πTemp005 = πg.NewFunction(πg.NewCode("_rotateLeft", "/usr/lib/python2.7/_sha.py", πTemp003, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
			...
			// line 85: "Rotate x (32 bit) left n bits circularly."
			πF.SetLineno(85)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp006}, πg.NewStr("Rotate x (32 bit) left n bits circularly.").ToObject()); πE != nil {
				continue
			}
			if πTemp007, πE = πg.ResolveGlobal(πF, ß_rotateLeft); πE != nil {
				continue
			}
			...
			πTemp006 = πg.NewFunction(πg.NewCode("f0_19", "/usr/lib/python2.7/_sha.py", πTemp003, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
			...
			πTemp003[1] = πg.Param{Name: "C", Def: nil}
			πTemp003[2] = πg.Param{Name: "D", Def: nil}
			πTemp007 = πg.NewFunction(πg.NewCode("f20_39", "/usr/lib/python2.7/_sha.py", πTemp003, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µB *πg.Object = πArgs[0]; _ = µB
				var µC *πg.Object = πArgs[1]; _ = µC
				var µD *πg.Object = πArgs[2]; _ = µD
				var πTemp001 *πg.Object
			...
			πTemp003[1] = πg.Param{Name: "C", Def: nil}
			πTemp003[2] = πg.Param{Name: "D", Def: nil}
			πTemp008 = πg.NewFunction(πg.NewCode("f40_59", "/usr/lib/python2.7/_sha.py", πTemp003, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µB *πg.Object = πArgs[0]; _ = µB
				var µC *πg.Object = πArgs[1]; _ = µC
				var µD *πg.Object = πArgs[2]; _ = µD
				var πTemp001 *πg.Object
			...
			πTemp003[1] = πg.Param{Name: "C", Def: nil}
			πTemp003[2] = πg.Param{Name: "D", Def: nil}
			πTemp009 = πg.NewFunction(πg.NewCode("f60_79", "/usr/lib/python2.7/_sha.py", πTemp003, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µB *πg.Object = πArgs[0]; _ = µB
				var µC *πg.Object = πArgs[1]; _ = µC
				var µD *πg.Object = πArgs[2]; _ = µD
				var πTemp001 *πg.Object
			...
			_, πE = πg.NewCode("sha", "/usr/lib/python2.7/_sha.py", nil, 0, func(πF *πg.Frame, _ []*πg.Object) (*πg.Object, *πg.BaseException) {
				πClass := πTemp011
				_ = πClass
				var πTemp001 *πg.Object
				_ = πTemp001
				...
				for ; πF.State() >= 0; πF.PopCheckpoint() {
					...
					// line 119: "An implementation of the SHA hash function in pure Python."
					πF.SetLineno(119)
					if πE = πClass.SetItem(πF, ß__doc__.ToObject(), πg.NewStr("An implementation of the SHA hash function in pure Python.").ToObject()); πE != nil {
						continue
					}
					...
					πTemp001 = πg.NewFunction(πg.NewCode("__init__", "/usr/lib/python2.7/_sha.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
					...
					πTemp002 = make([]πg.Param, 1)
					πTemp002[0] = πg.Param{Name: "self", Def: nil}
					πTemp003 = πg.NewFunction(πg.NewCode("init", "/usr/lib/python2.7/_sha.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
						var πTemp001 *πg.Object
						_ = πTemp001
						var πTemp002 []*πg.Object
					...
					// line 140: "Initialize the message-digest and set all fields to zero."
					πF.SetLineno(140)
					if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp004}, πg.NewStr("Initialize the message-digest and set all fields to zero.").ToObject()); πE != nil {
						continue
					}
					...
					πTemp004 = πg.NewFunction(πg.NewCode("_transform", "/usr/lib/python2.7/_sha.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
					...
					πTemp005 = πg.NewFunction(πg.NewCode("update", "/usr/lib/python2.7/_sha.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
					...
					πTemp002 = make([]πg.Param, 1)
					πTemp002[0] = πg.Param{Name: "self", Def: nil}
					πTemp006 = πg.NewFunction(πg.NewCode("digest", "/usr/lib/python2.7/_sha.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
					...
					πTemp002 = make([]πg.Param, 1)
					πTemp002[0] = πg.Param{Name: "self", Def: nil}
					πTemp007 = πg.NewFunction(πg.NewCode("hexdigest", "/usr/lib/python2.7/_sha.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
						var πTemp001 []*πg.Object
						_ = πTemp001
						var πTemp002 *πg.Object
						...
						for ; πF.State() >= 0; πF.PopCheckpoint() {
							...
							πTemp003 = πg.NewFunction(πg.NewCode("<generator>", "/usr/lib/python2.7/_sha.py", πTemp004, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
								var µc *πg.Object = πg.UnboundLocal; _ = µc
								var πTemp001 *πg.Object
								_ = πTemp001
								var πTemp002 *πg.Object
					...
					πTemp002 = make([]πg.Param, 1)
					πTemp002[0] = πg.Param{Name: "self", Def: nil}
					πTemp008 = πg.NewFunction(πg.NewCode("copy", "/usr/lib/python2.7/_sha.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
						var πTemp001 []*πg.Object
						_ = πTemp001
						var πTemp002 *πg.Object
			...
			πTemp010 = πg.NewFunction(πg.NewCode("new", "/usr/lib/python2.7/_sha.py", πTemp003, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
			...
			// line 344: """Return a new sha crypto object.
			πF.SetLineno(344)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp012}, πg.NewStr("Return a new sha crypto object.\n\n    If arg is present, the method call update(arg) is made.\n    ").ToObject()); πE != nil {
				continue
			}
