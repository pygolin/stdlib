...
var Code *πg.Code
func init() {
	Code = πg.NewCode("<module>", "/usr/lib/python2.7/getopt.py", nil, 0, func(πF *πg.Frame, _ []*πg.Object) (*πg.Object, *πg.BaseException) {
		...
		for ; πF.State() >= 0; πF.PopCheckpoint() {
			...
			_, πE = πg.NewCode("GetoptError", "/usr/lib/python2.7/getopt.py", nil, 0, func(πF *πg.Frame, _ []*πg.Object) (*πg.Object, *πg.BaseException) {
				πClass := πTemp003
				_ = πClass
				var πTemp001 *πg.Object
				_ = πTemp001
				...
				for ; πF.State() >= 0; πF.PopCheckpoint() {
					...
					πTemp001 = πg.NewFunction(πg.NewCode("__init__", "/usr/lib/python2.7/getopt.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
					...
					πTemp002[0] = πg.Param{Name: "self", Def: nil}
					πTemp003 = πg.NewFunction(πg.NewCode("__str__", "/usr/lib/python2.7/getopt.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
						var πTemp001 *πg.Object
						_ = πTemp001
						var πR *πg.Object; _ = πR
			...
			πTemp002 = πg.NewFunction(πg.NewCode("getopt", "/usr/lib/python2.7/getopt.py", πTemp006, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
			...
			πTemp004 = πg.NewFunction(πg.NewCode("gnu_getopt", "/usr/lib/python2.7/getopt.py", πTemp006, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µargs *πg.Object = πArgs[0]; _ = µargs
				var µshortopts *πg.Object = πArgs[1]; _ = µshortopts
				var µlongopts *πg.Object = πArgs[2]; _ = µlongopts
				var µopts *πg.Object = πg.UnboundLocal; _ = µopts
			...
			// line 95: """getopt(args, options[, long_options]) -> opts, args
			πF.SetLineno(95)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp005}, πg.NewStr("getopt(args, options[, long_options]) -> opts, args\n\n    This function works like getopt(), except that GNU style scanning\n    mode is used by default. This means that option and non-option\n    arguments may be intermixed. The getopt() function stops\n    processing options as soon as a non-option argument is\n    encountered.\n\n    If the first character of the option string is `+', or if the\n    environment variable POSIXLY_CORRECT is set, then option\n    processing stops as soon as a non-option argument is encountered.\n\n    ").ToObject()); πE != nil {
				continue
			}
			if πTemp007, πE = πg.ResolveGlobal(πF, ßgnu_getopt); πE != nil {
				continue
			}
			...
			πTemp005 = πg.NewFunction(πg.NewCode("do_longs", "/usr/lib/python2.7/getopt.py", πTemp006, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
			...
			πTemp007 = πg.NewFunction(πg.NewCode("long_has_args", "/usr/lib/python2.7/getopt.py", πTemp006, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				...
				for ; πF.State() >= 0; πF.PopCheckpoint() {
					...
					πTemp002 = πg.NewFunction(πg.NewCode("<generator>", "/usr/lib/python2.7/getopt.py", πTemp003, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
			...
			πTemp006[3] = πg.Param{Name: "args", Def: nil}
			πTemp008 = πg.NewFunction(πg.NewCode("do_shorts", "/usr/lib/python2.7/getopt.py", πTemp006, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µopts *πg.Object = πArgs[0]; _ = µopts
			...
			πTemp006[0] = πg.Param{Name: "opt", Def: nil}
			πTemp006[1] = πg.Param{Name: "shortopts", Def: nil}
			πTemp009 = πg.NewFunction(πg.NewCode("short_has_arg", "/usr/lib/python2.7/getopt.py", πTemp006, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µopt *πg.Object = πArgs[0]; _ = µopt
				var µshortopts *πg.Object = πArgs[1]; _ = µshortopts
				var µi *πg.Object = πg.UnboundLocal; _ = µi
				var πTemp001 *πg.Object
