...
var Code *πg.Code
func init() {
	Code = πg.NewCode("<module>", "/usr/lib/python2.7/functools.py", nil, 0, func(πF *πg.Frame, _ []*πg.Object) (*πg.Object, *πg.BaseException) {
		...
		for ; πF.State() >= 0; πF.PopCheckpoint() {
			...
			// line 1: """functools.py - Tools for working with functions and callable objects
			πF.SetLineno(1)
			if πE = πF.Globals().SetItem(πF, ß__doc__.ToObject(), πg.NewStr("functools.py - Tools for working with functions and callable objects\n").ToObject()); πE != nil {
				continue
			}
			...
			πTemp001 = πg.NewFunction(πg.NewCode("setattr", "/usr/lib/python2.7/functools.py", πTemp004, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
			...
			πTemp003 = πg.NewFunction(πg.NewCode("update_wrapper", "/usr/lib/python2.7/functools.py", πTemp004, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
			...
			// line 27: """Update a wrapper function to look like the wrapped function
			πF.SetLineno(27)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp005}, πg.NewStr("Update a wrapper function to look like the wrapped function\n\n       wrapper is the function to be updated\n       wrapped is the original function\n       assigned is a tuple naming the attributes assigned directly\n       from the wrapped function to the wrapper function (defaults to\n       functools.WRAPPER_ASSIGNMENTS)\n       updated is a tuple naming the attributes of the wrapper that\n       are updated with the corresponding attribute from the wrapped\n       function (defaults to functools.WRAPPER_UPDATES)\n    ").ToObject()); πE != nil {
				continue
			}
			if πTemp006, πE = πg.ResolveGlobal(πF, ßupdate_wrapper); πE != nil {
				continue
			}
			...
			πTemp005 = πg.NewFunction(πg.NewCode("wraps", "/usr/lib/python2.7/functools.py", πTemp004, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
			...
			// line 48: """Decorator factory to apply update_wrapper() to a wrapper function
			πF.SetLineno(48)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp006}, πg.NewStr("Decorator factory to apply update_wrapper() to a wrapper function\n\n       Returns a decorator that invokes update_wrapper() with the decorated\n       function as the wrapper argument and the arguments to wraps() as the\n       remaining arguments. Default arguments are as for update_wrapper().\n       This is a convenience function to simplify applying partial() to\n       update_wrapper().\n    ").ToObject()); πE != nil {
				continue
			}
			if πTemp007, πE = πg.ResolveGlobal(πF, ßwraps); πE != nil {
				continue
			}
			...
			πTemp006 = πg.NewFunction(πg.NewCode("total_ordering", "/usr/lib/python2.7/functools.py", πTemp004, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				...
				for ; πF.State() >= 0; πF.PopCheckpoint() {
					...
					πTemp004 = πg.NewFunction(πg.NewCode("<lambda>", "/usr/lib/python2.7/functools.py", πTemp005, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
			...
			// line 60: """Class decorator that fills in missing ordering methods"""
			πF.SetLineno(60)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp007}, πg.NewStr("Class decorator that fills in missing ordering methods").ToObject()); πE != nil {
				continue
			}
			if πTemp008, πE = πg.ResolveGlobal(πF, ßtotal_ordering); πE != nil {
				continue
			}
			...
			πTemp007 = πg.NewFunction(πg.NewCode("cmp_to_key", "/usr/lib/python2.7/functools.py", πTemp004, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				...
				for ; πF.State() >= 0; πF.PopCheckpoint() {
					...
					_, πE = πg.NewCode("K", "/usr/lib/python2.7/functools.py", nil, 0, func(πF *πg.Frame, _ []*πg.Object) (*πg.Object, *πg.BaseException) {
						πClass := πTemp001
						_ = πClass
						var πTemp001 []*πg.Object
						_ = πTemp001
						...
						for ; πF.State() >= 0; πF.PopCheckpoint() {
							...
							πTemp002 = πg.NewFunction(πg.NewCode("__init__", "/usr/lib/python2.7/functools.py", πTemp003, πg.CodeFlagVarArg, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
								var µself *πg.Object = πArgs[0]; _ = µself
							...
							πTemp004 = πg.NewFunction(πg.NewCode("__lt__", "/usr/lib/python2.7/functools.py", πTemp003, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
								var µself *πg.Object = πArgs[0]; _ = µself
								var µother *πg.Object = πArgs[1]; _ = µother
								var πTemp001 *πg.Object
								_ = πTemp001
							...
							πTemp003[0] = πg.Param{Name: "self", Def: nil}
							πTemp003[1] = πg.Param{Name: "other", Def: nil}
							πTemp005 = πg.NewFunction(πg.NewCode("__gt__", "/usr/lib/python2.7/functools.py", πTemp003, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
								var µself *πg.Object = πArgs[0]; _ = µself
								var µother *πg.Object = πArgs[1]; _ = µother
								var πTemp001 *πg.Object
								_ = πTemp001
							...
							πTemp003[0] = πg.Param{Name: "self", Def: nil}
							πTemp003[1] = πg.Param{Name: "other", Def: nil}
							πTemp006 = πg.NewFunction(πg.NewCode("__eq__", "/usr/lib/python2.7/functools.py", πTemp003, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
								var µself *πg.Object = πArgs[0]; _ = µself
								var µother *πg.Object = πArgs[1]; _ = µother
								var πTemp001 *πg.Object
								_ = πTemp001
							...
							πTemp003[0] = πg.Param{Name: "self", Def: nil}
							πTemp003[1] = πg.Param{Name: "other", Def: nil}
							πTemp007 = πg.NewFunction(πg.NewCode("__le__", "/usr/lib/python2.7/functools.py", πTemp003, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
								var µself *πg.Object = πArgs[0]; _ = µself
								var µother *πg.Object = πArgs[1]; _ = µother
								var πTemp001 *πg.Object
								_ = πTemp001
							...
							πTemp003[0] = πg.Param{Name: "self", Def: nil}
							πTemp003[1] = πg.Param{Name: "other", Def: nil}
							πTemp008 = πg.NewFunction(πg.NewCode("__ge__", "/usr/lib/python2.7/functools.py", πTemp003, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
								var µself *πg.Object = πArgs[0]; _ = µself
								var µother *πg.Object = πArgs[1]; _ = µother
								var πTemp001 *πg.Object
								_ = πTemp001
							...
							πTemp003[0] = πg.Param{Name: "self", Def: nil}
							πTemp003[1] = πg.Param{Name: "other", Def: nil}
							πTemp009 = πg.NewFunction(πg.NewCode("__ne__", "/usr/lib/python2.7/functools.py", πTemp003, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
								var µself *πg.Object = πArgs[0]; _ = µself
								var µother *πg.Object = πArgs[1]; _ = µother
								var πTemp001 *πg.Object
								_ = πTemp001
							...
							πTemp003[0] = πg.Param{Name: "self", Def: nil}
							πTemp010 = πg.NewFunction(πg.NewCode("__hash__", "/usr/lib/python2.7/functools.py", πTemp003, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
								var µself *πg.Object = πArgs[0]; _ = µself
								var πTemp001 []*πg.Object
								_ = πTemp001
								var πTemp002 *πg.Object
			...
			// line 87: """Convert a cmp= function into a key= function"""
			πF.SetLineno(87)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp008}, πg.NewStr("Convert a cmp= function into a key= function").ToObject()); πE != nil {
				continue
			}
			if πTemp009, πE = πg.ResolveGlobal(πF, ßcmp_to_key); πE != nil {
				continue
			}
