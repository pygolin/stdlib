...
var Code *πg.Code
func init() {
	Code = πg.NewCode("<module>", "/usr/lib/python2.7/keyword.py", nil, 0, func(πF *πg.Frame, _ []*πg.Object) (*πg.Object, *πg.BaseException) {
		...
		for ; πF.State() >= 0; πF.PopCheckpoint() {
			...
			// line 3: """Keywords (from "graminit.c")
			πF.SetLineno(3)
			if πE = πF.Globals().SetItem(πF, ß__doc__.ToObject(), πg.NewStr("Keywords (from \"graminit.c\")\n\nThis file is automatically generated; please don't muck it up!\n\nTo update the symbols in this file, 'cd' to the top directory of\nthe python source tree after building the interpreter and run:\n\n    ./python Lib/keyword.py\n").ToObject()); πE != nil {
				continue
			}
			...
			πTemp002 = πg.NewFunction(πg.NewCode("main", "/usr/lib/python2.7/keyword.py", πTemp004, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
