...
var Code *πg.Code
func init() {
	Code = πg.NewCode("<module>", "/usr/lib/python2.7/unittest_loader.py", nil, 0, func(πF *πg.Frame, _ []*πg.Object) (*πg.Object, *πg.BaseException) {
		...
		for ; πF.State() >= 0; πF.PopCheckpoint() {
			...
			// line 1: """Loading unittests."""
			πF.SetLineno(1)
			if πE = πF.Globals().SetItem(πF, ß__doc__.ToObject(), πg.NewStr("Loading unittests.").ToObject()); πE != nil {
				continue
			}
			// line 3: import os
			πF.SetLineno(3)
			...
			πTemp001 = πg.NewFunction(πg.NewCode("_make_failed_import_test", "/usr/lib/python2.7/unittest_loader.py", πTemp004, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
			...
			πTemp003 = πg.NewFunction(πg.NewCode("_make_failed_load_tests", "/usr/lib/python2.7/unittest_loader.py", πTemp004, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µname *πg.Object = πArgs[0]; _ = µname
			...
			πTemp005 = πg.NewFunction(πg.NewCode("_make_failed_test", "/usr/lib/python2.7/unittest_loader.py", πTemp004, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				...
				for ; πF.State() >= 0; πF.PopCheckpoint() {
					...
					πTemp001 = πg.NewFunction(πg.NewCode("testFailure", "/usr/lib/python2.7/unittest_loader.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
			...
			_, πE = πg.NewCode("TestLoader", "/usr/lib/python2.7/unittest_loader.py", nil, 0, func(πF *πg.Frame, _ []*πg.Object) (*πg.Object, *πg.BaseException) {
				πClass := πTemp006
				_ = πClass
				var πTemp001 *πg.Object
				_ = πTemp001
				...
				for ; πF.State() >= 0; πF.PopCheckpoint() {
					...
					πTemp001 = πg.NewFunction(πg.NewCode("loadTestsFromTestCase", "/usr/lib/python2.7/unittest_loader.py", πTemp003, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
					...
					// line 55: """Return a suite of all tests cases contained in testCaseClass"""
					πF.SetLineno(55)
					if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp002}, πg.NewStr("Return a suite of all tests cases contained in testCaseClass").ToObject()); πE != nil {
						continue
					}
					if πTemp004, πE = πg.ResolveClass(πF, πClass, nil, ßloadTestsFromTestCase); πE != nil {
						continue
					}
					...
					πTemp002 = πg.NewFunction(πg.NewCode("loadTestsFromModule", "/usr/lib/python2.7/unittest_loader.py", πTemp003, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
					...
					// line 66: """Return a suite of all tests cases contained in the given module"""
					πF.SetLineno(66)
					if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp004}, πg.NewStr("Return a suite of all tests cases contained in the given module").ToObject()); πE != nil {
						continue
					}
					if πTemp005, πE = πg.ResolveClass(πF, πClass, nil, ßloadTestsFromModule); πE != nil {
						continue
					}
					...
					πTemp004 = πg.NewFunction(πg.NewCode("loadTestsFromName", "/usr/lib/python2.7/unittest_loader.py", πTemp003, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
					...
					// line 84: """Return a suite of all tests cases given a string specifier.
					πF.SetLineno(84)
					if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp005}, πg.NewStr("Return a suite of all tests cases given a string specifier.\n\n        The name may resolve either to a module, a test case class, a\n        test method within a test case class, or a callable object which\n        returns a TestCase or TestSuite instance.\n\n        The method optionally resolves the names relative to a given module.\n        ").ToObject()); πE != nil {
						continue
					}
					if πTemp006, πE = πg.ResolveClass(πF, πClass, nil, ßloadTestsFromName); πE != nil {
						continue
					}
					...
					πTemp005 = πg.NewFunction(πg.NewCode("loadTestsFromNames", "/usr/lib/python2.7/unittest_loader.py", πTemp003, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
						...
						for ; πF.State() >= 0; πF.PopCheckpoint() {
							...
							πTemp002 = πg.NewFunction(πg.NewCode("<generator>", "/usr/lib/python2.7/unittest_loader.py", πTemp003, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
								var µname *πg.Object = πg.UnboundLocal; _ = µname
								var πTemp001 *πg.Object
								_ = πTemp001
								var πTemp002 bool
					...
					// line 133: """Return a suite of all tests cases found using the given sequence
					πF.SetLineno(133)
					if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp006}, πg.NewStr("Return a suite of all tests cases found using the given sequence\n        of string specifiers. See 'loadTestsFromName()'.\n        ").ToObject()); πE != nil {
						continue
					}
					if πTemp007, πE = πg.ResolveClass(πF, πClass, nil, ßloadTestsFromNames); πE != nil {
						continue
					}
					...
					πTemp003[0] = πg.Param{Name: "self", Def: nil}
					πTemp003[1] = πg.Param{Name: "testCaseClass", Def: nil}
					πTemp006 = πg.NewFunction(πg.NewCode("getTestCaseNames", "/usr/lib/python2.7/unittest_loader.py", πTemp003, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
						var µtestCaseClass *πg.Object = πArgs[1]; _ = µtestCaseClass
						...
						for ; πF.State() >= 0; πF.PopCheckpoint() {
							...
							πTemp001 = πg.NewFunction(πg.NewCode("isTestMethod", "/usr/lib/python2.7/unittest_loader.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
							...
							πTemp004 = πg.NewFunction(πg.NewCode("<generator>", "/usr/lib/python2.7/unittest_loader.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
					...
					// line 140: """Return a sorted sequence of method names found within testCaseClass
					πF.SetLineno(140)
					if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp007}, πg.NewStr("Return a sorted sequence of method names found within testCaseClass\n        ").ToObject()); πE != nil {
						continue
					}
					if πTemp008, πE = πg.ResolveClass(πF, πClass, nil, ßgetTestCaseNames); πE != nil {
						continue
					}
					...
					πTemp007 = πg.NewFunction(πg.NewCode("discover", "/usr/lib/python2.7/unittest_loader.py", πTemp003, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
					...
					// line 153: """Find and return all test modules from the specified start
					πF.SetLineno(153)
					if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp008}, πg.NewStr("Find and return all test modules from the specified start\n        directory, recursing into subdirectories to find them. Only test files\n        that match the pattern will be loaded. (Using shell style pattern\n        matching.)\n\n        All test modules must be importable from the top level of the project.\n        If the start directory is not the top level directory then the top\n        level directory must be specified separately.\n\n        If a test package name (directory with '__init__.py') matches the\n        pattern then the package will be checked for a 'load_tests' function. If\n        this exists then it will be called with loader, tests, pattern.\n\n        If load_tests exists then discovery does  *not* recurse into the package,\n        load_tests is responsible for loading all tests in the package.\n\n        The pattern is deliberately not stored as a loader attribute so that\n        packages can continue discovery themselves. top_level_dir is stored so\n        load_tests does not need to pass this argument in to loader.discover().\n        ").ToObject()); πE != nil {
						continue
					}
					if πTemp009, πE = πg.ResolveClass(πF, πClass, nil, ßdiscover); πE != nil {
						continue
					}
					...
					πTemp008 = πg.NewFunction(πg.NewCode("_get_directory_containing_module", "/usr/lib/python2.7/unittest_loader.py", πTemp003, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
					...
					πTemp009 = πg.NewFunction(πg.NewCode("_get_name_from_path", "/usr/lib/python2.7/unittest_loader.py", πTemp003, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
					...
					πTemp003[0] = πg.Param{Name: "self", Def: nil}
					πTemp003[1] = πg.Param{Name: "name", Def: nil}
					πTemp010 = πg.NewFunction(πg.NewCode("_get_module_from_name", "/usr/lib/python2.7/unittest_loader.py", πTemp003, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
						var µname *πg.Object = πArgs[1]; _ = µname
						var πTemp001 []*πg.Object
						_ = πTemp001
					...
					πTemp011 = πg.NewFunction(πg.NewCode("_match_path", "/usr/lib/python2.7/unittest_loader.py", πTemp003, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
						var µpath *πg.Object = πArgs[1]; _ = µpath
					...
					πTemp012 = πg.NewFunction(πg.NewCode("_find_tests", "/usr/lib/python2.7/unittest_loader.py", πTemp003, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
						var µstart_dir *πg.Object = πArgs[1]; _ = µstart_dir
						var µpattern *πg.Object = πArgs[2]; _ = µpattern
					...
					// line 247: """Used by discovery. Yields test suites it loads."""
					πF.SetLineno(247)
					if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp013}, πg.NewStr("Used by discovery. Yields test suites it loads.").ToObject()); πE != nil {
						continue
					}
					if πTemp014, πE = πg.ResolveClass(πF, πClass, nil, ß_find_tests); πE != nil {
						continue
					}
			...
			πTemp007 = πg.NewFunction(πg.NewCode("_makeLoader", "/usr/lib/python2.7/unittest_loader.py", πTemp004, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
			...
			πTemp008 = πg.NewFunction(πg.NewCode("getTestCaseNames", "/usr/lib/python2.7/unittest_loader.py", πTemp004, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
			...
			πTemp009 = πg.NewFunction(πg.NewCode("makeSuite", "/usr/lib/python2.7/unittest_loader.py", πTemp004, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µtestCaseClass *πg.Object = πArgs[0]; _ = µtestCaseClass
				var µprefix *πg.Object = πArgs[1]; _ = µprefix
				var µsortUsing *πg.Object = πArgs[2]; _ = µsortUsing
				var µsuiteClass *πg.Object = πArgs[3]; _ = µsuiteClass
			...
			πTemp010 = πg.NewFunction(πg.NewCode("findTestCases", "/usr/lib/python2.7/unittest_loader.py", πTemp004, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
