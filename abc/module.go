...
var Code *πg.Code
func init() {
	Code = πg.NewCode("<module>", "/usr/lib/python2.7/abc.py", nil, 0, func(πF *πg.Frame, _ []*πg.Object) (*πg.Object, *πg.BaseException) {
		...
		for ; πF.State() >= 0; πF.PopCheckpoint() {
			...
			// line 4: """Abstract Base Classes (ABCs) according to PEP 3119."""
			πF.SetLineno(4)
			if πE = πF.Globals().SetItem(πF, ß__doc__.ToObject(), πg.NewStr("Abstract Base Classes (ABCs) according to PEP 3119.").ToObject()); πE != nil {
				continue
			}
			...
			πTemp001 = πg.NewFunction(πg.NewCode("abstractmethod", "/usr/lib/python2.7/abc.py", πTemp003, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
			...
			// line 16: """A decorator indicating abstract methods.
			πF.SetLineno(16)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp004}, πg.NewStr("A decorator indicating abstract methods.\n\n    Requires that the metaclass is ABCMeta or derived from it.  A\n    class that has a metaclass derived from ABCMeta cannot be\n    instantiated unless all of its abstract methods are overridden.\n    The abstract methods can be called using any of the normal\n    'super' call mechanisms.\n\n    Usage:\n\n        class C:\n            __metaclass__ = ABCMeta\n            @abstractmethod\n            def my_abstract_method(self, ...):\n                ...\n    ").ToObject()); πE != nil {
				continue
			}
			if πTemp005, πE = πg.ResolveGlobal(πF, ßabstractmethod); πE != nil {
				continue
			}
			...
			_, πE = πg.NewCode("abstractproperty", "/usr/lib/python2.7/abc.py", nil, 0, func(πF *πg.Frame, _ []*πg.Object) (*πg.Object, *πg.BaseException) {
				πClass := πTemp006
				_ = πClass
				var πTemp001 *πg.Object
				_ = πTemp001
				for ; πF.State() >= 0; πF.PopCheckpoint() {
					...
					// line 37: """A decorator indicating abstract properties.
					πF.SetLineno(37)
					if πE = πClass.SetItem(πF, ß__doc__.ToObject(), πg.NewStr("A decorator indicating abstract properties.\n\n    Requires that the metaclass is ABCMeta or derived from it.  A\n    class that has a metaclass derived from ABCMeta cannot be\n    instantiated unless all of its abstract properties are overridden.\n    The abstract properties can be called using any of the normal\n    'super' call mechanisms.\n\n    Usage:\n\n        class C:\n            __metaclass__ = ABCMeta\n            @abstractproperty\n            def my_abstract_property(self):\n                ...\n\n    This defines a read-only property; you can also define a read-write\n    abstract property using the 'long' form of property declaration:\n\n        class C:\n            __metaclass__ = ABCMeta\n            def getx(self): ...\n            def setx(self, value): ...\n            x = abstractproperty(getx, setx)\n    ").ToObject()); πE != nil {
						continue
					}
			...
			if πTemp007, πE = πTemp005.Call(πF, []*πg.Object{πg.NewStr("abstractproperty").ToObject(), πg.NewTuple(πTemp002...).ToObject(), πTemp006.ToObject()}, nil); πE != nil {
				continue
			}
			...
			_, πE = πg.NewCode("ABCMeta", "/usr/lib/python2.7/abc.py", nil, 0, func(πF *πg.Frame, _ []*πg.Object) (*πg.Object, *πg.BaseException) {
				πClass := πTemp006
				_ = πClass
				var πTemp001 *πg.Object
				_ = πTemp001
				...
				for ; πF.State() >= 0; πF.PopCheckpoint() {
					...
					// line 67: """Metaclass for defining Abstract Base Classes (ABCs).
					πF.SetLineno(67)
					if πE = πClass.SetItem(πF, ß__doc__.ToObject(), πg.NewStr("Metaclass for defining Abstract Base Classes (ABCs).\n\n    Use this metaclass to create an ABC.  An ABC can be subclassed\n    directly, and then acts as a mix-in class.  You can also register\n    unrelated concrete classes (even built-in classes) and unrelated\n    ABCs as 'virtual subclasses' -- these and their descendants will\n    be considered subclasses of the registering ABC by the built-in\n    issubclass() function, but the registering ABC won't show up in\n    their MRO (Method Resolution Order) nor will method\n    implementations defined by the registering ABC be callable (not\n    even via super()).\n\n    ").ToObject()); πE != nil {
						continue
					}
					...
					πTemp001 = πg.NewFunction(πg.NewCode("__new__", "/usr/lib/python2.7/abc.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						...
						for ; πF.State() >= 0; πF.PopCheckpoint() {
							...
							πTemp003 = πg.NewFunction(πg.NewCode("<generator>", "/usr/lib/python2.7/abc.py", πTemp005, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
					...
					πTemp003 = πg.NewFunction(πg.NewCode("register", "/usr/lib/python2.7/abc.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
					...
					// line 106: """Register a virtual subclass of an ABC."""
					πF.SetLineno(106)
					if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp004}, πg.NewStr("Register a virtual subclass of an ABC.").ToObject()); πE != nil {
						continue
					}
					if πTemp005, πE = πg.ResolveClass(πF, πClass, nil, ßregister); πE != nil {
						continue
					}
					if πE = πg.SetAttr(πF, πTemp005, ß__doc__, πTemp004); πE != nil {
						continue
					...
					πTemp004 = πg.NewFunction(πg.NewCode("_dump_registry", "/usr/lib/python2.7/abc.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µcls *πg.Object = πArgs[0]; _ = µcls
					...
					// line 120: """Debug helper to print the ABC registry."""
					πF.SetLineno(120)
					if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp005}, πg.NewStr("Debug helper to print the ABC registry.").ToObject()); πE != nil {
						continue
					}
					if πTemp006, πE = πg.ResolveClass(πF, πClass, nil, ß_dump_registry); πE != nil {
						continue
					}
					...
					πTemp005 = πg.NewFunction(πg.NewCode("__instancecheck__", "/usr/lib/python2.7/abc.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µcls *πg.Object = πArgs[0]; _ = µcls
					...
					// line 129: """Override for isinstance(instance, cls)."""
					πF.SetLineno(129)
					if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp006}, πg.NewStr("Override for isinstance(instance, cls).").ToObject()); πE != nil {
						continue
					}
					if πTemp007, πE = πg.ResolveClass(πF, πClass, nil, ß__instancecheck__); πE != nil {
						continue
					}
					...
					πTemp002[0] = πg.Param{Name: "cls", Def: nil}
					πTemp002[1] = πg.Param{Name: "subclass", Def: nil}
					πTemp006 = πg.NewFunction(πg.NewCode("__subclasscheck__", "/usr/lib/python2.7/abc.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µcls *πg.Object = πArgs[0]; _ = µcls
						var µsubclass *πg.Object = πArgs[1]; _ = µsubclass
					...
					// line 149: """Override for issubclass(subclass, cls)."""
					πF.SetLineno(149)
					if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp007}, πg.NewStr("Override for issubclass(subclass, cls).").ToObject()); πE != nil {
						continue
					}
					if πTemp008, πE = πg.ResolveClass(πF, πClass, nil, ß__subclasscheck__); πE != nil {
						continue
					}
			...
			if πTemp007, πE = πTemp005.Call(πF, []*πg.Object{πg.NewStr("ABCMeta").ToObject(), πg.NewTuple(πTemp002...).ToObject(), πTemp006.ToObject()}, nil); πE != nil {
				continue
			}
