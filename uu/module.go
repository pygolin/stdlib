...
var Code *πg.Code
func init() {
	Code = πg.NewCode("<module>", "/usr/lib/python2.7/uu.py", nil, 0, func(πF *πg.Frame, _ []*πg.Object) (*πg.Object, *πg.BaseException) {
		...
		for ; πF.State() >= 0; πF.PopCheckpoint() {
			...
			// line 27: """Implementation of the UUencode and UUdecode functions.
			πF.SetLineno(27)
			if πE = πF.Globals().SetItem(πF, ß__doc__.ToObject(), πg.NewStr("Implementation of the UUencode and UUdecode functions.\n\nencode(in_file, out_file [,name, mode])\ndecode(in_file [, out_file, mode])\n").ToObject()); πE != nil {
				continue
			}
			...
			_, πE = πg.NewCode("Error", "/usr/lib/python2.7/uu.py", nil, 0, func(πF *πg.Frame, _ []*πg.Object) (*πg.Object, *πg.BaseException) {
				πClass := πTemp003
				_ = πClass
				for ; πF.State() >= 0; πF.PopCheckpoint() {
					switch πF.State() {
			...
			πTemp001 = πg.NewFunction(πg.NewCode("encode", "/usr/lib/python2.7/uu.py", πTemp006, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
			...
			// line 43: """Uuencode file"""
			πF.SetLineno(43)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp004}, πg.NewStr("Uuencode file").ToObject()); πE != nil {
				continue
			}
			if πTemp005, πE = πg.ResolveGlobal(πF, ßencode); πE != nil {
				continue
			}
			...
			πTemp004 = πg.NewFunction(πg.NewCode("decode", "/usr/lib/python2.7/uu.py", πTemp006, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µin_file *πg.Object = πArgs[0]; _ = µin_file
				var µout_file *πg.Object = πArgs[1]; _ = µout_file
			...
			// line 91: """Decode uuencoded file"""
			πF.SetLineno(91)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp005}, πg.NewStr("Decode uuencoded file").ToObject()); πE != nil {
				continue
			}
			if πTemp007, πE = πg.ResolveGlobal(πF, ßdecode); πE != nil {
				continue
			}
			...
			πTemp005 = πg.NewFunction(πg.NewCode("test", "/usr/lib/python2.7/uu.py", πTemp006, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
			...
			// line 159: """uuencode/uudecode main program"""
			πF.SetLineno(159)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp007}, πg.NewStr("uuencode/uudecode main program").ToObject()); πE != nil {
				continue
			}
			if πTemp008, πE = πg.ResolveGlobal(πF, ßtest); πE != nil {
				continue
			}
