...
var Code *πg.Code
func init() {
	Code = πg.NewCode("<module>", "/usr/lib/python2.7/fpformat.py", nil, 0, func(πF *πg.Frame, _ []*πg.Object) (*πg.Object, *πg.BaseException) {
		...
		for ; πF.State() >= 0; πF.PopCheckpoint() {
			...
			// line 1: """General floating point formatting functions.
			πF.SetLineno(1)
			if πE = πF.Globals().SetItem(πF, ß__doc__.ToObject(), πg.NewStr("General floating point formatting functions.\n\nFunctions:\nfix(x, digits_behind)\nsci(x, digits_behind)\n\nEach takes a number or a string and a number of digits as arguments.\n\nParameters:\nx:             number to be formatted; or a string resembling a number\ndigits_behind: number of digits behind the decimal point\n").ToObject()); πE != nil {
				continue
			}
			...
			_, πE = πg.NewCode("NotANumber", "/usr/lib/python2.7/fpformat.py", nil, 0, func(πF *πg.Frame, _ []*πg.Object) (*πg.Object, *πg.BaseException) {
				πClass := πTemp005
				_ = πClass
				for ; πF.State() >= 0; πF.PopCheckpoint() {
					switch πF.State() {
		...
		Label1:
			...
			πTemp001 = πg.NewFunction(πg.NewCode("extract", "/usr/lib/python2.7/fpformat.py", πTemp010, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
			...
			// line 36: """Return (sign, intpart, fraction, expo) or raise an exception:
			πF.SetLineno(36)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp003}, πg.NewStr("Return (sign, intpart, fraction, expo) or raise an exception:\n    sign is '+' or '-'\n    intpart is 0 or more digits beginning with a nonzero\n    fraction is 0 or more digits\n    expo is an integer").ToObject()); πE != nil {
				continue
			}
			if πTemp006, πE = πg.ResolveGlobal(πF, ßextract); πE != nil {
				continue
			}
			...
			πTemp003 = πg.NewFunction(πg.NewCode("unexpo", "/usr/lib/python2.7/fpformat.py", πTemp010, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
			...
			// line 51: """Remove the exponent by changing intpart and fraction."""
			πF.SetLineno(51)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp006}, πg.NewStr("Remove the exponent by changing intpart and fraction.").ToObject()); πE != nil {
				continue
			}
			if πTemp011, πE = πg.ResolveGlobal(πF, ßunexpo); πE != nil {
				continue
			}
			if πE = πg.SetAttr(πF, πTemp011, ß__doc__, πTemp006); πE != nil {
				continue
			}
			...
			πTemp006 = πg.NewFunction(πg.NewCode("roundfrac", "/usr/lib/python2.7/fpformat.py", πTemp010, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µintpart *πg.Object = πArgs[0]; _ = µintpart
				var µfraction *πg.Object = πArgs[1]; _ = µfraction
			...
			// line 65: """Round or extend the fraction to size digs."""
			πF.SetLineno(65)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp011}, πg.NewStr("Round or extend the fraction to size digs.").ToObject()); πE != nil {
				continue
			}
			if πTemp012, πE = πg.ResolveGlobal(πF, ßroundfrac); πE != nil {
				continue
			}
			...
			πTemp011 = πg.NewFunction(πg.NewCode("fix", "/usr/lib/python2.7/fpformat.py", πTemp010, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
			...
			// line 91: """Format x as [-]ddd.ddd with 'digs' digits after the point
			πF.SetLineno(91)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp012}, πg.NewStr("Format x as [-]ddd.ddd with 'digs' digits after the point\n    and at least one digit before.\n    If digs <= 0, the point is suppressed.").ToObject()); πE != nil {
				continue
			}
			if πTemp013, πE = πg.ResolveGlobal(πF, ßfix); πE != nil {
				continue
			}
			...
			πTemp010[0] = πg.Param{Name: "x", Def: nil}
			πTemp010[1] = πg.Param{Name: "digs", Def: nil}
			πTemp012 = πg.NewFunction(πg.NewCode("sci", "/usr/lib/python2.7/fpformat.py", πTemp010, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µx *πg.Object = πArgs[0]; _ = µx
				var µdigs *πg.Object = πArgs[1]; _ = µdigs
				var µsign *πg.Object = πg.UnboundLocal; _ = µsign
				var µintpart *πg.Object = πg.UnboundLocal; _ = µintpart
			...
			// line 107: """Format x as [-]d.dddE[+-]ddd with 'digs' digits after the point
			πF.SetLineno(107)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp013}, πg.NewStr("Format x as [-]d.dddE[+-]ddd with 'digs' digits after the point\n    and exactly one digit before.\n    If digs is <= 0, one digit is kept and the point is suppressed.").ToObject()); πE != nil {
				continue
			}
			if πTemp014, πE = πg.ResolveGlobal(πF, ßsci); πE != nil {
				continue
			}
			...
			πTemp013 = πg.NewFunction(πg.NewCode("test", "/usr/lib/python2.7/fpformat.py", πTemp010, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
			...
			// line 139: """Interactive test run."""
			πF.SetLineno(139)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp014}, πg.NewStr("Interactive test run.").ToObject()); πE != nil {
				continue
			}
			if πTemp015, πE = πg.ResolveGlobal(πF, ßtest); πE != nil {
				continue
			}
