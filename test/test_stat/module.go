...
var Code *πg.Code
func init() {
	Code = πg.NewCode("<module>", "/usr/lib/python2.7/test/test_stat.py", nil, 0, func(πF *πg.Frame, _ []*πg.Object) (*πg.Object, *πg.BaseException) {
		...
		for ; πF.State() >= 0; πF.PopCheckpoint() {
			...
			πTemp001 = πTemp002[1]
			if πTemp003, πE = πg.GetAttrImport(πF, πTemp001, ßTESTFN); πE != nil {
				continue
			}
			...
			πTemp001 = πTemp002[1]
			if πTemp003, πE = πg.GetAttrImport(πF, πTemp001, ßrun_unittest); πE != nil {
				continue
			}
			...
			_, πE = πg.NewCode("TestFilemode", "/usr/lib/python2.7/test/test_stat.py", nil, 0, func(πF *πg.Frame, _ []*πg.Object) (*πg.Object, *πg.BaseException) {
				πClass := πTemp004
				_ = πClass
				var πTemp001 *πg.Set
				_ = πTemp001
				...
				for ; πF.State() >= 0; πF.PopCheckpoint() {
					...
					πTemp002 = πg.NewFunction(πg.NewCode("setUp", "/usr/lib/python2.7/test/test_stat.py", πTemp004, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
					...
					πTemp005 = πg.NewFunction(πg.NewCode("get_mode", "/usr/lib/python2.7/test/test_stat.py", πTemp004, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
					...
					πTemp006 = πg.NewFunction(πg.NewCode("assertS_IS", "/usr/lib/python2.7/test/test_stat.py", πTemp004, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
					...
					πTemp004 = make([]πg.Param, 1)
					πTemp004[0] = πg.Param{Name: "self", Def: nil}
					πTemp007 = πg.NewFunction(πg.NewCode("test_mode", "/usr/lib/python2.7/test/test_stat.py", πTemp004, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
						var µst_mode *πg.Object = πg.UnboundLocal; _ = µst_mode
						var πTemp001 []*πg.Object
						_ = πTemp001
						...
						Label1:
							...
							if πTemp010, πE = πg.ResolveGlobal(πF, ßos); πE != nil {
								continue
							}
							if πTemp011, πE = πg.GetAttr(πF, πTemp010, ßname, nil); πE != nil {
								continue
							}
							if πTemp005, πE = πg.Eq(πF, πTemp011, ßposix.ToObject()); πE != nil {
								continue
							}
							if πTemp006, πE = πg.IsTrue(πF, πTemp005); πE != nil {
								continue
						...
						Label2:
							...
							πF.SetLineno(90)
							πTemp001 = πF.MakeArgs(2)
							if πTemp005, πE = πg.ResolveGlobal(πF, ßTESTFN); πE != nil {
								continue
							}
							πTemp001[0] = πTemp005
							...
							if πTemp010, πE = πg.GetAttr(πF, πTemp005, ßchmod, nil); πE != nil {
								continue
							}
							if πTemp005, πE = πTemp010.Call(πF, πTemp001, nil); πE != nil {
								continue
							}
							πF.FreeArgs(πTemp001)
							...
							if πTemp005, πE = πg.GetAttr(πF, µself, ßget_mode, nil); πE != nil {
								continue
							}
							...
							if πTemp005, πE = πg.GetAttr(πF, µself, ßassertS_IS, nil); πE != nil {
								continue
							}
							...
							if πTemp010, πE = πg.GetAttr(πF, πTemp005, ßS_IMODE, nil); πE != nil {
								continue
							}
							if πTemp005, πE = πTemp010.Call(πF, πTemp012, nil); πE != nil {
								continue
							}
							...
							if πTemp010, πE = πg.GetAttr(πF, πTemp005, ßS_IRWXU, nil); πE != nil {
								continue
							}
							πTemp001[1] = πTemp010
							if πE = πg.CheckLocal(πF, µself, "self"); πE != nil {
							...
							if πTemp010, πE = πg.GetAttr(πF, πTemp005, ßS_IRWXG, nil); πE != nil {
								continue
							}
							πTemp001[1] = πTemp010
							if πE = πg.CheckLocal(πF, µself, "self"); πE != nil {
							...
							if πTemp010, πE = πg.GetAttr(πF, πTemp005, ßS_IRWXO, nil); πE != nil {
								continue
							}
							πTemp001[1] = πTemp010
							if πE = πg.CheckLocal(πF, µself, "self"); πE != nil {
						...
						Label3:
							...
							if πTemp010, πE = πg.GetAttr(πF, πTemp005, ßS_IFMT, nil); πE != nil {
								continue
							}
							if πTemp005, πE = πTemp010.Call(πF, πTemp012, nil); πE != nil {
								continue
							...
							if πTemp010, πE = πg.GetAttr(πF, πTemp005, ßS_IFREG, nil); πE != nil {
								continue
							}
							πTemp001[1] = πTemp010
							if πE = πg.CheckLocal(πF, µself, "self"); πE != nil {
					...
					πTemp004 = make([]πg.Param, 1)
					πTemp004[0] = πg.Param{Name: "self", Def: nil}
					πTemp009 = πg.NewFunction(πg.NewCode("test_directory", "/usr/lib/python2.7/test/test_stat.py", πTemp004, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
						var µst_mode *πg.Object = πg.UnboundLocal; _ = µst_mode
						var πTemp001 []*πg.Object
						_ = πTemp001
					...
					πTemp004 = make([]πg.Param, 1)
					πTemp004[0] = πg.Param{Name: "self", Def: nil}
					πTemp011 = πg.NewFunction(πg.NewCode("test_link", "/usr/lib/python2.7/test/test_stat.py", πTemp004, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
					...
					πTemp004 = make([]πg.Param, 1)
					πTemp004[0] = πg.Param{Name: "self", Def: nil}
					πTemp012 = πg.NewFunction(πg.NewCode("test_fifo", "/usr/lib/python2.7/test/test_stat.py", πTemp004, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
						var µst_mode *πg.Object = πg.UnboundLocal; _ = µst_mode
						var πTemp001 []*πg.Object
						_ = πTemp001
					...
					πTemp004 = make([]πg.Param, 1)
					πTemp004[0] = πg.Param{Name: "self", Def: nil}
					πTemp014 = πg.NewFunction(πg.NewCode("test_devices", "/usr/lib/python2.7/test/test_stat.py", πTemp004, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
						var µst_mode *πg.Object = πg.UnboundLocal; _ = µst_mode
					...
					πTemp004 = make([]πg.Param, 1)
					πTemp004[0] = πg.Param{Name: "self", Def: nil}
					πTemp015 = πg.NewFunction(πg.NewCode("test_module_attributes", "/usr/lib/python2.7/test/test_stat.py", πTemp004, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
			...
			πTemp001 = πg.NewFunction(πg.NewCode("test_main", "/usr/lib/python2.7/test/test_stat.py", πTemp007, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var πTemp001 []*πg.Object
				_ = πTemp001
				var πTemp002 *πg.Object
				_ = πTemp002
