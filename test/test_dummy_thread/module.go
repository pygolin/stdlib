...
var Code *πg.Code
func init() {
	Code = πg.NewCode("<module>", "/usr/lib/python2.7/test/test_dummy_thread.py", nil, 0, func(πF *πg.Frame, _ []*πg.Object) (*πg.Object, *πg.BaseException) {
		...
		for ; πF.State() >= 0; πF.PopCheckpoint() {
			...
			// line 1: """Generic thread tests.
			πF.SetLineno(1)
			if πE = πF.Globals().SetItem(πF, ß__doc__.ToObject(), πg.NewStr("Generic thread tests.\n\nMeant to be used by dummy_thread and thread.  To allow for different modules\nto be used, test_main() can be called with the module to use as the thread\nimplementation as its sole argument.\n\n").ToObject()); πE != nil {
				continue
			}
			...
			_, πE = πg.NewCode("LockTests", "/usr/lib/python2.7/test/test_dummy_thread.py", nil, 0, func(πF *πg.Frame, _ []*πg.Object) (*πg.Object, *πg.BaseException) {
				πClass := πTemp003
				_ = πClass
				var πTemp001 *πg.Object
				_ = πTemp001
				...
				for ; πF.State() >= 0; πF.PopCheckpoint() {
					...
					// line 19: """Test lock objects."""
					πF.SetLineno(19)
					if πE = πClass.SetItem(πF, ß__doc__.ToObject(), πg.NewStr("Test lock objects.").ToObject()); πE != nil {
						continue
					}
					...
					πTemp001 = πg.NewFunction(πg.NewCode("setUp", "/usr/lib/python2.7/test/test_dummy_thread.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
					...
					πTemp002 = make([]πg.Param, 1)
					πTemp002[0] = πg.Param{Name: "self", Def: nil}
					πTemp003 = πg.NewFunction(πg.NewCode("test_initlock", "/usr/lib/python2.7/test/test_dummy_thread.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
						var πTemp001 []*πg.Object
						_ = πTemp001
						var πTemp002 *πg.Object
					...
					πTemp002 = make([]πg.Param, 1)
					πTemp002[0] = πg.Param{Name: "self", Def: nil}
					πTemp004 = πg.NewFunction(πg.NewCode("test_release", "/usr/lib/python2.7/test/test_dummy_thread.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
						var πTemp001 *πg.Object
						_ = πTemp001
						var πTemp002 *πg.Object
					...
					πTemp002 = make([]πg.Param, 1)
					πTemp002[0] = πg.Param{Name: "self", Def: nil}
					πTemp005 = πg.NewFunction(πg.NewCode("test_improper_release", "/usr/lib/python2.7/test/test_dummy_thread.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
						var πTemp001 []*πg.Object
						_ = πTemp001
						var πTemp002 *πg.Object
					...
					πTemp002 = make([]πg.Param, 1)
					πTemp002[0] = πg.Param{Name: "self", Def: nil}
					πTemp006 = πg.NewFunction(πg.NewCode("test_cond_acquire_success", "/usr/lib/python2.7/test/test_dummy_thread.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
						var πTemp001 []*πg.Object
						_ = πTemp001
						var πTemp002 []*πg.Object
					...
					πTemp002 = make([]πg.Param, 1)
					πTemp002[0] = πg.Param{Name: "self", Def: nil}
					πTemp007 = πg.NewFunction(πg.NewCode("test_cond_acquire_fail", "/usr/lib/python2.7/test/test_dummy_thread.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
						var πTemp001 []*πg.Object
						_ = πTemp001
						var πTemp002 *πg.Object
					...
					πTemp002 = make([]πg.Param, 1)
					πTemp002[0] = πg.Param{Name: "self", Def: nil}
					πTemp008 = πg.NewFunction(πg.NewCode("test_uncond_acquire_success", "/usr/lib/python2.7/test/test_dummy_thread.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
						var πTemp001 *πg.Object
						_ = πTemp001
						var πTemp002 *πg.Object
					...
					πTemp002 = make([]πg.Param, 1)
					πTemp002[0] = πg.Param{Name: "self", Def: nil}
					πTemp009 = πg.NewFunction(πg.NewCode("test_uncond_acquire_return_val", "/usr/lib/python2.7/test/test_dummy_thread.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
						var πTemp001 []*πg.Object
						_ = πTemp001
						var πTemp002 []*πg.Object
					...
					πTemp002 = make([]πg.Param, 1)
					πTemp002[0] = πg.Param{Name: "self", Def: nil}
					πTemp010 = πg.NewFunction(πg.NewCode("test_uncond_acquire_blocking", "/usr/lib/python2.7/test/test_dummy_thread.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
						...
						for ; πF.State() >= 0; πF.PopCheckpoint() {
							...
							πTemp001 = πg.NewFunction(πg.NewCode("delay_unlock", "/usr/lib/python2.7/test/test_dummy_thread.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
							...
							// line 68: """Hold on to lock for a set amount of time before unlocking."""
							πF.SetLineno(68)
							if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp003}, πg.NewStr("Hold on to lock for a set amount of time before unlocking.").ToObject()); πE != nil {
								continue
							}
							if πE = πg.CheckLocal(πF, µdelay_unlock, "delay_unlock"); πE != nil {
								continue
							}
							if πE = πg.SetAttr(πF, µdelay_unlock, ß__doc__, πTemp003); πE != nil {
								continue
							}
			...
			_, πE = πg.NewCode("MiscTests", "/usr/lib/python2.7/test/test_dummy_thread.py", nil, 0, func(πF *πg.Frame, _ []*πg.Object) (*πg.Object, *πg.BaseException) {
				πClass := πTemp003
				_ = πClass
				var πTemp001 *πg.Object
				_ = πTemp001
				...
				for ; πF.State() >= 0; πF.PopCheckpoint() {
					...
					// line 87: """Miscellaneous tests."""
					πF.SetLineno(87)
					if πE = πClass.SetItem(πF, ß__doc__.ToObject(), πg.NewStr("Miscellaneous tests.").ToObject()); πE != nil {
						continue
					}
					...
					πTemp002 = make([]πg.Param, 1)
					πTemp002[0] = πg.Param{Name: "self", Def: nil}
					πTemp001 = πg.NewFunction(πg.NewCode("test_exit", "/usr/lib/python2.7/test/test_dummy_thread.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
						var πTemp001 []*πg.Object
						_ = πTemp001
						var πTemp002 *πg.Object
					...
					πTemp002 = make([]πg.Param, 1)
					πTemp002[0] = πg.Param{Name: "self", Def: nil}
					πTemp003 = πg.NewFunction(πg.NewCode("test_ident", "/usr/lib/python2.7/test/test_dummy_thread.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
						var πTemp001 []*πg.Object
						_ = πTemp001
						var πTemp002 *πg.Object
					...
					πTemp002 = make([]πg.Param, 1)
					πTemp002[0] = πg.Param{Name: "self", Def: nil}
					πTemp004 = πg.NewFunction(πg.NewCode("test_LockType", "/usr/lib/python2.7/test/test_dummy_thread.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
						var πTemp001 []*πg.Object
						_ = πTemp001
						var πTemp002 *πg.Object
					...
					πTemp002 = make([]πg.Param, 1)
					πTemp002[0] = πg.Param{Name: "self", Def: nil}
					πTemp005 = πg.NewFunction(πg.NewCode("test_interrupt_main", "/usr/lib/python2.7/test/test_dummy_thread.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
						...
						for ; πF.State() >= 0; πF.PopCheckpoint() {
							...
							πTemp001 = πg.NewFunction(πg.NewCode("call_interrupt", "/usr/lib/python2.7/test/test_dummy_thread.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
								var πTemp001 *πg.Object
								_ = πTemp001
								var πTemp002 *πg.Object
								_ = πTemp002
					...
					πTemp002 = make([]πg.Param, 1)
					πTemp002[0] = πg.Param{Name: "self", Def: nil}
					πTemp006 = πg.NewFunction(πg.NewCode("test_interrupt_in_main", "/usr/lib/python2.7/test/test_dummy_thread.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
						var πTemp001 []*πg.Object
						_ = πTemp001
						var πTemp002 *πg.Object
			...
			_, πE = πg.NewCode("ThreadTests", "/usr/lib/python2.7/test/test_dummy_thread.py", nil, 0, func(πF *πg.Frame, _ []*πg.Object) (*πg.Object, *πg.BaseException) {
				πClass := πTemp003
				_ = πClass
				var πTemp001 *πg.Object
				_ = πTemp001
				...
				for ; πF.State() >= 0; πF.PopCheckpoint() {
					...
					// line 120: """Test thread creation."""
					πF.SetLineno(120)
					if πE = πClass.SetItem(πF, ß__doc__.ToObject(), πg.NewStr("Test thread creation.").ToObject()); πE != nil {
						continue
					}
					...
					πTemp002 = make([]πg.Param, 1)
					πTemp002[0] = πg.Param{Name: "self", Def: nil}
					πTemp001 = πg.NewFunction(πg.NewCode("test_arg_passing", "/usr/lib/python2.7/test/test_dummy_thread.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
						...
						for ; πF.State() >= 0; πF.PopCheckpoint() {
							...
							πTemp001 = πg.NewFunction(πg.NewCode("arg_tester", "/usr/lib/python2.7/test/test_dummy_thread.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
							...
							// line 125: """Use to test _thread.start_new_thread() passes args properly."""
							πF.SetLineno(125)
							if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp003}, πg.NewStr("Use to test _thread.start_new_thread() passes args properly.").ToObject()); πE != nil {
								continue
							}
							if πE = πg.CheckLocal(πF, µarg_tester, "arg_tester"); πE != nil {
								continue
							}
							if πE = πg.SetAttr(πF, µarg_tester, ß__doc__, πTemp003); πE != nil {
								continue
							}
					...
					πTemp002 = make([]πg.Param, 1)
					πTemp002[0] = πg.Param{Name: "self", Def: nil}
					πTemp003 = πg.NewFunction(πg.NewCode("test_multi_creation", "/usr/lib/python2.7/test/test_dummy_thread.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
						...
						for ; πF.State() >= 0; πF.PopCheckpoint() {
							...
							πTemp002[0] = πg.Param{Name: "queue", Def: nil}
							πTemp002[1] = πg.Param{Name: "delay", Def: nil}
							πTemp001 = πg.NewFunction(πg.NewCode("queue_mark", "/usr/lib/python2.7/test/test_dummy_thread.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
								var µqueue *πg.Object = πArgs[0]; _ = µqueue
								var µdelay *πg.Object = πArgs[1]; _ = µdelay
								var πTemp001 []*πg.Object
								_ = πTemp001
							...
							// line 147: """Wait for ``delay`` seconds and then put something into ``queue``"""
							πF.SetLineno(147)
							if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp003}, πg.NewStr("Wait for ``delay`` seconds and then put something into ``queue``").ToObject()); πE != nil {
								continue
							}
							if πE = πg.CheckLocal(πF, µqueue_mark, "queue_mark"); πE != nil {
								continue
							}
							if πE = πg.SetAttr(πF, µqueue_mark, ß__doc__, πTemp003); πE != nil {
								continue
							}
							...
							if πTemp005, πE = πg.GetAttr(πF, πTemp003, ßverbose, nil); πE != nil {
								continue
							}
						...
						Label1:
							...
							if πTemp003, πE = πg.Mod(πF, πg.NewStr("*** Testing multiple thread creation (will take approx. %s to %s sec.) ***").ToObject(), πTemp005); πE != nil {
								continue
							}
							πTemp004[0] = πTemp003
							if πE = πg.Print(πF, πTemp004, true); πE != nil {
						...
						Label5:
							...
							if πTemp005, πE = πg.GetAttr(πF, πTemp003, ßsleep, nil); πE != nil {
								continue
							}
							if πTemp003, πE = πTemp005.Call(πF, πTemp004, nil); πE != nil {
								continue
						...
						Label10:
							...
							if πTemp003, πE = πg.GetAttr(πF, µtesting_queue, ßqsize, nil); πE != nil {
								continue
							}
							if πTemp005, πE = πTemp003.Call(πF, nil, nil); πE != nil {
								continue
							...
							if πTemp003, πE = πg.Mod(πF, πg.NewStr("Not all %s threads executed properly after %s sec.").ToObject(), πTemp005); πE != nil {
								continue
							}
							πTemp004[2] = πTemp003
							if πE = πg.CheckLocal(πF, µself, "self"); πE != nil {
			...
			πTemp001 = πg.NewFunction(πg.NewCode("test_main", "/usr/lib/python2.7/test/test_dummy_thread.py", πTemp007, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
