...
var Code *πg.Code
func init() {
	Code = πg.NewCode("<module>", "/usr/lib/python2.7/test/test_support.py", nil, 0, func(πF *πg.Frame, _ []*πg.Object) (*πg.Object, *πg.BaseException) {
		...
		for ; πF.State() >= 0; πF.PopCheckpoint() {
			...
			// line 1: """Supporting definitions for the Python regression tests."""
			πF.SetLineno(1)
			if πE = πF.Globals().SetItem(πF, ß__doc__.ToObject(), πg.NewStr("Supporting definitions for the Python regression tests.").ToObject()); πE != nil {
				continue
			}
		...
		Label1:
			...
			_, πE = πg.NewCode("Error", "/usr/lib/python2.7/test/test_support.py", nil, 0, func(πF *πg.Frame, _ []*πg.Object) (*πg.Object, *πg.BaseException) {
				πClass := πTemp006
				_ = πClass
				for ; πF.State() >= 0; πF.PopCheckpoint() {
					switch πF.State() {
					...
					// line 52: """Base class for regression test exceptions."""
					πF.SetLineno(52)
					if πE = πClass.SetItem(πF, ß__doc__.ToObject(), πg.NewStr("Base class for regression test exceptions.").ToObject()); πE != nil {
						continue
					}
				}
				return nil, nil
			...
			_, πE = πg.NewCode("TestFailed", "/usr/lib/python2.7/test/test_support.py", nil, 0, func(πF *πg.Frame, _ []*πg.Object) (*πg.Object, *πg.BaseException) {
				πClass := πTemp006
				_ = πClass
				for ; πF.State() >= 0; πF.PopCheckpoint() {
					switch πF.State() {
					...
					// line 55: """Test failed."""
					πF.SetLineno(55)
					if πE = πClass.SetItem(πF, ß__doc__.ToObject(), πg.NewStr("Test failed.").ToObject()); πE != nil {
						continue
					}
				}
				return nil, nil
		...
		Label4:
			...
			πTemp001 = πg.NewFunction(πg.NewCode("_waitfor", "/usr/lib/python2.7/test/test_support.py", πTemp009, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
			...
			πTemp007 = πg.NewFunction(πg.NewCode("_unlink", "/usr/lib/python2.7/test/test_support.py", πTemp009, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
			...
			πTemp008 = πg.NewFunction(πg.NewCode("_rmdir", "/usr/lib/python2.7/test/test_support.py", πTemp009, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
			...
			πTemp010 = πg.NewFunction(πg.NewCode("_rmtree", "/usr/lib/python2.7/test/test_support.py", πTemp009, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				...
				for ; πF.State() >= 0; πF.PopCheckpoint() {
					...
					πTemp001 = πg.NewFunction(πg.NewCode("_rmtree_inner", "/usr/lib/python2.7/test/test_support.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µpath *πg.Object = πArgs[0]; _ = µpath
						var µname *πg.Object = πg.UnboundLocal; _ = µname
		...
		Label6:
			...
			πTemp009 = make([]πg.Param, 1)
			πTemp009[0] = πg.Param{Name: "filename", Def: nil}
			πTemp011 = πg.NewFunction(πg.NewCode("unlink", "/usr/lib/python2.7/test/test_support.py", πTemp009, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µfilename *πg.Object = πArgs[0]; _ = µfilename
				var πTemp001 []*πg.Object
				_ = πTemp001
				var πTemp002 *πg.Object
		...
		Label13:
			...
			_, πE = πg.NewCode("WarningsRecorder", "/usr/lib/python2.7/test/test_support.py", nil, 0, func(πF *πg.Frame, _ []*πg.Object) (*πg.Object, *πg.BaseException) {
				πClass := πTemp006
				_ = πClass
				var πTemp001 *πg.Object
				_ = πTemp001
				...
				for ; πF.State() >= 0; πF.PopCheckpoint() {
					...
					// line 822: """Convenience wrapper for the warnings list returned on
					πF.SetLineno(822)
					if πE = πClass.SetItem(πF, ß__doc__.ToObject(), πg.NewStr("Convenience wrapper for the warnings list returned on\n       entry to the warnings.catch_warnings() context manager.\n    ").ToObject()); πE != nil {
						continue
					}
					...
					πTemp001 = πg.NewFunction(πg.NewCode("__init__", "/usr/lib/python2.7/test/test_support.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
					...
					πTemp003 = πg.NewFunction(πg.NewCode("__getattr__", "/usr/lib/python2.7/test/test_support.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
					...
					πTemp002 = make([]πg.Param, 1)
					πTemp002[0] = πg.Param{Name: "self", Def: nil}
					πTemp004 = πg.NewFunction(πg.NewCode("warnings", "/usr/lib/python2.7/test/test_support.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
						var πTemp001 *πg.Object
						_ = πTemp001
						var πTemp002 *πg.Object
					...
					πTemp002 = make([]πg.Param, 1)
					πTemp002[0] = πg.Param{Name: "self", Def: nil}
					πTemp006 = πg.NewFunction(πg.NewCode("reset", "/usr/lib/python2.7/test/test_support.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
						var πTemp001 []*πg.Object
						_ = πTemp001
						var πTemp002 *πg.Object
			...
			πTemp012 = πg.NewFunction(πg.NewCode("_filterwarnings", "/usr/lib/python2.7/test/test_support.py", πTemp009, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				...
				return πg.NewGenerator(πF, func(πSent *πg.Object) (*πg.Object, *πg.BaseException) {
					...
					Label1:
						...
						πTemp008 = πg.NewFunction(πg.NewCode("<generator>", "/usr/lib/python2.7/test/test_support.py", πTemp014, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						...
						if πTemp006, πE = πg.Iter(πF, µfilters); πE != nil {
							continue
						}
						πF.PushCheckpoint(4)
						πTemp010 = false
					Label3:
						...
						if πTemp009, πE = πg.Next(πF, πTemp006); πE != nil {
							...
							πTemp015 = true
							if πE = πg.Tie(πF, πg.TieTarget{Children: []πg.TieTarget{πg.TieTarget{Target: &πTemp016}, πg.TieTarget{Target: &πTemp017}}}, πTemp009); πE != nil {
								continue
							}
							µmsg = πTemp016
							µcat = πTemp017
						...
						µseen = πTemp009
						if πTemp016, πE = πg.SliceType.Call(πF, πg.Args{πg.None, πg.None, πg.None}, nil); πE != nil {
							continue
						}
						if πE = πg.CheckLocal(πF, µreraise, "reraise"); πE != nil {
							continue
						}
						if πTemp017, πE = πg.GetItem(πF, µreraise, πTemp016); πE != nil {
							continue
						}
						if πTemp009, πE = πg.Iter(πF, πTemp017); πE != nil {
							continue
						}
						πF.PushCheckpoint(7)
						πTemp015 = false
					Label6:
						...
						if πTemp016, πE = πg.Next(πF, πTemp009); πE != nil {
							isStop, exc := πg.IsInstance(πF, πE.ToObject(), πg.StopIterationType.ToObject())
							if exc != nil {
								πE = exc
							} else if isStop {
						...
						πTemp005[0] = µexc
						if πTemp016, πE = πg.ResolveGlobal(πF, ßstr); πE != nil {
							continue
						}
						...
						if πTemp019, πE = πg.GetAttr(πF, πTemp017, ßI, nil); πE != nil {
							continue
						}
						πTemp005[2] = πTemp019
						if πTemp017, πE = πg.ResolveGlobal(πF, ßre); πE != nil {
						...
						if πTemp019, πE = πg.GetAttr(πF, πTemp017, ßmatch, nil); πE != nil {
							continue
						}
						if πTemp017, πE = πTemp019.Call(πF, πTemp005, nil); πE != nil {
							continue
						}
						πF.FreeArgs(πTemp005)
						πTemp016 = πTemp017
						...
						if πTemp017, πE = πg.GetAttr(πF, µexc, ß__class__, nil); πE != nil {
							continue
						}
						πTemp005[0] = πTemp017
						...
						πTemp005[1] = µcat
						if πTemp017, πE = πg.ResolveGlobal(πF, ßissubclass); πE != nil {
							continue
						}
						if πTemp019, πE = πTemp017.Call(πF, πTemp005, nil); πE != nil {
							continue
						}
						πF.FreeArgs(πTemp005)
						πTemp016 = πTemp019
					...
					Label10:
						...
						if πTemp016, πE = πg.GetAttr(πF, µreraise, ßremove, nil); πE != nil {
							continue
						}
						if πTemp017, πE = πTemp016.Call(πF, πTemp005, nil); πE != nil {
							continue
					...
					Label8:
						...
						if πTemp018, πE = πg.IsTrue(πF, µseen); πE != nil {
							continue
						}
						...
						if πTemp018, πE = πg.IsTrue(πF, µquiet); πE != nil {
							continue
						}
						πTemp016 = πg.GetBool(!πTemp018).ToObject()
						πTemp009 = πTemp016
					...
					Label13:
						...
						if πTemp016, πE = πg.GetAttr(πF, µcat, ß__name__, nil); πE != nil {
							continue
						}
						πTemp009 = πg.NewTuple2(µmsg, πTemp016).ToObject()
						πTemp005[0] = πTemp009
						if πE = πg.CheckLocal(πF, µmissing, "missing"); πE != nil {
							continue
						}
						if πTemp009, πE = πg.GetAttr(πF, µmissing, ßappend, nil); πE != nil {
							continue
						}
						if πTemp016, πE = πTemp009.Call(πF, πTemp005, nil); πE != nil {
							continue
						}
						πF.FreeArgs(πTemp005)
						goto Label14
					...
					Label15:
						...
						if πTemp016, πE = πg.GetItem(πF, µreraise, πTemp009); πE != nil {
							continue
						}
						if πTemp006, πE = πg.Mod(πF, πg.NewStr("unhandled warning %r").ToObject(), πTemp016); πE != nil {
							continue
						}
						πTemp005[0] = πTemp006
						...
						if πTemp009, πE = πTemp006.Call(πF, πTemp005, nil); πE != nil {
							continue
						}
						πF.FreeArgs(πTemp005)
					...
					Label17:
						...
						if πTemp016, πE = πg.GetItem(πF, µmissing, πTemp009); πE != nil {
							continue
						}
						if πTemp006, πE = πg.Mod(πF, πg.NewStr("filter (%r, %s) did not catch any warning").ToObject(), πTemp016); πE != nil {
							continue
						}
						πTemp005[0] = πTemp006
						if πTemp006, πE = πg.ResolveGlobal(πF, ßAssertionError); πE != nil {
			...
			// line 845: """Catch the warnings, then check if all the expected
			πF.SetLineno(845)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp013}, πg.NewStr("Catch the warnings, then check if all the expected\n    warnings have been raised and re-raise unexpected warnings.\n    If 'quiet' is True, only re-raise the unexpected warnings.\n    ").ToObject()); πE != nil {
				continue
			}
			if πTemp014, πE = πg.ResolveGlobal(πF, ß_filterwarnings); πE != nil {
				continue
			}
			...
			πTemp013 = πg.NewFunction(πg.NewCode("check_warnings", "/usr/lib/python2.7/test/test_support.py", πTemp009, πg.CodeFlagVarArg | πg.CodeFlagKWArg, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µfilters *πg.Object = πArgs[0]; _ = µfilters
			...
			// line 885: """Context manager to silence warnings.
			πF.SetLineno(885)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp014}, πg.NewStr("Context manager to silence warnings.\n\n    Accept 2-tuples as positional arguments:\n        (\"message regexp\", WarningCategory)\n\n    Optional argument:\n     - if 'quiet' is True, it does not fail if a filter catches nothing\n        (default True without argument,\n         default False if some filters are defined)\n\n    Without argument, it defaults to:\n        check_warnings((\"\", Warning), quiet=True)\n    ").ToObject()); πE != nil {
				continue
			}
			if πTemp015, πE = πg.ResolveGlobal(πF, ßcheck_warnings); πE != nil {
				continue
			}
			...
			πF.SetLineno(908)
			πTemp009 = make([]πg.Param, 0)
			πTemp014 = πg.NewFunction(πg.NewCode("check_py3k_warnings", "/usr/lib/python2.7/test/test_support.py", πTemp009, πg.CodeFlagVarArg | πg.CodeFlagKWArg, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µfilters *πg.Object = πArgs[0]; _ = µfilters
				var µkwargs *πg.Object = πArgs[1]; _ = µkwargs
				var πTemp001 *πg.Object
				_ = πTemp001
			...
			// line 909: """Context manager to silence py3k warnings.
			πF.SetLineno(909)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp015}, πg.NewStr("Context manager to silence py3k warnings.\n\n    Accept 2-tuples as positional arguments:\n        (\"message regexp\", WarningCategory)\n\n    Optional argument:\n     - if 'quiet' is True, it does not fail if a filter catches nothing\n        (default False)\n\n    Without argument, it defaults to:\n        check_py3k_warnings((\"\", DeprecationWarning), quiet=False)\n    ").ToObject()); πE != nil {
				continue
			}
			if πTemp016, πE = πg.ResolveGlobal(πF, ßcheck_py3k_warnings); πE != nil {
				continue
			}
			...
			_, πE = πg.NewCode("CleanImport", "/usr/lib/python2.7/test/test_support.py", nil, 0, func(πF *πg.Frame, _ []*πg.Object) (*πg.Object, *πg.BaseException) {
				πClass := πTemp006
				_ = πClass
				var πTemp001 *πg.Object
				_ = πTemp001
				...
				for ; πF.State() >= 0; πF.PopCheckpoint() {
					...
					// line 931: """Context manager to force import to return a new module reference.
					πF.SetLineno(931)
					if πE = πClass.SetItem(πF, ß__doc__.ToObject(), πg.NewStr("Context manager to force import to return a new module reference.\n\n    This is useful for testing module-level behaviours, such as\n    the emission of a DeprecationWarning on import.\n\n    Use like this:\n\n        with CleanImport(\"foo\"):\n            importlib.import_module(\"foo\") # new reference\n    ").ToObject()); πE != nil {
						continue
					}
					...
					πTemp002 = make([]πg.Param, 1)
					πTemp002[0] = πg.Param{Name: "self", Def: nil}
					πTemp001 = πg.NewFunction(πg.NewCode("__init__", "/usr/lib/python2.7/test/test_support.py", πTemp002, πg.CodeFlagVarArg, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
					...
					πTemp002 = make([]πg.Param, 1)
					πTemp002[0] = πg.Param{Name: "self", Def: nil}
					πTemp003 = πg.NewFunction(πg.NewCode("__enter__", "/usr/lib/python2.7/test/test_support.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
						var πR *πg.Object; _ = πR
						var πE *πg.BaseException; _ = πE
						for ; πF.State() >= 0; πF.PopCheckpoint() {
					...
					πTemp002 = make([]πg.Param, 1)
					πTemp002[0] = πg.Param{Name: "self", Def: nil}
					πTemp004 = πg.NewFunction(πg.NewCode("__exit__", "/usr/lib/python2.7/test/test_support.py", πTemp002, πg.CodeFlagVarArg, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
			...
			_, πE = πg.NewCode("EnvironmentVarGuard", "/usr/lib/python2.7/test/test_support.py", nil, 0, func(πF *πg.Frame, _ []*πg.Object) (*πg.Object, *πg.BaseException) {
				πClass := πTemp006
				_ = πClass
				var πTemp001 *πg.Object
				_ = πTemp001
				...
				for ; πF.State() >= 0; πF.PopCheckpoint() {
					...
					// line 964: """Class to help protect the environment variable properly.  Can be used as
					πF.SetLineno(964)
					if πE = πClass.SetItem(πF, ß__doc__.ToObject(), πg.NewStr("Class to help protect the environment variable properly.  Can be used as\n    a context manager.").ToObject()); πE != nil {
						continue
					}
					...
					πTemp003 = πg.NewFunction(πg.NewCode("__getitem__", "/usr/lib/python2.7/test/test_support.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
					...
					πTemp004 = πg.NewFunction(πg.NewCode("__setitem__", "/usr/lib/python2.7/test/test_support.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
						var µenvvar *πg.Object = πArgs[1]; _ = µenvvar
					...
					πTemp002[0] = πg.Param{Name: "self", Def: nil}
					πTemp002[1] = πg.Param{Name: "envvar", Def: nil}
					πTemp005 = πg.NewFunction(πg.NewCode("__delitem__", "/usr/lib/python2.7/test/test_support.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
						var µenvvar *πg.Object = πArgs[1]; _ = µenvvar
						var πTemp001 *πg.Object
						_ = πTemp001
					...
					πTemp002 = make([]πg.Param, 1)
					πTemp002[0] = πg.Param{Name: "self", Def: nil}
					πTemp006 = πg.NewFunction(πg.NewCode("keys", "/usr/lib/python2.7/test/test_support.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
						var πTemp001 *πg.Object
						_ = πTemp001
						var πTemp002 *πg.Object
					...
					πTemp002[1] = πg.Param{Name: "envvar", Def: nil}
					πTemp002[2] = πg.Param{Name: "value", Def: nil}
					πTemp007 = πg.NewFunction(πg.NewCode("set", "/usr/lib/python2.7/test/test_support.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
						var µenvvar *πg.Object = πArgs[1]; _ = µenvvar
						var µvalue *πg.Object = πArgs[2]; _ = µvalue
						var πTemp001 *πg.Object
					...
					πTemp002[0] = πg.Param{Name: "self", Def: nil}
					πTemp002[1] = πg.Param{Name: "envvar", Def: nil}
					πTemp008 = πg.NewFunction(πg.NewCode("unset", "/usr/lib/python2.7/test/test_support.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
						var µenvvar *πg.Object = πArgs[1]; _ = µenvvar
						var πTemp001 *πg.Object
						_ = πTemp001
					...
					πTemp002 = make([]πg.Param, 1)
					πTemp002[0] = πg.Param{Name: "self", Def: nil}
					πTemp009 = πg.NewFunction(πg.NewCode("__enter__", "/usr/lib/python2.7/test/test_support.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
						var πR *πg.Object; _ = πR
						var πE *πg.BaseException; _ = πE
						for ; πF.State() >= 0; πF.PopCheckpoint() {
					...
					πTemp002 = make([]πg.Param, 1)
					πTemp002[0] = πg.Param{Name: "self", Def: nil}
					πTemp010 = πg.NewFunction(πg.NewCode("__exit__", "/usr/lib/python2.7/test/test_support.py", πTemp002, πg.CodeFlagVarArg, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
						var µignore_exc *πg.Object = πArgs[1]; _ = µignore_exc
			...
			_, πE = πg.NewCode("BasicTestRunner", "/usr/lib/python2.7/test/test_support.py", nil, 0, func(πF *πg.Frame, _ []*πg.Object) (*πg.Object, *πg.BaseException) {
				πClass := πTemp006
				_ = πClass
				var πTemp001 *πg.Object
				_ = πTemp001
				...
				for ; πF.State() >= 0; πF.PopCheckpoint() {
					...
					πTemp001 = πg.NewFunction(πg.NewCode("run", "/usr/lib/python2.7/test/test_support.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
			...
			πTemp015 = πg.NewFunction(πg.NewCode("_id", "/usr/lib/python2.7/test/test_support.py", πTemp009, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
			...
			πTemp016 = πg.NewFunction(πg.NewCode("cpython_only", "/usr/lib/python2.7/test/test_support.py", πTemp009, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				...
				for ; πF.State() >= 0; πF.PopCheckpoint() {
					...
					πTemp001 = πg.NewFunction(πg.NewCode("<lambda>", "/usr/lib/python2.7/test/test_support.py", πTemp002, πg.CodeFlagVarArg | πg.CodeFlagKWArg, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
			...
			πTemp017 = πg.NewFunction(πg.NewCode("_run_suite", "/usr/lib/python2.7/test/test_support.py", πTemp009, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
			...
			// line 1436: """Run tests from a unittest.TestSuite-derived class."""
			πF.SetLineno(1436)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp018}, πg.NewStr("Run tests from a unittest.TestSuite-derived class.").ToObject()); πE != nil {
				continue
			}
			if πTemp019, πE = πg.ResolveGlobal(πF, ß_run_suite); πE != nil {
				continue
			}
			...
			πF.SetLineno(1455)
			πTemp009 = make([]πg.Param, 0)
			πTemp018 = πg.NewFunction(πg.NewCode("run_unittest", "/usr/lib/python2.7/test/test_support.py", πTemp009, πg.CodeFlagVarArg, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
			...
			// line 1456: """Run tests from unittest.TestCase-derived classes."""
			πF.SetLineno(1456)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp019}, πg.NewStr("Run tests from unittest.TestCase-derived classes.").ToObject()); πE != nil {
				continue
			}
			if πTemp020, πE = πg.ResolveGlobal(πF, ßrun_unittest); πE != nil {
				continue
			}
			...
			πF.SetLineno(1525)
			πTemp009 = make([]πg.Param, 0)
			πTemp019 = πg.NewFunction(πg.NewCode("threading_setup", "/usr/lib/python2.7/test/test_support.py", πTemp009, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var πTemp001 *πg.Object
				_ = πTemp001
				var πTemp002 bool
				_ = πTemp002
			...
			πTemp020 = πg.NewFunction(πg.NewCode("threading_cleanup", "/usr/lib/python2.7/test/test_support.py", πTemp009, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
			...
			πF.SetLineno(1560)
			πTemp009 = make([]πg.Param, 0)
			πTemp021 = πg.NewFunction(πg.NewCode("reap_children", "/usr/lib/python2.7/test/test_support.py", πTemp009, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
			...
			// line 1561: """Use this function at the end of test_main() whenever sub-processes
			πF.SetLineno(1561)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp022}, πg.NewStr("Use this function at the end of test_main() whenever sub-processes\n    are started.  This will help ensure that no extra children (zombies)\n    stick around to hog resources and create problems when looking\n    for refleaks.\n    ").ToObject()); πE != nil {
				continue
			}
			if πTemp023, πE = πg.ResolveGlobal(πF, ßreap_children); πE != nil {
				continue
			}
