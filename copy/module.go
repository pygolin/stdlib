...
var Code *πg.Code
func init() {
	Code = πg.NewCode("<module>", "/usr/lib/python2.7/copy.py", nil, 0, func(πF *πg.Frame, _ []*πg.Object) (*πg.Object, *πg.BaseException) {
		...
		for ; πF.State() >= 0; πF.PopCheckpoint() {
			...
			_, πE = πg.NewCode("Error", "/usr/lib/python2.7/copy.py", nil, 0, func(πF *πg.Frame, _ []*πg.Object) (*πg.Object, *πg.BaseException) {
				πClass := πTemp004
				_ = πClass
				for ; πF.State() >= 0; πF.PopCheckpoint() {
					switch πF.State() {
			...
			πTemp001 = πg.NewFunction(πg.NewCode("copy", "/usr/lib/python2.7/copy.py", πTemp006, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
			...
			// line 70: """Shallow copy operation on arbitrary Python objects.
			πF.SetLineno(70)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp003}, πg.NewStr("Shallow copy operation on arbitrary Python objects.\n\n    See the module's __doc__ string for more info.\n    ").ToObject()); πE != nil {
				continue
			}
			...
			πTemp006 = make([]πg.Param, 1)
			πTemp006[0] = πg.Param{Name: "x", Def: nil}
			πTemp003 = πg.NewFunction(πg.NewCode("_copy_immutable", "/usr/lib/python2.7/copy.py", πTemp006, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µx *πg.Object = πArgs[0]; _ = µx
				var πR *πg.Object; _ = πR
				var πE *πg.BaseException; _ = πE
				for ; πF.State() >= 0; πF.PopCheckpoint() {
		...
		Label6:
			...
			πTemp006 = make([]πg.Param, 1)
			πTemp006[0] = πg.Param{Name: "x", Def: nil}
			πTemp005 = πg.NewFunction(πg.NewCode("_copy_with_constructor", "/usr/lib/python2.7/copy.py", πTemp006, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µx *πg.Object = πArgs[0]; _ = µx
				var πTemp001 []*πg.Object
				_ = πTemp001
				var πTemp002 []*πg.Object
		...
		Label11:
			...
			πTemp006 = make([]πg.Param, 1)
			πTemp006[0] = πg.Param{Name: "x", Def: nil}
			πTemp007 = πg.NewFunction(πg.NewCode("_copy_with_copy_method", "/usr/lib/python2.7/copy.py", πTemp006, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µx *πg.Object = πArgs[0]; _ = µx
				var πTemp001 *πg.Object
				_ = πTemp001
				var πTemp002 *πg.Object
		...
		Label13:
			...
			πTemp009 = πg.NewFunction(πg.NewCode("deepcopy", "/usr/lib/python2.7/copy.py", πTemp006, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µx *πg.Object = πArgs[0]; _ = µx
			...
			// line 149: """Deep copy operation on arbitrary Python objects.
			πF.SetLineno(149)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp010}, πg.NewStr("Deep copy operation on arbitrary Python objects.\n\n    See the module's __doc__ string for more info.\n    ").ToObject()); πE != nil {
				continue
			}
			if πTemp013, πE = πg.ResolveGlobal(πF, ßdeepcopy); πE != nil {
				continue
			}
			if πE = πg.SetAttr(πF, πTemp013, ß__doc__, πTemp010); πE != nil {
				continue
			}
			...
			πTemp010 = πg.NewFunction(πg.NewCode("_deepcopy_atomic", "/usr/lib/python2.7/copy.py", πTemp006, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µx *πg.Object = πArgs[0]; _ = µx
				var µmemo *πg.Object = πArgs[1]; _ = µmemo
				var πR *πg.Object; _ = πR
				var πE *πg.BaseException; _ = πE
		...
		Label20:
			...
			πTemp006[0] = πg.Param{Name: "x", Def: nil}
			πTemp006[1] = πg.Param{Name: "memo", Def: nil}
			πTemp013 = πg.NewFunction(πg.NewCode("_deepcopy_list", "/usr/lib/python2.7/copy.py", πTemp006, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µx *πg.Object = πArgs[0]; _ = µx
				var µmemo *πg.Object = πArgs[1]; _ = µmemo
				var µy *πg.Object = πg.UnboundLocal; _ = µy
			...
			πTemp006[0] = πg.Param{Name: "x", Def: nil}
			πTemp006[1] = πg.Param{Name: "memo", Def: nil}
			πTemp014 = πg.NewFunction(πg.NewCode("_deepcopy_tuple", "/usr/lib/python2.7/copy.py", πTemp006, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µx *πg.Object = πArgs[0]; _ = µx
				var µmemo *πg.Object = πArgs[1]; _ = µmemo
				var µy *πg.Object = πg.UnboundLocal; _ = µy
				var µa *πg.Object = πg.UnboundLocal; _ = µa
			...
			πTemp006[0] = πg.Param{Name: "x", Def: nil}
			πTemp006[1] = πg.Param{Name: "memo", Def: nil}
			πTemp015 = πg.NewFunction(πg.NewCode("_deepcopy_dict", "/usr/lib/python2.7/copy.py", πTemp006, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µx *πg.Object = πArgs[0]; _ = µx
				var µmemo *πg.Object = πArgs[1]; _ = µmemo
				var µy *πg.Object = πg.UnboundLocal; _ = µy
		...
		Label24:
			...
			πTemp006[0] = πg.Param{Name: "x", Def: nil}
			πTemp006[1] = πg.Param{Name: "memo", Def: nil}
			πTemp016 = πg.NewFunction(πg.NewCode("_deepcopy_method", "/usr/lib/python2.7/copy.py", πTemp006, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µx *πg.Object = πArgs[0]; _ = µx
				var µmemo *πg.Object = πArgs[1]; _ = µmemo
				var πTemp001 []*πg.Object
				_ = πTemp001
			...
			πTemp006[0] = πg.Param{Name: "x", Def: nil}
			πTemp006[1] = πg.Param{Name: "memo", Def: nil}
			πTemp017 = πg.NewFunction(πg.NewCode("_keep_alive", "/usr/lib/python2.7/copy.py", πTemp006, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µx *πg.Object = πArgs[0]; _ = µx
				var µmemo *πg.Object = πArgs[1]; _ = µmemo
				var πTemp001 []*πg.Object
				_ = πTemp001
			...
			// line 271: """Keeps a reference to the object x in the memo.
			πF.SetLineno(271)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp018}, πg.NewStr("Keeps a reference to the object x in the memo.\n\n    Because we remember objects by their id, we have\n    to assure that possibly temporary objects are kept\n    alive by referencing them.\n    We store a reference at the id of the memo, which should\n    normally not be used unless someone tries to deepcopy\n    the memo itself...\n    ").ToObject()); πE != nil {
				continue
			}
			if πTemp021, πE = πg.ResolveGlobal(πF, ß_keep_alive); πE != nil {
				continue
			}
			if πE = πg.SetAttr(πF, πTemp021, ß__doc__, πTemp018); πE != nil {
				continue
			}
			...
			πTemp018 = πg.NewFunction(πg.NewCode("_reconstruct", "/usr/lib/python2.7/copy.py", πTemp006, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µx *πg.Object = πArgs[0]; _ = µx
			...
			πTemp021 = πg.NewFunction(πg.NewCode("_test", "/usr/lib/python2.7/copy.py", πTemp006, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				...
				for ; πF.State() >= 0; πF.PopCheckpoint() {
					...
					_, πE = πg.NewCode("C", "/usr/lib/python2.7/copy.py", nil, 0, func(πF *πg.Frame, _ []*πg.Object) (*πg.Object, *πg.BaseException) {
						πClass := πTemp004
						_ = πClass
						var πTemp001 *πg.Object
						_ = πTemp001
						...
						for ; πF.State() >= 0; πF.PopCheckpoint() {
							...
							πTemp001 = πg.NewFunction(πg.NewCode("__init__", "/usr/lib/python2.7/copy.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
							...
							πTemp002[0] = πg.Param{Name: "self", Def: nil}
							πTemp003 = πg.NewFunction(πg.NewCode("__getstate__", "/usr/lib/python2.7/copy.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
								var µself *πg.Object = πArgs[0]; _ = µself
								var πTemp001 *πg.Dict
								_ = πTemp001
								var πTemp002 *πg.Object
							...
							πTemp004 = πg.NewFunction(πg.NewCode("__setstate__", "/usr/lib/python2.7/copy.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
								var µself *πg.Object = πArgs[0]; _ = µself
							...
							πTemp005 = πg.NewFunction(πg.NewCode("__deepcopy__", "/usr/lib/python2.7/copy.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
								var µself *πg.Object = πArgs[0]; _ = µself
								var µmemo *πg.Object = πArgs[1]; _ = µmemo
					...
					_, πE = πg.NewCode("odict", "/usr/lib/python2.7/copy.py", nil, 0, func(πF *πg.Frame, _ []*πg.Object) (*πg.Object, *πg.BaseException) {
						πClass := πTemp004
						_ = πClass
						var πTemp001 *πg.Object
						_ = πTemp001
						...
						for ; πF.State() >= 0; πF.PopCheckpoint() {
							...
							πTemp004 = πg.NewFunction(πg.NewCode("__setitem__", "/usr/lib/python2.7/copy.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
								var µself *πg.Object = πArgs[0]; _ = µself
