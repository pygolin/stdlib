...
var Code *πg.Code
func init() {
	Code = πg.NewCode("<module>", "/usr/lib/python2.7/random.py", nil, 0, func(πF *πg.Frame, _ []*πg.Object) (*πg.Object, *πg.BaseException) {
		...
		for ; πF.State() >= 0; πF.PopCheckpoint() {
			...
			_, πE = πg.NewCode("Random", "/usr/lib/python2.7/random.py", nil, 0, func(πF *πg.Frame, _ []*πg.Object) (*πg.Object, *πg.BaseException) {
				πClass := πTemp004
				_ = πClass
				var πTemp001 *πg.Object
				_ = πTemp001
				...
				for ; πF.State() >= 0; πF.PopCheckpoint() {
					...
					// line 71: """Random number generator base class used by bound module functions.
					πF.SetLineno(71)
					if πE = πClass.SetItem(πF, ß__doc__.ToObject(), πg.NewStr("Random number generator base class used by bound module functions.\n\n    Used to instantiate instances of Random to get generators that don't\n    share state.  Especially useful for multi-threaded programs, creating\n    a different instance of Random for each thread, and using the jumpahead()\n    method to ensure that the generated sequences seen by each thread don't\n    overlap.\n\n    Class Random can also be subclassed if you want to use a different basic\n    generator of your own devising: in that case, override the following\n    methods: random(), seed(), getstate(), setstate() and jumpahead().\n    Optionally, implement a getrandbits() method so that randrange() can cover\n    arbitrarily large ranges.\n\n    ").ToObject()); πE != nil {
						continue
					}
					...
					πTemp001 = πg.NewFunction(πg.NewCode("__init__", "/usr/lib/python2.7/random.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
					...
					// line 90: """Initialize an instance.
					πF.SetLineno(90)
					if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp003}, πg.NewStr("Initialize an instance.\n\n        Optional argument x controls seeding, as for Random.seed().\n        ").ToObject()); πE != nil {
						continue
					}
					...
					πTemp003 = πg.NewFunction(πg.NewCode("seed", "/usr/lib/python2.7/random.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
					...
					πTemp004 = πg.NewFunction(πg.NewCode("randrange", "/usr/lib/python2.7/random.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
					...
					// line 118: """Choose a random item from range(start, stop[, step]).
					πF.SetLineno(118)
					if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp005}, πg.NewStr("Choose a random item from range(start, stop[, step]).\n\n        This fixes the problem with randint() which includes the\n        endpoint; in Python this is usually not what you want.\n\n        ").ToObject()); πE != nil {
						continue
					}
					if πTemp006, πE = πg.ResolveClass(πF, πClass, nil, ßrandrange); πE != nil {
						continue
					}
					...
					πTemp005 = πg.NewFunction(πg.NewCode("randint", "/usr/lib/python2.7/random.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
						var µa *πg.Object = πArgs[1]; _ = µa
					...
					// line 181: """Return random integer in range [a, b], including both end points.
					πF.SetLineno(181)
					if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp006}, πg.NewStr("Return random integer in range [a, b], including both end points.\n        ").ToObject()); πE != nil {
						continue
					}
					if πTemp007, πE = πg.ResolveClass(πF, πClass, nil, ßrandint); πE != nil {
						continue
					}
					...
					πTemp006 = πg.NewFunction(πg.NewCode("choice", "/usr/lib/python2.7/random.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
					...
					// line 189: """Choose a random element from a non-empty sequence."""
					πF.SetLineno(189)
					if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp007}, πg.NewStr("Choose a random element from a non-empty sequence.").ToObject()); πE != nil {
						continue
					}
					if πTemp008, πE = πg.ResolveClass(πF, πClass, nil, ßchoice); πE != nil {
						continue
					}
					...
					πTemp007 = πg.NewFunction(πg.NewCode("shuffle", "/usr/lib/python2.7/random.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
						var µx *πg.Object = πArgs[1]; _ = µx
					...
					// line 193: """x, random=random.random -> shuffle list x in place; return None.
					πF.SetLineno(193)
					if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp008}, πg.NewStr("x, random=random.random -> shuffle list x in place; return None.\n\n        Optional arg random is a 0-argument function returning a random\n        float in [0.0, 1.0); by default, the standard random.random.\n\n        ").ToObject()); πE != nil {
						continue
					}
					if πTemp009, πE = πg.ResolveClass(πF, πClass, nil, ßshuffle); πE != nil {
						continue
					}
					...
					πTemp002[1] = πg.Param{Name: "a", Def: nil}
					πTemp002[2] = πg.Param{Name: "b", Def: nil}
					πTemp008 = πg.NewFunction(πg.NewCode("uniform", "/usr/lib/python2.7/random.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
						var µa *πg.Object = πArgs[1]; _ = µa
						var µb *πg.Object = πArgs[2]; _ = µb
						var πTemp001 *πg.Object
					...
					// line 274: "Get a random number in the range [a, b) or [a, b] depending on rounding."
					πF.SetLineno(274)
					if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp009}, πg.NewStr("Get a random number in the range [a, b) or [a, b] depending on rounding.").ToObject()); πE != nil {
						continue
					}
					if πTemp010, πE = πg.ResolveClass(πF, πClass, nil, ßuniform); πE != nil {
						continue
					}
			...
			πTemp002 = πg.NewFunction(πg.NewCode("_test_generator", "/usr/lib/python2.7/random.py", πTemp007, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
			...
			πTemp003 = πg.NewFunction(πg.NewCode("_test", "/usr/lib/python2.7/random.py", πTemp007, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µN *πg.Object = πArgs[0]; _ = µN
				var πTemp001 []*πg.Object
				_ = πTemp001
				var πTemp002 *πg.Object
			...
			πTemp005 = πg.NewFunction(πg.NewCode("_notimplemented", "/usr/lib/python2.7/random.py", πTemp007, πg.CodeFlagVarArg | πg.CodeFlagKWArg, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
