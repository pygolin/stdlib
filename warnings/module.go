...
var Code *πg.Code
func init() {
	Code = πg.NewCode("<module>", "/usr/lib/python2.7/warnings.py", nil, 0, func(πF *πg.Frame, _ []*πg.Object) (*πg.Object, *πg.BaseException) {
		...
		for ; πF.State() >= 0; πF.PopCheckpoint() {
			...
			// line 1: """Python part of the warnings subsystem."""
			πF.SetLineno(1)
			if πE = πF.Globals().SetItem(πF, ß__doc__.ToObject(), πg.NewStr("Python part of the warnings subsystem.").ToObject()); πE != nil {
				continue
			}
			...
			πTemp001 = πg.NewFunction(πg.NewCode("warnpy3k", "/usr/lib/python2.7/warnings.py", πTemp003, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
			...
			// line 17: """Issue a deprecation warning for Python 3.x related changes.
			πF.SetLineno(17)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp004}, πg.NewStr("Issue a deprecation warning for Python 3.x related changes.\n\n    Warnings are omitted unless Python is started with the -3 option.\n    ").ToObject()); πE != nil {
				continue
			}
			if πTemp005, πE = πg.ResolveGlobal(πF, ßwarnpy3k); πE != nil {
				continue
			}
			...
			πTemp004 = πg.NewFunction(πg.NewCode("_show_warning", "/usr/lib/python2.7/warnings.py", πTemp003, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µmessage *πg.Object = πArgs[0]; _ = µmessage
				var µcategory *πg.Object = πArgs[1]; _ = µcategory
			...
			// line 27: """Hook to write a warning to a file; replace if you like."""
			πF.SetLineno(27)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp005}, πg.NewStr("Hook to write a warning to a file; replace if you like.").ToObject()); πE != nil {
				continue
			}
			if πTemp006, πE = πg.ResolveGlobal(πF, ß_show_warning); πE != nil {
				continue
			}
			...
			πTemp005 = πg.NewFunction(πg.NewCode("formatwarning", "/usr/lib/python2.7/warnings.py", πTemp003, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µmessage *πg.Object = πArgs[0]; _ = µmessage
				var µcategory *πg.Object = πArgs[1]; _ = µcategory
				var µfilename *πg.Object = πArgs[2]; _ = µfilename
				var µlineno *πg.Object = πArgs[3]; _ = µlineno
			...
			// line 42: """Function to format a warning the standard way."""
			πF.SetLineno(42)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp006}, πg.NewStr("Function to format a warning the standard way.").ToObject()); πE != nil {
				continue
			}
			if πTemp007, πE = πg.ResolveGlobal(πF, ßformatwarning); πE != nil {
				continue
			}
			...
			πTemp006 = πg.NewFunction(πg.NewCode("filterwarnings", "/usr/lib/python2.7/warnings.py", πTemp003, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
			...
			// line 70: """Insert an entry into the list of warnings filters (at the front).
			πF.SetLineno(70)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp007}, πg.NewStr("Insert an entry into the list of warnings filters (at the front).\n\n    'action' -- one of \"error\", \"ignore\", \"always\", \"default\", \"module\",\n                or \"once\"\n    'message' -- a regex that the warning message must match\n    'category' -- a class that the warning must be a subclass of\n    'module' -- a regex that the module name must match\n    'lineno' -- an integer line number, 0 matches all warnings\n    'append' -- if true, append to the list of filters\n    ").ToObject()); πE != nil {
				continue
			}
			if πTemp008, πE = πg.ResolveGlobal(πF, ßfilterwarnings); πE != nil {
				continue
			}
			...
			πTemp007 = πg.NewFunction(πg.NewCode("simplefilter", "/usr/lib/python2.7/warnings.py", πTemp003, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µaction *πg.Object = πArgs[0]; _ = µaction
				var µcategory *πg.Object = πArgs[1]; _ = µcategory
			...
			// line 96: """Insert a simple entry into the list of warnings filters (at the front).
			πF.SetLineno(96)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp008}, πg.NewStr("Insert a simple entry into the list of warnings filters (at the front).\n\n    A simple filter matches all modules and messages.\n    'action' -- one of \"error\", \"ignore\", \"always\", \"default\", \"module\",\n                or \"once\"\n    'category' -- a class that the warning must be a subclass of\n    'lineno' -- an integer line number, 0 matches all warnings\n    'append' -- if true, append to the list of filters\n    ").ToObject()); πE != nil {
				continue
			}
			if πTemp009, πE = πg.ResolveGlobal(πF, ßsimplefilter); πE != nil {
				continue
			}
			...
			πTemp008 = πg.NewFunction(πg.NewCode("resetwarnings", "/usr/lib/python2.7/warnings.py", πTemp003, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var πTemp001 []*πg.Object
				_ = πTemp001
				var πTemp002 *πg.Object
				_ = πTemp002
			...
			// line 116: """Clear the list of warning filters, so that no filters are active."""
			πF.SetLineno(116)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp009}, πg.NewStr("Clear the list of warning filters, so that no filters are active.").ToObject()); πE != nil {
				continue
			}
			if πTemp010, πE = πg.ResolveGlobal(πF, ßresetwarnings); πE != nil {
				continue
			}
			...
			if πE = πTemp011.SetItem(πF, ß__module__.ToObject(), πTemp009); πE != nil {
				continue
			}
			_, πE = πg.NewCode("_OptionError", "/usr/lib/python2.7/warnings.py", nil, 0, func(πF *πg.Frame, _ []*πg.Object) (*πg.Object, *πg.BaseException) {
				πClass := πTemp011
				_ = πClass
				for ; πF.State() >= 0; πF.PopCheckpoint() {
					switch πF.State() {
					...
					// line 120: """Exception used by option processing helpers."""
					πF.SetLineno(120)
					if πE = πClass.SetItem(πF, ß__doc__.ToObject(), πg.NewStr("Exception used by option processing helpers.").ToObject()); πE != nil {
						continue
					}
					// line 121: pass
					πF.SetLineno(121)
			...
			if πTemp010, πE = πTemp011.GetItem(πF, ß__metaclass__.ToObject()); πE != nil {
				continue
			}
			if πTemp010 == nil {
				πTemp010 = πg.TypeType.ToObject()
			}
			if πTemp012, πE = πTemp010.Call(πF, []*πg.Object{πg.NewStr("_OptionError").ToObject(), πg.NewTuple(πTemp002...).ToObject(), πTemp011.ToObject()}, nil); πE != nil {
				continue
			}
			...
			πTemp009 = πg.NewFunction(πg.NewCode("_processoptions", "/usr/lib/python2.7/warnings.py", πTemp003, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
			...
			if πE = πF.Globals().SetItem(πF, ß_processoptions.ToObject(), πTemp009); πE != nil {
				continue
			}
			...
			πTemp010 = πg.NewFunction(πg.NewCode("_setoption", "/usr/lib/python2.7/warnings.py", πTemp003, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				...
				Label5:
					...
					πTemp003 = πg.NewFunction(πg.NewCode("<generator>", "/usr/lib/python2.7/warnings.py", πTemp007, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µs *πg.Object = πg.UnboundLocal; _ = µs
						var πTemp001 *πg.Object
						_ = πTemp001
						var πTemp002 bool
			...
			if πE = πF.Globals().SetItem(πF, ß_setoption.ToObject(), πTemp010); πE != nil {
				continue
			}
			...
			πTemp003 = make([]πg.Param, 1)
			πTemp003[0] = πg.Param{Name: "action", Def: nil}
			πTemp012 = πg.NewFunction(πg.NewCode("_getaction", "/usr/lib/python2.7/warnings.py", πTemp003, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µaction *πg.Object = πArgs[0]; _ = µaction
			...
			πTemp013 = πg.NewFunction(πg.NewCode("_getcategory", "/usr/lib/python2.7/warnings.py", πTemp003, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
			...
			πTemp003[2] = πg.Param{Name: "stacklevel", Def: πg.NewInt(1).ToObject()}
			πTemp014 = πg.NewFunction(πg.NewCode("warn", "/usr/lib/python2.7/warnings.py", πTemp003, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µmessage *πg.Object = πArgs[0]; _ = µmessage
				var µcategory *πg.Object = πArgs[1]; _ = µcategory
				var µstacklevel *πg.Object = πArgs[2]; _ = µstacklevel
			...
			// line 195: """Issue a warning, or maybe ignore it or raise an exception."""
			πF.SetLineno(195)
			if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp015}, πg.NewStr("Issue a warning, or maybe ignore it or raise an exception.").ToObject()); πE != nil {
				continue
			}
			if πTemp016, πE = πg.ResolveGlobal(πF, ßwarn); πE != nil {
				continue
			}
			...
			πTemp015 = πg.NewFunction(πg.NewCode("warn_explicit", "/usr/lib/python2.7/warnings.py", πTemp003, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
				var µmessage *πg.Object = πArgs[0]; _ = µmessage
				var µcategory *πg.Object = πArgs[1]; _ = µcategory
				var µfilename *πg.Object = πArgs[2]; _ = µfilename
				var µlineno *πg.Object = πArgs[3]; _ = µlineno
			...
			if πE = πTemp011.SetItem(πF, ß__module__.ToObject(), πTemp016); πE != nil {
				continue
			}
			_, πE = πg.NewCode("WarningMessage", "/usr/lib/python2.7/warnings.py", nil, 0, func(πF *πg.Frame, _ []*πg.Object) (*πg.Object, *πg.BaseException) {
				πClass := πTemp011
				_ = πClass
				var πTemp001 *πg.Object
				_ = πTemp001
				...
				for ; πF.State() >= 0; πF.PopCheckpoint() {
					...
					// line 302: """Holds the result of a single showwarning() call."""
					πF.SetLineno(302)
					if πE = πClass.SetItem(πF, ß__doc__.ToObject(), πg.NewStr("Holds the result of a single showwarning() call.").ToObject()); πE != nil {
						continue
					}
					...
					πTemp001 = πg.NewFunction(πg.NewCode("__init__", "/usr/lib/python2.7/warnings.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
					...
					πTemp002[0] = πg.Param{Name: "self", Def: nil}
					πTemp003 = πg.NewFunction(πg.NewCode("__str__", "/usr/lib/python2.7/warnings.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
						var πTemp001 *πg.Object
						_ = πTemp001
						var πTemp002 *πg.Object
			...
			if πTemp017, πE = πTemp011.GetItem(πF, ß__metaclass__.ToObject()); πE != nil {
				continue
			}
			if πTemp017 == nil {
				πTemp017 = πg.TypeType.ToObject()
			}
			if πTemp018, πE = πTemp017.Call(πF, []*πg.Object{πg.NewStr("WarningMessage").ToObject(), πg.NewTuple(πTemp002...).ToObject(), πTemp011.ToObject()}, nil); πE != nil {
				continue
			}
			...
			_, πE = πg.NewCode("catch_warnings", "/usr/lib/python2.7/warnings.py", nil, 0, func(πF *πg.Frame, _ []*πg.Object) (*πg.Object, *πg.BaseException) {
				πClass := πTemp011
				_ = πClass
				var πTemp001 *πg.Object
				_ = πTemp001
				...
				for ; πF.State() >= 0; πF.PopCheckpoint() {
					...
					// line 322: """A context manager that copies and restores the warnings filter upon
					πF.SetLineno(322)
					if πE = πClass.SetItem(πF, ß__doc__.ToObject(), πg.NewStr("A context manager that copies and restores the warnings filter upon\n    exiting the context.\n\n    The 'record' argument specifies whether warnings should be captured by a\n    custom implementation of warnings.showwarning() and be appended to a list\n    returned by the context manager. Otherwise None is returned by the context\n    manager. The objects appended to the list are arguments whose attributes\n    mirror the arguments to showwarning().\n\n    The 'module' argument is to specify an alternative module to the module\n    named 'warnings' and imported under that name. This argument is only useful\n    when testing the warnings module itself.\n\n    ").ToObject()); πE != nil {
						continue
					}
					...
					// line 338: """Specify whether to record warnings and if an alternative module
					πF.SetLineno(338)
					if πE = πg.Tie(πF, πg.TieTarget{Target: &πTemp003}, πg.NewStr("Specify whether to record warnings and if an alternative module\n        should be used other than sys.modules['warnings'].\n\n        For compatibility with Python 3.0, please consider all arguments to be\n        keyword-only.\n\n        ").ToObject()); πE != nil {
						continue
					}
					...
					πTemp002 = make([]πg.Param, 1)
					πTemp002[0] = πg.Param{Name: "self", Def: nil}
					πTemp003 = πg.NewFunction(πg.NewCode("__repr__", "/usr/lib/python2.7/warnings.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
					...
					πTemp002 = make([]πg.Param, 1)
					πTemp002[0] = πg.Param{Name: "self", Def: nil}
					πTemp004 = πg.NewFunction(πg.NewCode("__enter__", "/usr/lib/python2.7/warnings.py", πTemp002, 0, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
						...
						Label3:
							...
							πTemp001 = πg.NewFunction(πg.NewCode("showwarning", "/usr/lib/python2.7/warnings.py", πTemp006, πg.CodeFlagVarArg | πg.CodeFlagKWArg, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
								var µargs *πg.Object = πArgs[0]; _ = µargs
					...
					πTemp002 = make([]πg.Param, 1)
					πTemp002[0] = πg.Param{Name: "self", Def: nil}
					πTemp005 = πg.NewFunction(πg.NewCode("__exit__", "/usr/lib/python2.7/warnings.py", πTemp002, πg.CodeFlagVarArg, func(πF *πg.Frame, πArgs []*πg.Object) (*πg.Object, *πg.BaseException) {
						var µself *πg.Object = πArgs[0]; _ = µself
			...
			if πTemp018, πE = πTemp017.Call(πF, []*πg.Object{πg.NewStr("catch_warnings").ToObject(), πg.NewTuple(πTemp002...).ToObject(), πTemp011.ToObject()}, nil); πE != nil {
				continue
			}
